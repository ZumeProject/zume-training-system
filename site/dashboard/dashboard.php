...
class Zume_Training_Dashboard extends Zume_Magic_Page
{
    ...
    public static function translations() {
        return [
            ...
            'confirm_phone_and_email' => __( 'If these are not correct, please update your profile.', 'zume' ),
            ...
            'select_timezone' => __( 'Select timezone', 'zume' ),
            'new' => __( 'New', 'zume' ),
            ...
            'launch_course3' => __( 'Present Course', 'zume' ),
            'launch_course2' => __( 'Launch Course', 'zume' ),
            'launch_course' => __( 'Course Content', 'zume' ),
            ...
            'apology_for_delay' => __( 'We apologize for the delay', 'zume' ),
            'message' => __( 'Message', 'zume' ),
            ...
            'local_map_explanation' => __( 'A printable map of the Zume vision for your local area.', 'zume' ),
            'training_vision_map_explanation' => __( 'The "Map of Zúme Trainees" shows what is needed and what is reported for global saturation of trained multiplying disciples.', 'zume' ),
            'simple_church_planting_map_explanation' => __( 'The "Map of Zúme Churches" shows what is needed and what is reported for global saturation of multiplying simple churches.', 'zume' ),
            'hundred_hour_map_explanation' => __( 'The Last 100 Hours map shows the Holy Spirit moving his people to disciple making through Zúme around the world.', 'zume' ),

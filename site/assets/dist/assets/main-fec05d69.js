var mt=Object.defineProperty;var vt=(i,t,e)=>t in i?mt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var G=(i,t,e)=>(vt(i,typeof t!="symbol"?t+"":t,e),e);/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const j=window,Y=j.ShadowRoot&&(j.ShadyCSS===void 0||j.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,X=Symbol(),Q=new WeakMap;let dt=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==X)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Y&&t===void 0){const s=e!==void 0&&e.length===1;s&&(t=Q.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Q.set(e,t))}return t}toString(){return this.cssText}};const bt=i=>new dt(typeof i=="string"?i:i+"",void 0,X),yt=(i,...t)=>{const e=i.length===1?i[0]:t.reduce((s,n,r)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+i[r+1],i[0]);return new dt(e,i,X)},_t=(i,t)=>{Y?i.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):t.forEach(e=>{const s=document.createElement("style"),n=j.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=e.cssText,i.appendChild(s)})},K=Y?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return bt(e)})(i):i;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var V;const L=window,x=L.trustedTypes,st=x?x.createPolicy("lit-html",{createHTML:i=>i}):void 0,Z="$lit$",y=`lit$${(Math.random()+"").slice(9)}$`,pt="?"+y,wt=`<${pt}>`,E=document,R=()=>E.createComment(""),I=i=>i===null||typeof i!="object"&&typeof i!="function",$t=Array.isArray,At=i=>$t(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",D=`[ 	
\f\r]`,P=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,it=/-->/g,nt=/>/g,_=RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ot=/'/g,rt=/"/g,ft=/^(?:script|style|textarea|title)$/i,xt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),o=xt(1),v=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),at=new WeakMap,A=E.createTreeWalker(E,129,null,!1),Et=(i,t)=>{const e=i.length-1,s=[];let n,r=t===2?"<svg>":"",a=P;for(let l=0;l<e;l++){const h=i[l];let b,c,p=-1,m=0;for(;m<h.length&&(a.lastIndex=m,c=a.exec(h),c!==null);)m=a.lastIndex,a===P?c[1]==="!--"?a=it:c[1]!==void 0?a=nt:c[2]!==void 0?(ft.test(c[2])&&(n=RegExp("</"+c[2],"g")),a=_):c[3]!==void 0&&(a=_):a===_?c[0]===">"?(a=n??P,p=-1):c[1]===void 0?p=-2:(p=a.lastIndex-c[2].length,b=c[1],a=c[3]===void 0?_:c[3]==='"'?rt:ot):a===rt||a===ot?a=_:a===it||a===nt?a=P:(a=_,n=void 0);const z=a===_&&i[l+1].startsWith("/>")?" ":"";r+=a===P?h+wt:p>=0?(s.push(b),h.slice(0,p)+Z+h.slice(p)+y+z):h+y+(p===-2?(s.push(void 0),l):z)}const d=r+(i[e]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[st!==void 0?st.createHTML(d):d,s]};class O{constructor({strings:t,_$litType$:e},s){let n;this.parts=[];let r=0,a=0;const d=t.length-1,l=this.parts,[h,b]=Et(t,e);if(this.el=O.createElement(h,s),A.currentNode=this.el.content,e===2){const c=this.el.content,p=c.firstChild;p.remove(),c.append(...p.childNodes)}for(;(n=A.nextNode())!==null&&l.length<d;){if(n.nodeType===1){if(n.hasAttributes()){const c=[];for(const p of n.getAttributeNames())if(p.endsWith(Z)||p.startsWith(y)){const m=b[a++];if(c.push(p),m!==void 0){const z=n.getAttribute(m.toLowerCase()+Z).split(y),N=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:N[2],strings:z,ctor:N[1]==="."?Pt:N[1]==="?"?Rt:N[1]==="@"?It:M})}else l.push({type:6,index:r})}for(const p of c)n.removeAttribute(p)}if(ft.test(n.tagName)){const c=n.textContent.split(y),p=c.length-1;if(p>0){n.textContent=x?x.emptyScript:"";for(let m=0;m<p;m++)n.append(c[m],R()),A.nextNode(),l.push({type:2,index:++r});n.append(c[p],R())}}}else if(n.nodeType===8)if(n.data===pt)l.push({type:2,index:r});else{let c=-1;for(;(c=n.data.indexOf(y,c+1))!==-1;)l.push({type:7,index:r}),c+=y.length-1}r++}}static createElement(t,e){const s=E.createElement("template");return s.innerHTML=t,s}}function C(i,t,e=i,s){var n,r,a,d;if(t===v)return t;let l=s!==void 0?(n=e._$Co)===null||n===void 0?void 0:n[s]:e._$Cl;const h=I(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==h&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),h===void 0?l=void 0:(l=new h(i),l._$AT(i,e,s)),s!==void 0?((a=(d=e)._$Co)!==null&&a!==void 0?a:d._$Co=[])[s]=l:e._$Cl=l),l!==void 0&&(t=C(i,l._$AS(i,t.values),l,s)),t}class Ct{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:s},parts:n}=this._$AD,r=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:E).importNode(s,!0);A.currentNode=r;let a=A.nextNode(),d=0,l=0,h=n[0];for(;h!==void 0;){if(d===h.index){let b;h.type===2?b=new T(a,a.nextSibling,this,t):h.type===1?b=new h.ctor(a,h.name,h.strings,this,t):h.type===6&&(b=new Ot(a,this,t)),this._$AV.push(b),h=n[++l]}d!==(h==null?void 0:h.index)&&(a=A.nextNode(),d++)}return r}v(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class T{constructor(t,e,s,n){var r;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=n,this._$Cp=(r=n==null?void 0:n.isConnected)===null||r===void 0||r}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=C(this,t,e),I(t)?t===$||t==null||t===""?(this._$AH!==$&&this._$AR(),this._$AH=$):t!==this._$AH&&t!==v&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):At(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==$&&I(this._$AH)?this._$AA.nextSibling.data=t:this.$(E.createTextNode(t)),this._$AH=t}g(t){var e;const{values:s,_$litType$:n}=t,r=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=O.createElement(n.h,this.options)),n);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===r)this._$AH.v(s);else{const a=new Ct(r,this),d=a.u(this.options);a.v(s),this.$(d),this._$AH=a}}_$AC(t){let e=at.get(t.strings);return e===void 0&&at.set(t.strings,e=new O(t)),e}T(t){$t(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,n=0;for(const r of t)n===e.length?e.push(s=new T(this.k(R()),this.k(R()),this,this.options)):s=e[n],s._$AI(r),n++;n<e.length&&(this._$AR(s&&s._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,e);t&&t!==this._$AB;){const n=t.nextSibling;t.remove(),t=n}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class M{constructor(t,e,s,n,r){this.type=1,this._$AH=$,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,n){const r=this.strings;let a=!1;if(r===void 0)t=C(this,t,e,0),a=!I(t)||t!==this._$AH&&t!==v,a&&(this._$AH=t);else{const d=t;let l,h;for(t=r[0],l=0;l<r.length-1;l++)h=C(this,d[s+l],e,l),h===v&&(h=this._$AH[l]),a||(a=!I(h)||h!==this._$AH[l]),h===$?t=$:t!==$&&(t+=(h??"")+r[l+1]),this._$AH[l]=h}a&&!n&&this.j(t)}j(t){t===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Pt extends M{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===$?void 0:t}}const kt=x?x.emptyScript:"";class Rt extends M{constructor(){super(...arguments),this.type=4}j(t){t&&t!==$?this.element.setAttribute(this.name,kt):this.element.removeAttribute(this.name)}}class It extends M{constructor(t,e,s,n,r){super(t,e,s,n,r),this.type=5}_$AI(t,e=this){var s;if((t=(s=C(this,t,e,0))!==null&&s!==void 0?s:$)===v)return;const n=this._$AH,r=t===$&&n!==$||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,a=t!==$&&(n===$||r);r&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;typeof this._$AH=="function"?this._$AH.call((s=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}}class Ot{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){C(this,t)}}const lt=L.litHtmlPolyfillSupport;lt==null||lt(O,T),((V=L.litHtmlVersions)!==null&&V!==void 0?V:L.litHtmlVersions=[]).push("2.7.3");const Tt=(i,t,e)=>{var s,n;const r=(s=e==null?void 0:e.renderBefore)!==null&&s!==void 0?s:t;let a=r._$litPart$;if(a===void 0){const d=(n=e==null?void 0:e.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=a=new T(t.insertBefore(R(),d),d,void 0,e??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var F,q;let u=class extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Tt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return v}};u.finalized=!0,u._$litElement$=!0,(F=globalThis.litElementHydrateSupport)===null||F===void 0||F.call(globalThis,{LitElement:u});const ht=globalThis.litElementPolyfillSupport;ht==null||ht({LitElement:u});((q=globalThis.litElementVersions)!==null&&q!==void 0?q:globalThis.litElementVersions=[]).push("3.3.2");const k={makeAPlan:"getting-started",connectToCoach:"connect-to-coach"},f={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",connectToCoach:"connectToCoach"},g={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone"},U={[g.updateName]:{slug:g.updateName,component:(i,t)=>o`
                            <complete-profile
                                name=${i.slug}
                                module=${i.module}
                                ...
                                variant="name"
                            ></complete-profile>
                        `},[g.updateLocation]:{slug:g.updateLocation,component:(i,t)=>o`
                            <complete-profile
                                name=${i.slug}
                                module=${i.module}
                                t="${JSON.stringify(t.complete_profile)}"
                                variant="location"
                            ></complete-profile>
                        `},[g.updatePhone]:{slug:g.updatePhone,component:(i,t)=>o`
                            <complete-profile
                                name=${i.slug}
                                module=${i.module}
                                t="${JSON.stringify(t.complete_profile)}"
        ...
        `}_onBack(){if(this.stepIndex>0){const t=this.stepIndex-1;this._gotoStep(t)}}_onNext(){if(this.stepIndex+1<this.steps.length){const t=this.stepIndex+1;this._gotoStep(t)}}_onSkip(){const t=this.step.module;for(let e=this.stepIndex+1;e<this.steps.length-1;e++)if(this.steps[e].module!==t){this._gotoStep(e);return}this._onFinish()}_onFinish(){this.finishUrl||(window.location.href="/"),window.location.href=this.finishUrl}_gotoStep(t,e=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(t),this.step=this.steps[this.stepIndex],e)){const s=new URL(window.location.href),n=s.pathname.split("/"),r=n[n.length-1];let a="";Object.values(k).includes(r)?a=n.join("/")+"/"+this.step.slug+s.search:a=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,a)}}clampSteps(t){let e=t;return t>this.steps.length-1&&(e=this.steps.length-1),t<0&&(e=0),e}_handleHistoryPopState(){const e=new URL(window.location.href).pathname.split("/"),s=e[e.length-1];Object.values(k).includes(s)&&this._gotoStep(0,!1),this.steps.forEach(({slug:n},r)=>{s===n&&this._gotoStep(r,!1)})}makeModule(t=[],e=!1){const s={steps:[],skippable:e};return t.forEach(n=>{Object.keys(U).includes(n)&&s.steps.push(U[n])}),s}getModule(t,e=!1){const s={[f.completeProfile]:{steps:[U[g.updateName],U[g.updateLocation]],skippable:e},[f.makePlan]:{steps:[{slug:"make-a-plan",component:r=>o`
                        ...
                        `}],skippable:e}};return Object.keys(s).includes(t)?s[t]:s[f.completeProfile]}isWizardLoaded(){return Object.keys(this.modules).length!==0}loadWizard(){const t=this.getWizard();this.modules=t,this.steps=[],Object.entries(this.modules).forEach(([e,{steps:s,skippable:n}])=>{s.forEach(({component:r,slug:a})=>{const d={component:r,slug:a,module:e,skippable:n};this.steps.push(d)})})}isWizardTypeValid(){return!!Object.values(k).includes(this.type)}getWizard(){return this.isWizardTypeValid()?{[k.makeAPlan]:{[f.completeProfile]:this.makeModule([g.updateName,g.updateLocation],!0),[f.makePlan]:this.getModule(f.makePlan,!0),[f.inviteFriends]:this.getModule(f.inviteFriends,!0)},[k.connectToCoach]:{[f.completeProfile]:this.makeModule([g.updateName,g.updateLocation,g.updatePhone]),[f.connectToCoach]:this.getModule(f.connectToCoach)}}[this.type]:{}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState)}createRenderRoot(){return this}}window.customElements.define("zume-wizard",zt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mt=Nt(class extends Ut{constructor(i){if(super(i),i.type!==S.PROPERTY&&i.type!==S.ATTRIBUTE&&i.type!==S.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!jt(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===v||t===$)return t;const e=i.element,s=i.name;if(i.type===S.PROPERTY){if(t===e[s])return v}else if(i.type===S.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(s))return v}else if(i.type===S.ATTRIBUTE&&e.getAttribute(s)===t+"")return v;return Lt(i),t}});class Wt extends u{static get properties(){return{name:{type:String},module:{type:String},t:{type:Object},variant:{type:String},locations:{attribute:!1},locationError:{attribute:!1},city:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this._handleLocationsChange=this._handleLocationsChange.bind(this),this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus()}render(){return o`
        <div class="inputs">
            ${this.variant==="name"?o`
        ...
        `}createRenderRoot(){return this}}customElements.define("listen-part",Yt);class Xt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ...
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("read-part",Xt);class Gt extends u{static get properties(){return{part:{type:Object}}}render(){switch(this.part.type){case"section":return o`<section-part .part=${this.part}></section-part>`;case"watch":return o`<watch-part .part=${this.part}></watch-part>`;case"discuss":return o`<discuss-part .part=${this.part}></discuss-part>`;case"read":return o`<read-part .part=${this.part}></read-part>`;case"see":return o`<see-part .part=${this.part}></see-part>`;case"share":return o`<share-part .part=${this.part}></share-part>`;case"listen":return o`<listen-part .part=${this.part}></listen-part>`;case"form":return o`<form-part .part=${this.part}></form-part>`;case"cta":default:return o`<basic-part .part=${this.part}></basic-part>`}}createRenderRoot(){return this}}customElements.define("part-switcher",Gt);class Qt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h2>${t}</h2>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("section-part",Qt);class Kt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-part",te);class ee extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ...
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("watch-part",ee);class gt extends u{constructor(){super()}render(){return o`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",gt);const ct=document.querySelector(".nav-toggle"),se=document.querySelector("#nav");ct&&ct.addEventListener("click",i=>{se.classList.toggle("nav--visible")});
//# sourceMappingURL=main-fec05d69.js.map

var lt=Object.defineProperty;var ct=(i,e,t)=>e in i?lt(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var S=(i,e,t)=>(ct(i,typeof e!="symbol"?e+"":e,t),t),oe=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var P=(i,e,t)=>(oe(i,e,"read from private field"),t?t.call(i):e.get(i)),T=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},le=(i,e,t,s)=>(oe(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var I=(i,e,t)=>(oe(i,e,"access private method"),t);const je=document.querySelector(".nav-toggle"),dt=document.querySelector("#nav");je&&je.addEventListener("click",i=>{dt.classList.toggle("nav--visible")});var be;let ht=(be=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},S(be,"prefix","Z5_"),be);window.ZumeStorage=ht;var j,te,Ue,se,Fe,ie,Be,Q,fe;class qe{constructor(e){T(this,te);T(this,se);T(this,ie);T(this,Q);S(this,"WIZARD_STATE_NAME","zume_wizard_state");S(this,"STALE_LIFESPAN",10*60*1e3);S(this,"MAX_LIFESPAN",60*60*1e3);T(this,j,void 0);this.moduleName=e,le(this,j,I(this,te,Ue).call(this))}empty(){return Object.keys(P(this,j).data).length===0}isDataStale(){return I(this,Q,fe).call(this,P(this,j),this.STALE_LIFESPAN)}get(e){return P(this,j).data[e]}getAll(){return P(this,j).data}add(e,t){P(this,j).data[e]=t,I(this,ie,Be).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(P(this,j)))}clear(){le(this,j,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}j=new WeakMap,te=new WeakSet,Ue=function(){const e=I(this,se,Fe).call(this);return e&&!I(this,Q,fe).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},se=new WeakSet,Fe=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},ie=new WeakSet,Be=function(){P(this,j).timestamp=Date.now()},Q=new WeakSet,fe=function(e,t){return Date.now()-e.timestamp>t};const w={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},ut={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},c={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...ut},pt={[c.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[c.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[c.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
                                    ...
                                    ${y.childRoutesOf("getting-started").map(e=>o`
                                                <li>
                                                    <nav-link
                                                        ...
                                                        @click=${e.type==="handled-link"?t=>{e.clickHandler(t,this.dispatchEvent)}:null}
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ne=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},ne=it(class extends nt{constructor(i){if(super(i),i.type!==R.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],r=[];let a=0;for(const h of i)n[a]=s?s(h,a):a,r[a]=t(h,a),a++;return{values:r,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const r=xt(i),{values:a,keys:h}=this.dt(e,t,s);if(!Array.isArray(r))return this.ht=h,a;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],d=[];let b,p,u=0,m=r.length-1,v=0,f=a.length-1;for(;u<=m&&v<=f;)if(r[u]===null)u++;else if(r[m]===null)m--;else if(l[u]===h[v])d[v]=z(r[u],a[v]),u++,v++;else if(l[m]===h[f])d[f]=z(r[m],a[f]),m--,f--;else if(l[u]===h[f])d[f]=z(r[u],a[f]),B(i,d[f+1],r[u]),u++,f--;else if(l[m]===h[v])d[v]=z(r[m],a[v]),B(i,r[u],r[m]),m--,v++;else if(b===void 0&&(b=Ne(h,v,f),p=Ne(l,u,m)),b.has(l[u]))if(b.has(l[m])){const E=p.get(h[v]),re=E!==void 0?r[E]:null;if(re===null){const Se=B(i,r[u]);z(Se,a[v]),d[v]=Se}else d[v]=z(re,a[v]),B(i,r[u],re),r[E]=null;v++}else ge(r[m]),m--;else ge(r[u]),u++;for(;v<=f;){const E=B(i,d[f+1]);z(E,a[v]),d[v++]=E}for(;u<=m;){const E=r[u++];E!==null&&ge(E)}return this.ht=h,at(i,d),x}});class Wt extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.userId=jsObject.profile.user_id}firstUpdated(){this.getCtas()}getCtas(){makeRequest("POST","user_ctas",{user_id:this.userId},"zume_system/v1").done(e=>{const t=Object.values(e);this.allCtas=t,this.ctas=this.shuffleArray(t).slice(0,3)})}shuffleArray(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}renderCta({content:e,content_template:t}){if(t==="card")return o`
                ...
                <div class="nav-grid">
                    ${this.routes.map(e=>o`
                        <grid-link
                            ...
                            icon=${e.icon}
                            ?disableNavigate=${e.type==="handled-link"}
                            @click=${e.type==="handled-link"?t=>e.handler(t,this.dispatchEvent):null}
                            ?completed=${y.getCompletedStatus(e.name)}
                            ?locked=${y.getLockedStatus(e.name)}
                        >
                        </grid-link>
...
//# sourceMappingURL=main-bd4d7b56.js.map

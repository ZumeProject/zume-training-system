 ...
 */const Et=st(class extends it{constructor(i){if(super(i),i.type!==R.PROPERTY&&i.type!==R.ATTRIBUTE&&i.type!==R.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!wt(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===x||e===y)return e;const t=i.element,s=i.name;if(i.type===R.PROPERTY){if(e===t[s])return x}else if(i.type===R.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return x}else if(i.type===R.ATTRIBUTE&&t.getAttribute(s)===e+"")return x;return at(i),e}});class zt extends g{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return o`
                        ...
                        >
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${_.childRoutesOf("getting-started").map(t=>o`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        ...
                                                        icon=${t.icon}
                                                        text=${t.translation}
                                                        ?directLink=${t.type==="direct-link"}
                                                        ?completed=${_.getCompletedStatus(t.name)}
                                                    ></nav-link>
                            ...
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${_.childRoutesOf("training").map(t=>o`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(t.name)}
                                                        icon=${t.icon}
                                                        text=${t.translation}
                                                        ?locked=${_.getLockedStatus(t.name)}
                                                    ></nav-link>
                            ...
                            <li class="menu-section">
                                ...
                                ></nav-link>
                                <ul class="nested is-active">
                                    ${_.childRoutesOf("practicing").map(t=>o`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(t.name)}
                ...
                <div class="center my-0">
                    ...
                    <form action="" id="profile-form">
                        ...
                        <div class="">
                            ...
                            <input type="text" id="city" name="city" value=${((e=zumeDashboard.user_profile.location)==null?void 0:e.label)??""}>
                        </div>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",Ut);class Ft extends A{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Le=(i,e,t)=>{const s=new Map;for(let a=e;a<=t;a++)s.set(i[a],a);return s},ae=st(class extends it{constructor(i){if(super(i),i.type!==R.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const a=[],r=[];let n=0;for(const h of i)a[n]=s?s(h,n):n,r[n]=t(h,n),n++;return{values:r,keys:a}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var a;const r=xt(i),{values:n,keys:h}=this.dt(e,t,s);if(!Array.isArray(r))return this.ht=h,n;const d=(a=this.ht)!==null&&a!==void 0?a:this.ht=[],c=[];let b,p,u=0,m=r.length-1,v=0,f=n.length-1;for(;u<=m&&v<=f;)if(r[u]===null)u++;else if(r[m]===null)m--;else if(d[u]===h[v])c[v]=M(r[u],n[v]),u++,v++;else if(d[m]===h[f])c[f]=M(r[m],n[f]),m--,f--;else if(d[u]===h[f])c[f]=M(r[u],n[f]),B(i,c[f+1],r[u]),u++,f--;else if(d[m]===h[v])c[v]=M(r[m],n[v]),B(i,r[u],r[m]),m--,v++;else if(b===void 0&&(b=Le(h,v,f),p=Le(d,u,m)),b.has(d[u]))if(b.has(d[m])){const z=p.get(h[v]),re=z!==void 0?r[z]:null;if(re===null){const we=B(i,r[u]);M(we,n[v]),c[v]=we}else c[v]=M(re,n[v]),B(i,r[u],re),r[z]=null;v++}else ge(r[m]),m--;else ge(r[u]),u++;for(;v<=f;){const z=B(i,c[f+1]);M(z,n[v]),c[v++]=z}for(;u<=m;){const z=r[u++];z!==null&&ge(z)}return this.ht=h,at(i,c),x}});class Bt extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.userId=zumeDashboard.user_profile.user_id}firstUpdated(){this.getCtas()}getCtas(){makeRequest("POST","user_ctas",{user_id:this.userId},"zume_system/v1").done(e=>{const t=Object.values(e);this.allCtas=t,this.ctas=this.shuffleArray(t).slice(0,3)})}shuffleArray(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}renderCta({content:e,content_template:t}){if(t==="card")return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-cta",Bt);class ne extends A{static get properties(){return{view:{type:String,attribute:!1}}}constructor(e){super(),this.routeName=e,this.route=_.getRoute(this.routeName),this.routes=_.childRoutesOf(this.routeName),this.view="list"}switchView(e="list"){this.view=e}renderLinks(){return this.view==="grid"?o`
                <div class="nav-grid">
                    ${this.routes.map(e=>o`
                        <grid-link
                            href=${e.pattern}
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-top-level",ne);class Wt extends ne{constructor(){super("getting-started")}createRenderRoot(){return this}}customElements.define("dash-getting-started",Wt);class Zt extends A{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
                    <h1 class="h3">Maps</h1>
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slide",k);class ns extends k{render(){return o`
        ...
        `}}customElements.define("activity-slide",ns);class rs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover">
        ...
        `}}customElements.define("checkin-slide",ls);class ds extends k{render(){return o`
            <div class="slides-card">
                <div class="cover">
                    <div class="center activity-card" data-large>
                        <p>${this.slide.center[0]}</p>
        ...
        `}}customElements.define("congratulations-slide",ds);class cs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("discuss-slide",cs);class hs extends k{render(){return o`
            <div class="slides-card">
                <div class="cover">
        ...
        `}}customElements.define("title-slide",bs);class fs extends k{render(){return o`
        ...
        `}}customElements.define("video-slide",fs);class $s extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
...
//# sourceMappingURL=main-b856ed64.js.map

 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ze=s=>(...e)=>({_$litDirective$:s,values:e});class Ge{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:mt}=dt,gt=s=>s.strings===void 0,De=()=>document.createComment(""),U=(s,e,t)=>{var i;const n=s._$AA.parentNode,o=e===void 0?s._$AB:e._$AA;if(t===void 0){const a=n.insertBefore(De(),o),d=n.insertBefore(De(),o);t=new mt(a,d,s,s.options)}else{const a=t._$AB.nextSibling,d=t._$AM,h=d!==s;if(h){let c;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(c=s._$AU)!==d._$AU&&t._$AP(c)}if(a!==o||h){let c=t._$AA;for(;c!==a;){const v=c.nextSibling;n.insertBefore(c,o),c=v}}}return t},D=(s,e,t=s)=>(s._$AI(e,t),s),bt={},Ke=(s,e=bt)=>s._$AH=e,vt=s=>s._$AH,he=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const n=t.nextSibling;t.remove(),t=n}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ft=Ze(class extends Ge{constructor(s){if(super(s),s.type!==P.PROPERTY&&s.type!==P.ATTRIBUTE&&s.type!==P.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!gt(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===w||e===_)return e;const t=s.element,i=s.name;if(s.type===P.PROPERTY){if(e===t[i])return w}else if(s.type===P.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return w}else if(s.type===P.ATTRIBUTE&&t.getAttribute(i)===e+"")return w;return Ke(s),e}});class $t extends u{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return r`
            ...
            <div class="dashboard__sidebar">
                <ul class="stack-2 | progress-menu accordion-menu" data-accordion-menu data-submenu-toggle="true">
                    ...
                    <li class="menu-section">
                        ...
                        ></nav-link>
                        <ul class="nested is-active">
                            ${j.childRoutesOf("practicing").map(e=>r`
                                        <li>
                                            <nav-link
                                                class="menu-btn"
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-board",j);class Tt extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",Tt);class Mt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",Mt);class It extends u{render(){return r`
            <div class="dashboard__header">
            </div>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-content",It);class Ot extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-cta",Ot);class jt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-getting-started",jt);class Lt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
                    <h1 class="h3">Maps</h1>
                    <launch-course></launch-course>
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe=(s,e,t)=>{const i=new Map;for(let n=e;n<=t;n++)i.set(s[n],n);return i},Ft=Ze(class extends Ge{constructor(s){if(super(s),s.type!==P.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const n=[],o=[];let a=0;for(const d of s)n[a]=i?i(d,a):a,o[a]=t(d,a),a++;return{values:o,keys:n}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){var n;const o=vt(s),{values:a,keys:d}=this.dt(e,t,i);if(!Array.isArray(o))return this.ht=d,a;const h=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],c=[];let v,m,p=0,g=o.length-1,b=0,f=a.length-1;for(;p<=g&&b<=f;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(h[p]===d[b])c[b]=D(o[p],a[b]),p++,b++;else if(h[g]===d[f])c[f]=D(o[g],a[f]),g--,f--;else if(h[p]===d[f])c[f]=D(o[p],a[f]),U(s,c[f+1],o[p]),p++,f--;else if(h[g]===d[b])c[b]=D(o[g],a[b]),U(s,o[p],o[g]),g--,b++;else if(v===void 0&&(v=Pe(d,b,f),m=Pe(h,p,g)),v.has(h[p]))if(v.has(h[g])){const S=m.get(d[b]),te=S!==void 0?o[S]:null;if(te===null){const be=U(s,o[p]);D(be,a[b]),c[b]=be}else c[b]=D(te,a[b]),U(s,o[p],te),o[S]=null;b++}else he(o[g]),g--;else he(o[p]),p++;for(;b<=f;){const S=U(s,c[f+1]);D(S,a[b]),c[b++]=S}for(;p<=g;){const S=o[p++];S!==null&&he(S)}return this.ht=d,Ke(s,c),w}});class Ht extends u{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1}}}constructor(){super(),this.loading=!0,this.renderListItem=this.renderListItem.bind(this)}firstUpdated(){this.fetchCommitments()}updated(){jQuery(document).foundation()}fetchCommitments(){makeRequest("GET","commitments",{status:""},"zume_system/v1").done(e=>{this.commitments=e}).always(()=>{this.loading=!1})}completeCommitment(e){let t={id:e,user_id:zumeDashboard.user_profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(i=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:zumeDashboard.user_profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(i=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:i,id:n,status:o}=e;return r`
            <li class="list__item">
                <span>${t} <b>${i}</b></span>
                ...
                <div class="dropdown-pane" id="kebab-menu-${n}" data-dropdown data-auto-focus="true" data-position="bottom" data-alignment="right" data-close-on-click="true" data-close-on-click-inside="true">
                    <ul>
                        <li><button class="menu-btn" @click=${()=>this.editCommitment(n)}><span class="icon zume-pencil"></span>${zumeDashboard.translations.edit}</button></li>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-plans",Ht);class Ut extends u{constructor(){super(),this.routeName="practicing",this.routes=j.childRoutesOf("practicing")}render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-training",Bt);class Qe extends Rt(u){static get properties(){return{href:{type:String},class:{type:String},disabled:{type:Boolean},completed:{type:Boolean},directLink:{type:Boolean},icon:{type:String},text:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.disabled=!1,this.completed=!1,this.directLink=!1}handleClick(e){this.directLink||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return r`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",Qe);class Wt extends Qe{constructor(){super()}renderText(){return this.text.split(" ").map(e=>r`
            <span>${e}</span>
        `)}render(){return r`
            <a
                href=${this.href}
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slideshow",Kt);class Qt extends u{static get properties(){return{partData:{type:Object}}}render(){switch(this.partData.type){case"section":return r`<section-part .partData=${this.partData}></section-part>`;case"watch":return r`<watch-part .partData=${this.partData}></watch-part>`;case"discuss":return r`<discuss-part .partData=${this.partData}></discuss-part>`;case"read":return r`<read-part .partData=${this.partData}></read-part>`;case"see":return r`<see-part .partData=${this.partData}></see-part>`;case"share":return r`<share-part .partData=${this.partData}></share-part>`;case"listen":return r`<listen-part .partData=${this.partData}></listen-part>`;case"form":return r`<form-part .partData=${this.partData}></form-part>`;case"checkin":return r`<checkin-part .partData=${this.partData}></checkin-part>`;case"cta":default:return r`<basic-part .partData=${this.partData}></basic-part>`}}createRenderRoot(){return this}}customElements.define("part-switcher",Qt);class Yt extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
...
//# sourceMappingURL=main-5637a085.js.map

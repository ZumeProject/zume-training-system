 ...
 */const Tt=(i,t,e)=>{const s=new Map;for(let n=t;n<=e;n++)s.set(i[n],n);return s},vt=Yt(class extends Xt{constructor(i){if(super(i),i.type!==P.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);const n=[],r=[];let a=0;for(const h of i)n[a]=s?s(h,a):a,r[a]=e(h,a),a++;return{values:r,keys:n}}render(i,t,e){return this.dt(i,t,e).values}update(i,[t,e,s]){var n;const r=we(i),{values:a,keys:h}=this.dt(t,e,s);if(!Array.isArray(r))return this.ht=h,a;const d=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],c=[];let f,m,p=0,g=r.length-1,b=0,v=a.length-1;for(;p<=g&&b<=v;)if(r[p]===null)p++;else if(r[g]===null)g--;else if(d[p]===h[b])c[b]=A(r[p],a[b]),p++,b++;else if(d[g]===h[v])c[v]=A(r[g],a[v]),g--,v--;else if(d[p]===h[v])c[v]=A(r[p],a[v]),q(i,c[v+1],r[p]),p++,v--;else if(d[g]===h[b])c[b]=A(r[g],a[b]),q(i,r[p],r[g]),g--,b++;else if(f===void 0&&(f=Tt(h,b,v),m=Tt(d,p,g)),f.has(d[p]))if(f.has(d[g])){const x=m.get(h[b]),st=x!==void 0?r[x]:null;if(st===null){const _t=q(i,r[p]);A(_t,a[b]),c[b]=_t}else c[b]=A(st,a[b]),q(i,r[p],st),r[x]=null;b++}else ht(r[g]),g--;else ht(r[p]),p++;for(;b<=v;){const x=q(i,c[v+1]);A(x,a[b]),c[b++]=x}for(;p<=g;){const x=r[p++];x!==null&&ht(x)}return this.ht=h,te(i,c),S}});class Ve extends u{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.loading=!0,this.route=w.getRoute("my-plans"),this.filterName="my-plans-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){const t=this.filterStatus||"";this.fetchCommitments(t)}updated(){jQuery(document).foundation()}fetchCommitments(){const t=this.filterStatus;makeRequest("GET","commitments",{status:t},"zume_system/v1").done(e=>{this.commitments=e}).always(()=>{this.loading=!1})}openCommitmentsModal(){const t=document.querySelector("#new-commitments-form");jQuery(t).foundation("open")}closeCommitmentsModal(){const t=document.querySelector("#new-commitments-form");jQuery(t).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(t){this.value=""})}addCommitments(){const t=[];return jQuery(".post-training-plan").each(function(e){const s=jQuery(this).val();if(s){const r=jQuery(this).prev().text();console.log("Question: "+r+" Answer: "+s);var n=new Date;n.setDate(n.getDate()+30),this.value="";const a=makeRequest("POST","commitment",{user_id:zumeDashboard.user_profile.user_id,post_id:zumeDashboard.user_profile.contact_id,meta_key:"tasks",note:"Question: "+r+" Answer: "+s,question:r,answer:s,date:n,category:"post_training_plan"},"zume_system/v1");t.push(a.promise())}}),console.log(t),Promise.all(t).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(t){let e={id:t,user_id:zumeDashboard.user_profile.user_id};makeRequest("PUT","commitment",e,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(t){let e={id:t,user_id:zumeDashboard.user_profile.user_id};makeRequest("DELETE","commitment",e,"zume_system/v1").done(s=>{this.closeMenu(t),this.fetchCommitments()})}editCommitment(t){console.log(t)}filterCommitments(t){this.filterStatus=t,this.fetchCommitments(t),ZumeStorage.save(this.filterName,t),this.closeFilter()}closeFilter(){const t=this.querySelector("#filter-menu");jQuery(t).foundation("close")}closeMenu(t){const e=this.querySelector(`#kebab-menu-${t}`);jQuery(e).foundation("close")}renderListItem(t){const{question:e,answer:s,id:n,status:r}=t;return o`
    ...
    `);window.customElements.define("play-button",ee);class bs extends u{constructor(){super();z(this,"webShareSupported",!!window.navigator.share);z(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(e=>console.error("Error sharing",e))}copyLink(){navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(e=>console.error(e))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return o`
        ...
        `}renderRow({join_key:t,language_note:e,post_title:s,time_of_day_note:n,timezone_note:r,...a}){const h=a.set_a_01?"a":"b",d=h==="a"?10:20,c=`set_${h}_`,f=Date.now()/1e3;let m="";for(let g=1;g<d+1;g++){const b=g<10?`0${g}`:`${g}`,v=a[c+b];if(m=v.timestamp,f<v.timestamp)break}const p=moment(m*1e3).format("MMM Do 'YY");return o`
            <tr>
...
//# sourceMappingURL=main-dfe721b0.js.map

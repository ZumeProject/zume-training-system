var ot=Object.defineProperty;var lt=(i,e,t)=>e in i?ot(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var E=(i,e,t)=>(lt(i,typeof e!="symbol"?e+"":e,t),t),oe=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var A=(i,e,t)=>(oe(i,e,"read from private field"),t?t.call(i):e.get(i)),I=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},le=(i,e,t,s)=>(oe(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var O=(i,e,t)=>(oe(i,e,"access private method"),t);const Se=document.querySelector(".nav-toggle"),dt=document.querySelector("#nav");Se&&Se.addEventListener("click",i=>{dt.classList.toggle("nav--visible")});var ve;let ct=(ve=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},E(ve,"prefix","Z5_"),ve);window.ZumeStorage=ct;var S,te,qe,se,Ue,ie,Fe,J,fe;class He{constructor(e){I(this,te);I(this,se);I(this,ie);I(this,J);E(this,"WIZARD_STATE_NAME","zume_wizard_state");E(this,"STALE_LIFESPAN",10*60*1e3);E(this,"MAX_LIFESPAN",60*60*1e3);I(this,S,void 0);this.moduleName=e,le(this,S,O(this,te,qe).call(this))}empty(){return Object.keys(A(this,S).data).length===0}isDataStale(){return O(this,J,fe).call(this,A(this,S),this.STALE_LIFESPAN)}get(e){return A(this,S).data[e]}getAll(){return A(this,S).data}add(e,t){A(this,S).data[e]=t,O(this,ie,Fe).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(A(this,S)))}clear(){le(this,S,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}S=new WeakMap,te=new WeakSet,qe=function(){const e=O(this,se,Ue).call(this);return e&&!O(this,J,fe).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},se=new WeakSet,Ue=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},ie=new WeakSet,Fe=function(){A(this,S).timestamp=Date.now()},J=new WeakSet,fe=function(e,t){return Date.now()-e.timestamp>t};const w={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},ht={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},l={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...ht},ut={[l.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[l.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[l.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Re=/'/g,Me=/"/g,Je=/^(?:script|style|textarea|title)$/i,Qe=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),o=Qe(1),G=Qe(2),x=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Te=new WeakMap,N=q.createTreeWalker(q,129,null,!1),Ge=(i,e)=>{const t=i.length-1,s=[];let a,r=e===2?"<svg>":"",n=F;for(let d=0;d<t;d++){const c=i[d];let f,p,u=-1,m=0;for(;m<c.length&&(n.lastIndex=m,p=n.exec(c),p!==null);)m=n.lastIndex,n===F?p[1]==="!--"?n=Ae:p[1]!==void 0?n=De:p[2]!==void 0?(Je.test(p[2])&&(a=RegExp("</"+p[2],"g")),n=D):p[3]!==void 0&&(n=D):n===D?p[0]===">"?(n=a??F,u=-1):p[1]===void 0?u=-2:(u=n.lastIndex-p[2].length,f=p[1],n=p[3]===void 0?D:p[3]==='"'?Me:Re):n===Me||n===Re?n=D:n===Ae||n===De?n=F:(n=D,a=void 0);const v=n===D&&i[d+1].startsWith("/>")?" ":"";r+=n===F?c+ft:u>=0?(s.push(f),c.slice(0,u)+ee+c.slice(u)+C+v):c+C+(u===-2?(s.push(void 0),d):v)}const h=r+(i[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Pe!==void 0?Pe.createHTML(h):h,s]};class V{constructor({strings:e,_$litType$:t},s){let a;this.parts=[];let r=0,n=0;const h=e.length-1,d=this.parts,[c,f]=Ge(e,t);if(this.el=V.createElement(c,s),N.currentNode=this.el.content,t===2){const p=this.el.content,u=p.firstChild;u.remove(),p.append(...u.childNodes)}for(;(a=N.nextNode())!==null&&d.length<h;){if(a.nodeType===1){if(a.hasAttributes()){const p=[];for(const u of a.getAttributeNames())if(u.endsWith(ee)||u.startsWith(C)){const m=f[n++];if(p.push(u),m!==void 0){const v=a.getAttribute(m.toLowerCase()+ee).split(C),b=/([.?@])?(.*)/.exec(m);d.push({type:1,index:r,name:b[2],strings:v,ctor:b[1]==="."?Ye:b[1]==="?"?Xe:b[1]==="@"?et:Q})}else d.push({type:6,index:r})}for(const u of p)a.removeAttribute(u)}if(Je.test(a.tagName)){const p=a.textContent.split(C),u=p.length-1;if(u>0){a.textContent=H?H.emptyScript:"";for(let m=0;m<u;m++)a.append(p[m],W()),N.nextNode(),d.push({type:2,index:++r});a.append(p[u],W())}}}else if(a.nodeType===8)if(a.data===_e)d.push({type:2,index:r});else{let p=-1;for(;(p=a.data.indexOf(C,p+1))!==-1;)d.push({type:7,index:r}),p+=C.length-1}r++}}static createElement(e,t){const s=q.createElement("template");return s.innerHTML=e,s}}function T(i,e,t=i,s){var a,r,n,h;if(e===x)return e;let d=s!==void 0?(a=t._$Co)===null||a===void 0?void 0:a[s]:t._$Cl;const c=Z(e)?void 0:e._$litDirective$;return(d==null?void 0:d.constructor)!==c&&((r=d==null?void 0:d._$AO)===null||r===void 0||r.call(d,!1),c===void 0?d=void 0:(d=new c(i),d._$AT(i,t,s)),s!==void 0?((n=(h=t)._$Co)!==null&&n!==void 0?n:h._$Co=[])[s]=d:t._$Cl=d),d!==void 0&&(e=T(i,d._$AS(i,e.values),d,s)),e}class Ke{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:a}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:q).importNode(s,!0);N.currentNode=r;let n=N.nextNode(),h=0,d=0,c=a[0];for(;c!==void 0;){if(h===c.index){let f;c.type===2?f=new U(n,n.nextSibling,this,e):c.type===1?f=new c.ctor(n,c.name,c.strings,this,e):c.type===6&&(f=new tt(n,this,e)),this._$AV.push(f),c=a[++d]}h!==(c==null?void 0:c.index)&&(n=N.nextNode(),h++)}return r}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class U{constructor(e,t,s,a){var r;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=a,this._$Cp=(r=a==null?void 0:a.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),Z(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==x&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ve(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==_&&Z(this._$AH)?this._$AA.nextSibling.data=e:this.$(q.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:a}=e,r=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=V.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(s);else{const n=new Ke(r,this),h=n.u(this.options);n.v(s),this.$(h),this._$AH=n}}_$AC(e){let t=Te.get(e.strings);return t===void 0&&Te.set(e.strings,t=new V(e)),t}T(e){Ze(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,a=0;for(const r of e)a===t.length?t.push(s=new U(this.k(W()),this.k(W()),this,this.options)):s=t[a],s._$AI(r),a++;a<t.length&&(this._$AR(s&&s._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Q{constructor(e,t,s,a,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,a){const r=this.strings;let n=!1;if(r===void 0)e=T(this,e,t,0),n=!Z(e)||e!==this._$AH&&e!==x,n&&(this._$AH=e);else{const h=e;let d,c;for(e=r[0],d=0;d<r.length-1;d++)c=T(this,h[s+d],t,d),c===x&&(c=this._$AH[d]),n||(n=!Z(c)||c!==this._$AH[d]),c===_?e=_:e!==_&&(e+=(c??"")+r[d+1]),this._$AH[d]=c}n&&!a&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ye extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}}const bt=H?H.emptyScript:"";class Xe extends Q{constructor(){super(...arguments),this.type=4}j(e){e&&e!==_?this.element.setAttribute(this.name,bt):this.element.removeAttribute(this.name)}}class et extends Q{constructor(e,t,s,a,r){super(e,t,s,a,r),this.type=5}_$AI(e,t=this){var s;if((e=(s=T(this,e,t,0))!==null&&s!==void 0?s:_)===x)return;const a=this._$AH,r=e===_&&a!==_||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,n=e!==_&&(a===_||r);r&&this.element.removeEventListener(this.name,this,a),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class tt{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}}const $t={O:ee,P:C,A:_e,C:1,M:Ge,L:Ke,D:Ve,R:T,I:U,V:Q,H:Xe,N:et,U:Ye,F:tt},Ie=X.litHtmlPolyfillSupport;Ie==null||Ie(V,U),((he=X.litHtmlVersions)!==null&&he!==void 0?he:X.litHtmlVersions=[]).push("2.7.3");const yt=(i,e,t)=>{var s,a;const r=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let n=r._$litPart$;if(n===void 0){const h=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;r._$litPart$=n=new U(e.insertBefore(W(),h),h,void 0,t??{})}return n._$AI(i),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pe,me;let g=class extends j{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=yt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return x}};g.finalized=!0,g._$litElement$=!0,(pe=globalThis.litElementHydrateSupport)===null||pe===void 0||pe.call(globalThis,{LitElement:g});const Oe=globalThis.litElementPolyfillSupport;Oe==null||Oe({LitElement:g});((me=globalThis.litElementVersions)!==null&&me!==void 0?me:globalThis.litElementVersions=[]).push("3.3.2");class _t extends g{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new He}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.steps.length===0?o`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const je=(i,e,t)=>{const s=new Map;for(let a=e;a<=t;a++)s.set(i[a],a);return s},ae=st(class extends it{constructor(i){if(super(i),i.type!==M.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const a=[],r=[];let n=0;for(const h of i)a[n]=s?s(h,n):n,r[n]=t(h,n),n++;return{values:r,keys:a}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var a;const r=xt(i),{values:n,keys:h}=this.dt(e,t,s);if(!Array.isArray(r))return this.ht=h,n;const d=(a=this.ht)!==null&&a!==void 0?a:this.ht=[],c=[];let f,p,u=0,m=r.length-1,v=0,b=n.length-1;for(;u<=m&&v<=b;)if(r[u]===null)u++;else if(r[m]===null)m--;else if(d[u]===h[v])c[v]=R(r[u],n[v]),u++,v++;else if(d[m]===h[b])c[b]=R(r[m],n[b]),m--,b--;else if(d[u]===h[b])c[b]=R(r[u],n[b]),B(i,c[b+1],r[u]),u++,b--;else if(d[m]===h[v])c[v]=R(r[m],n[v]),B(i,r[u],r[m]),m--,v++;else if(f===void 0&&(f=je(h,v,b),p=je(d,u,m)),f.has(d[u]))if(f.has(d[m])){const z=p.get(h[v]),re=z!==void 0?r[z]:null;if(re===null){const we=B(i,r[u]);R(we,n[v]),c[v]=we}else c[v]=R(re,n[v]),B(i,r[u],re),r[z]=null;v++}else ge(r[m]),m--;else ge(r[u]),u++;for(;v<=b;){const z=B(i,c[b+1]);R(z,n[v]),c[v++]=z}for(;u<=m;){const z=r[u++];z!==null&&ge(z)}return this.ht=h,at(i,c),x}});class Bt extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.userId=zumeDashboard.user_profile.user_id}firstUpdated(){this.getCtas()}getCtas(){makeRequest("POST","user_ctas",{user_id:this.userId},"zume_system/v1").done(e=>{const t=Object.values(e);this.allCtas=t,this.ctas=this.shuffleArray(t).slice(0,3)})}shuffleArray(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}renderCta({content:e,content_template:t}){if(t==="card")return o`
        ...
        `}render(){var e,t,s,a,r,n,h,d;return o`
            <div class="dashboard__content" data-no-secondary-area>
                <div class="dashboard__header left">
                    <div class="dashboard__title">
                        <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("launch-course",as);class ns extends g{static get properties(){return{userProfile:{type:Object},loading:{type:Boolean,attribute:!1}}}constructor(){super(),this.userProfile={}}firstUpdated(){this.nameInput=this.renderRoot.querySelector("#full_name"),this.phoneInput=this.renderRoot.querySelector("#phone"),this.emailInput=this.renderRoot.querySelector("#email"),this.cityInput=this.renderRoot.querySelector("#city"),this.prefferedLanguageInput=this.renderRoot.querySelector("#preferred-language"),this.addressResultsContainer=this.renderRoot.querySelector("#address_results")}submitProfileForm(e){e.preventDefault();const t=this.nameInput.value,s=this.emailInput.value,a=this.phoneInput.value,r={name:t,phone:a,email:s};r.location_grid_meta=getLocationGridFromMapbox(zumeDashboard.mapbox_selected_id,this.userProfile.location),this.loading=!0,fetch(zumeDashboard.rest_endpoint+"/profile",{method:"POST",body:JSON.stringify(r),headers:{"X-WP-Nonce":zumeDashboard.nonce}}).then(n=>n.json()).then(n=>{const h=new CustomEvent("user-profile:change",{bubbles:!0,detail:n});this.dispatchEvent(h)}).catch(n=>{console.error(n)}).finally(()=>{this.loading=!1})}addressCallback(e){e.features.length<1&&(addressResultsContainer.innerHTML=`
                No Locations Found
            `);let t="";e.features.forEach(s=>{t+=`
                <div class="address-result" id="${s.id}" data-place-name="${s.place_name}">
                    ${s.place_name}
                </div>
            `}),addressResultsContainer.innerHTML=t,addressResults=this.renderRoot.querySelectorAll(".address-result"),addressResults.forEach(s=>{s.addEventListener("click",function(a){const r=a.target.id,n=a.target.dataset.placeName;cityInput.value=n,zumeDashboard.mapbox_selected_id=r,addressResultsContainer.innerHTML=""})})}render(){var e;return o`
            <form action="" id="profile-form" @submit=${this.submitProfileForm}>
                ...
                <div class=""></div>
                    ...
                    <input type="text" id="city" name="city" value=${((e=this.userProfile.location)==null?void 0:e.label)??""}>
                </div>
    ...
    `);window.customElements.define("play-button",nt);class xs extends g{constructor(){super();E(this,"webShareSupported",!!window.navigator.share);E(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(t){t.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return o`
        ...
        `}renderRow({join_key:e,language_note:t,post_title:s,time_of_day_note:a,timezone_note:r,...n}){const h=n.set_a_01?"a":"b",d=h==="a"?10:20,c=`set_${h}_`,f=Date.now()/1e3;let p="";for(let m=1;m<d+1;m++){const v=m<10?`0${m}`:`${m}`,b=n[c+v];if(p=b.timestamp,f<b.timestamp)break}const u=moment(p*1e3).format("MMM Do 'YY");return o`
            <tr>
...
//# sourceMappingURL=main-a4299b38.js.map

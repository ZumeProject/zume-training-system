 ...
 */var V,q;let u=class extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Tt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return g}};u.finalized=!0,u._$litElement$=!0,(V=globalThis.litElementHydrateSupport)===null||V===void 0||V.call(globalThis,{LitElement:u});const ct=globalThis.litElementPolyfillSupport;ct==null||ct({LitElement:u});((q=globalThis.litElementVersions)!==null&&q!==void 0?q:globalThis.litElementVersions=[]).push("3.3.2");const P={makeAPlan:"getting-started",connectToCoach:"connect-to-coach"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",connectToCoach:"connectToCoach"},m={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone"},L={[m.updateName]:{slug:m.updateName,component:(i,t)=>o`
        ...
        `}_onBack(){if(this.stepIndex>0){const t=this.stepIndex-1;this._gotoStep(t)}}_onNext(){if(this.stepIndex+1<this.steps.length){const t=this.stepIndex+1;this._gotoStep(t)}}_onSkip(){const t=this.step.module;for(let e=this.stepIndex+1;e<this.steps.length-1;e++)if(this.steps[e].module!==t){this._gotoStep(e);return}this._onFinish()}_onFinish(){this.finishUrl||(window.location.href="/"),window.location.href=this.finishUrl}_gotoStep(t,e=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(t),this.step=this.steps[this.stepIndex],e)){const s=new URL(window.location.href),n=s.pathname.split("/"),r=n[n.length-1];let a="";Object.values(P).includes(r)?a=n.join("/")+"/"+this.step.slug+s.search:a=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,a)}}clampSteps(t){let e=t;return t>this.steps.length-1&&(e=this.steps.length-1),t<0&&(e=0),e}_handleHistoryPopState(){const e=new URL(window.location.href).pathname.split("/"),s=e[e.length-1];Object.values(P).includes(s)&&this._gotoStep(0,!1),this.steps.forEach(({slug:n},r)=>{s===n&&this._gotoStep(r,!1)})}makeModule(t=[],e=!1){const s={steps:[],skippable:e};return t.forEach(n=>{Object.keys(L).includes(n)&&s.steps.push(L[n])}),s}getModule(t,e=!1){const s={[$.completeProfile]:{steps:[L[m.updateName],L[m.updateLocation]],skippable:e},[$.makePlan]:{steps:[{slug:"make-a-plan",component:r=>o`
                        ...
                        `}],skippable:e}};return Object.keys(s).includes(t)?s[t]:s[$.completeProfile]}isWizardLoaded(){return Object.keys(this.modules).length!==0}loadWizard(){const t=this.getWizard();this.modules=t,this.steps=[],Object.entries(this.modules).forEach(([e,{steps:s,skippable:n}])=>{s.forEach(({component:r,slug:a})=>{const d={component:r,slug:a,module:e,skippable:n};this.steps.push(d)})})}isWizardTypeValid(){return!!Object.values(P).includes(this.type)}getWizard(){return this.isWizardTypeValid()?{[P.makeAPlan]:{[$.completeProfile]:this.makeModule([m.updateName,m.updateLocation],!0),[$.makePlan]:this.getModule($.makePlan,!0),[$.inviteFriends]:this.getModule($.inviteFriends,!0)},[P.connectToCoach]:{[$.completeProfile]:this.makeModule([m.updateName,m.updateLocation,m.updatePhone]),[$.connectToCoach]:this.getModule($.connectToCoach)}}[this.type]:{}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState)}createRenderRoot(){return this}}window.customElements.define("zume-wizard",zt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const S={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Nt=i=>(...t)=>({_$litDirective$:i,values:t});class Lt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ut=i=>i.strings===void 0,jt={},Mt=(i,t=jt)=>i._$AH=t;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ht=Nt(class extends Lt{constructor(i){if(super(i),i.type!==S.PROPERTY&&i.type!==S.ATTRIBUTE&&i.type!==S.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ut(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===g||t===f)return t;const e=i.element,s=i.name;if(i.type===S.PROPERTY){if(t===e[s])return g}else if(i.type===S.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(s))return g}else if(i.type===S.ATTRIBUTE&&e.getAttribute(s)===t+"")return g;return Mt(i),t}});class Wt extends u{static get properties(){return{name:{type:String},module:{type:String},t:{type:Object},variant:{type:String},locations:{attribute:!1},locationError:{attribute:!1},city:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this._handleLocationsChange=this._handleLocationsChange.bind(this),this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus()}render(){return o`
        <div class="inputs">
            ${this.variant==="name"?o`
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slideshow",Vt);class qt extends u{static get properties(){return{part:{type:Object}}}render(){switch(console.log(this.part),this.part.type){case"section":return o`<section-part .part=${this.part}></section-part>`;case"watch":return o`<watch-part .part=${this.part}></watch-part>`;case"discuss":return o`<discuss-part .part=${this.part}></discuss-part>`;case"read":return o`<read-part .part=${this.part}></read-part>`;case"see":return o`<see-part .part=${this.part}></see-part>`;case"share":return o`<share-part .part=${this.part}></share-part>`;case"listen":return o`<listen-part .part=${this.part}></listen-part>`;case"form":return o`<form-part .part=${this.part}></form-part>`;case"checkin":return o`<checkin-part .part=${this.part}></checkin-part>`;case"cta":default:return o`<basic-part .part=${this.part}></basic-part>`}}createRenderRoot(){return this}}customElements.define("part-switcher",qt);class Jt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("basic-part",Jt);class Zt extends u{static get properties(){return{part:{type:Object}}}render(){console.log(this.part);const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        ...
        `}createRenderRoot(){return this}}customElements.define("checkin-part",Zt);class Kt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("discuss-part",Kt);class Yt extends u{static get properties(){return{part:{type:Object}}}render(){return this.part.t,this.part.d,this.part.info,o`
            ${this.title!==null?o`<h2>${this.title}</h2>`:""}
            ${this.description!==null?o`<p>${this.description}</p>`:""}
            ${this.info!==null?o`<p>${this.info}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("form-part",Yt);class Qt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            <h2 class="brand">LISTEN</h2>
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("listen-part",Qt);class Xt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            <h2 class="brand">READ</h2>
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("read-part",Xt);class Gt extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h2>${t}</h2>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("section-part",Gt);class te extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            <h2 class="brand">SEE</h2>
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("see-part",te);class ee extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("share-part",ee);class se extends u{static get properties(){return{part:{type:Object}}}render(){const t=this.part.t??null,e=this.part.d??null,s=this.part.info??null;return o`
            ${t!==null?o`<h3>${t}</h3>`:""}
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
...
//# sourceMappingURL=main-0377f1fa.js.map

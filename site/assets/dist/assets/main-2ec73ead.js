var ot=Object.defineProperty;var lt=(i,e,t)=>e in i?ot(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var S=(i,e,t)=>(lt(i,typeof e!="symbol"?e+"":e,t),t),oe=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var A=(i,e,t)=>(oe(i,e,"read from private field"),t?t.call(i):e.get(i)),T=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},le=(i,e,t,s)=>(oe(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var z=(i,e,t)=>(oe(i,e,"access private method"),t);const Se=document.querySelector(".nav-toggle"),ct=document.querySelector("#nav");Se&&Se.addEventListener("click",i=>{ct.classList.toggle("nav--visible")});var ve;let dt=(ve=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},S(ve,"prefix","Z5_"),ve);window.ZumeStorage=dt;var j,te,qe,se,Ue,ie,Fe,J,be;class He{constructor(e){T(this,te);T(this,se);T(this,ie);T(this,J);S(this,"WIZARD_STATE_NAME","zume_wizard_state");S(this,"STALE_LIFESPAN",10*60*1e3);S(this,"MAX_LIFESPAN",60*60*1e3);T(this,j,void 0);this.moduleName=e,le(this,j,z(this,te,qe).call(this))}empty(){return Object.keys(A(this,j).data).length===0}isDataStale(){return z(this,J,be).call(this,A(this,j),this.STALE_LIFESPAN)}get(e){return A(this,j).data[e]}getAll(){return A(this,j).data}add(e,t){A(this,j).data[e]=t,z(this,ie,Fe).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(A(this,j)))}clear(){le(this,j,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}j=new WeakMap,te=new WeakSet,qe=function(){const e=z(this,se,Ue).call(this);return e&&!z(this,J,be).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},se=new WeakSet,Ue=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},ie=new WeakSet,Fe=function(){A(this,j).timestamp=Date.now()},J=new WeakSet,be=function(e,t){return Date.now()-e.timestamp>t};const w={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},ht={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},c={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...ht},ut={[c.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[c.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[c.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const K=window,$e=K.ShadowRoot&&(K.ShadyCSS===void 0||K.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ye=Symbol(),je=new WeakMap;let Be=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==ye)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if($e&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=je.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&je.set(t,e))}return e}toString(){return this.cssText}};const pt=i=>new Be(typeof i=="string"?i:i+"",void 0,ye),mt=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,n,r)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+i[r+1],i[0]);return new Be(t,i,ye)},gt=(i,e)=>{$e?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const s=document.createElement("style"),n=K.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=t.cssText,i.appendChild(s)})},xe=$e?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return pt(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ce;const Y=window,Ee=Y.trustedTypes,vt=Ee?Ee.emptyScript:"",Ce=Y.reactiveElementPolyfillSupport,fe={toAttribute(i,e){switch(e){case Boolean:i=i?vt:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},We=(i,e)=>e!==i&&(e==e||i==i),de={attribute:!0,type:String,converter:fe,reflect:!1,hasChanged:We};let D=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,s)=>{const n=this._$Ep(s,t);n!==void 0&&(this._$Ev.set(n,s),e.push(n))}),e}static createProperty(e,t=de){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const s=typeof e=="symbol"?Symbol():"__"+e,n=this.getPropertyDescriptor(e,s,t);n!==void 0&&Object.defineProperty(this.prototype,e,n)}}static getPropertyDescriptor(e,t,s){return{get(){return this[t]},set(n){const r=this[e];this[t]=n,this.requestUpdate(e,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||de}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,s=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const n of s)this.createProperty(n,t[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)t.unshift(xe(n))}else e!==void 0&&t.push(xe(e));return t}static _$Ep(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,s;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)===null||s===void 0||s.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return gt(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostConnected)===null||s===void 0?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostDisconnected)===null||s===void 0?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$EO(e,t,s=de){var n;const r=this.constructor._$Ep(e,s);if(r!==void 0&&s.reflect===!0){const a=(((n=s.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?s.converter:fe).toAttribute(t,s.type);this._$El=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$El=null}}_$AK(e,t){var s;const n=this.constructor,r=n._$Ev.get(e);if(r!==void 0&&this._$El!==r){const a=n.getPropertyOptions(r),h=typeof a.converter=="function"?{fromAttribute:a.converter}:((s=a.converter)===null||s===void 0?void 0:s.fromAttribute)!==void 0?a.converter:fe;this._$El=r,this[r]=h.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,s){let n=!0;e!==void 0&&(((s=s||this.constructor.getPropertyOptions(e)).hasChanged||We)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),s.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,s))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,r)=>this[r]=n),this._$Ei=void 0);let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(e=this._$ES)===null||e===void 0||e.forEach(n=>{var r;return(r=n.hostUpdate)===null||r===void 0?void 0:r.call(n)}),this.update(s)):this._$Ek()}catch(n){throw t=!1,this._$Ek(),n}t&&this._$AE(s)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(s=>{var n;return(n=s.hostUpdated)===null||n===void 0?void 0:n.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,s)=>this._$EO(s,this[s],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};D.finalized=!0,D.elementProperties=new Map,D.elementStyles=[],D.shadowRootOptions={mode:"open"},Ce==null||Ce({ReactiveElement:D}),((ce=Y.reactiveElementVersions)!==null&&ce!==void 0?ce:Y.reactiveElementVersions=[]).push("1.6.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var he;const X=window,H=X.trustedTypes,Oe=H?H.createPolicy("lit-html",{createHTML:i=>i}):void 0,ee="$lit$",C=`lit$${(Math.random()+"").slice(9)}$`,_e="?"+C,bt=`<${_e}>`,q=document,W=()=>q.createComment(""),Z=i=>i===null||typeof i!="object"&&typeof i!="function",Ze=Array.isArray,Ve=i=>Ze(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",ue=`[ 	
\f\r]`,F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ae=/-->/g,Pe=/>/g,P=RegExp(`>|${ue}(?:([^\\s"'>=/]+)(${ue}*=${ue}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Re=/'/g,Me=/"/g,Je=/^(?:script|style|textarea|title)$/i,Qe=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),o=Qe(1),G=Qe(2),x=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Ie=new WeakMap,N=q.createTreeWalker(q,129,null,!1),Ge=(i,e)=>{const t=i.length-1,s=[];let n,r=e===2?"<svg>":"",a=F;for(let l=0;l<t;l++){const d=i[l];let b,p,u=-1,m=0;for(;m<d.length&&(a.lastIndex=m,p=a.exec(d),p!==null);)m=a.lastIndex,a===F?p[1]==="!--"?a=Ae:p[1]!==void 0?a=Pe:p[2]!==void 0?(Je.test(p[2])&&(n=RegExp("</"+p[2],"g")),a=P):p[3]!==void 0&&(a=P):a===P?p[0]===">"?(a=n??F,u=-1):p[1]===void 0?u=-2:(u=a.lastIndex-p[2].length,b=p[1],a=p[3]===void 0?P:p[3]==='"'?Me:Re):a===Me||a===Re?a=P:a===Ae||a===Pe?a=F:(a=P,n=void 0);const v=a===P&&i[l+1].startsWith("/>")?" ":"";r+=a===F?d+bt:u>=0?(s.push(b),d.slice(0,u)+ee+d.slice(u)+C+v):d+C+(u===-2?(s.push(void 0),l):v)}const h=r+(i[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Oe!==void 0?Oe.createHTML(h):h,s]};class V{constructor({strings:e,_$litType$:t},s){let n;this.parts=[];let r=0,a=0;const h=e.length-1,l=this.parts,[d,b]=Ge(e,t);if(this.el=V.createElement(d,s),N.currentNode=this.el.content,t===2){const p=this.el.content,u=p.firstChild;u.remove(),p.append(...u.childNodes)}for(;(n=N.nextNode())!==null&&l.length<h;){if(n.nodeType===1){if(n.hasAttributes()){const p=[];for(const u of n.getAttributeNames())if(u.endsWith(ee)||u.startsWith(C)){const m=b[a++];if(p.push(u),m!==void 0){const v=n.getAttribute(m.toLowerCase()+ee).split(C),f=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:f[2],strings:v,ctor:f[1]==="."?Ye:f[1]==="?"?Xe:f[1]==="@"?et:Q})}else l.push({type:6,index:r})}for(const u of p)n.removeAttribute(u)}if(Je.test(n.tagName)){const p=n.textContent.split(C),u=p.length-1;if(u>0){n.textContent=H?H.emptyScript:"";for(let m=0;m<u;m++)n.append(p[m],W()),N.nextNode(),l.push({type:2,index:++r});n.append(p[u],W())}}}else if(n.nodeType===8)if(n.data===_e)l.push({type:2,index:r});else{let p=-1;for(;(p=n.data.indexOf(C,p+1))!==-1;)l.push({type:7,index:r}),p+=C.length-1}r++}}static createElement(e,t){const s=q.createElement("template");return s.innerHTML=e,s}}function I(i,e,t=i,s){var n,r,a,h;if(e===x)return e;let l=s!==void 0?(n=t._$Co)===null||n===void 0?void 0:n[s]:t._$Cl;const d=Z(e)?void 0:e._$litDirective$;return(l==null?void 0:l.constructor)!==d&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),d===void 0?l=void 0:(l=new d(i),l._$AT(i,t,s)),s!==void 0?((a=(h=t)._$Co)!==null&&a!==void 0?a:h._$Co=[])[s]=l:t._$Cl=l),l!==void 0&&(e=I(i,l._$AS(i,e.values),l,s)),e}class Ke{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:n}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:q).importNode(s,!0);N.currentNode=r;let a=N.nextNode(),h=0,l=0,d=n[0];for(;d!==void 0;){if(h===d.index){let b;d.type===2?b=new U(a,a.nextSibling,this,e):d.type===1?b=new d.ctor(a,d.name,d.strings,this,e):d.type===6&&(b=new tt(a,this,e)),this._$AV.push(b),d=n[++l]}h!==(d==null?void 0:d.index)&&(a=N.nextNode(),h++)}return r}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class U{constructor(e,t,s,n){var r;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=n,this._$Cp=(r=n==null?void 0:n.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=I(this,e,t),Z(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==x&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ve(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==_&&Z(this._$AH)?this._$AA.nextSibling.data=e:this.$(q.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:n}=e,r=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=V.createElement(n.h,this.options)),n);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(s);else{const a=new Ke(r,this),h=a.u(this.options);a.v(s),this.$(h),this._$AH=a}}_$AC(e){let t=Ie.get(e.strings);return t===void 0&&Ie.set(e.strings,t=new V(e)),t}T(e){Ze(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,n=0;for(const r of e)n===t.length?t.push(s=new U(this.k(W()),this.k(W()),this,this.options)):s=t[n],s._$AI(r),n++;n<t.length&&(this._$AR(s&&s._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const n=e.nextSibling;e.remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Q{constructor(e,t,s,n,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,n){const r=this.strings;let a=!1;if(r===void 0)e=I(this,e,t,0),a=!Z(e)||e!==this._$AH&&e!==x,a&&(this._$AH=e);else{const h=e;let l,d;for(e=r[0],l=0;l<r.length-1;l++)d=I(this,h[s+l],t,l),d===x&&(d=this._$AH[l]),a||(a=!Z(d)||d!==this._$AH[l]),d===_?e=_:e!==_&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}a&&!n&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ye extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}}const ft=H?H.emptyScript:"";class Xe extends Q{constructor(){super(...arguments),this.type=4}j(e){e&&e!==_?this.element.setAttribute(this.name,ft):this.element.removeAttribute(this.name)}}class et extends Q{constructor(e,t,s,n,r){super(e,t,s,n,r),this.type=5}_$AI(e,t=this){var s;if((e=(s=I(this,e,t,0))!==null&&s!==void 0?s:_)===x)return;const n=this._$AH,r=e===_&&n!==_||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,a=e!==_&&(n===_||r);r&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class tt{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){I(this,e)}}const $t={O:ee,P:C,A:_e,C:1,M:Ge,L:Ke,D:Ve,R:I,I:U,V:Q,H:Xe,N:et,U:Ye,F:tt},Te=X.litHtmlPolyfillSupport;Te==null||Te(V,U),((he=X.litHtmlVersions)!==null&&he!==void 0?he:X.litHtmlVersions=[]).push("2.7.3");const yt=(i,e,t)=>{var s,n;const r=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=r._$litPart$;if(a===void 0){const h=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=a=new U(e.insertBefore(W(),h),h,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pe,me;let g=class extends D{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=yt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return x}};g.finalized=!0,g._$litElement$=!0,(pe=globalThis.litElementHydrateSupport)===null||pe===void 0||pe.call(globalThis,{LitElement:g});const ze=globalThis.litElementPolyfillSupport;ze==null||ze({LitElement:g});((me=globalThis.litElementVersions)!==null&&me!==void 0?me:globalThis.litElementVersions=[]).push("3.3.2");class _t extends g{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new He}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.steps.length===0?o`
        ...
        `}footer(){return this.stepIndex===this.steps.length-1?this.finishButton():""}_onBack(){if(this.stepIndex>0){const e=this.stepIndex-1;this._gotoStep(e)}}_onNext(){if(this.stepIndex+1<this.steps.length){const e=this.stepIndex+1;this._gotoStep(e)}else this._onFinish()}_onSkip(){const e=this.step.module;for(let t=this.stepIndex+1;t<this.steps.length;t++)if(this.steps[t].module!==e){this._gotoStep(t);return}this._onFinish()}_onQuit(){this._onFinish(!0)}_onFinish(e=!1){this.stateManager.clear(),this.finishUrl||(window.location.href="/");const t=new URL(this.finishUrl);e||(this.type===w.checkin?t.searchParams.set("completed",this.type):t.searchParams.set("completed",this.type)),window.location.href=t}_gotoStep(e,t=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(e),this.step=this.steps[this.stepIndex],t)){const s=new URL(window.location.href),n=s.pathname.split("/"),r=n[n.length-1];let a="";Object.values(w).includes(r)?a=n.join("/")+"/"+this.step.slug+s.search:a=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,a)}}clampSteps(e){let t=e;return e>this.steps.length-1&&(t=this.steps.length-1),e<0&&(t=0),t}_handleHistoryPopState(e=!1){const s=new URL(window.location.href).pathname.split("/"),n=s[s.length-1];Object.values(w).includes(n)&&this._gotoStep(0,!1);let r="",a=0;this.steps.forEach(({slug:h,module:l},d)=>{if(r!==l&&(r=l,a=d),n===h){if(e===!0&&this.stateManager.isDataStale()){this._gotoStep(a);return}this._gotoStep(d,!1)}})}_handlePlanDecision(e){switch(e.target.dataset.decision){case"make":this.updateWizard(w.makeAGroup);break;case"join":this.updateWizard(w.joinAPlan);break;case"skip":default:this._onSkip();break}}_handleLoading(e){const{loading:t}=e.detail;this.loading=t}makeModule(e=[],t=!1){const s={steps:[],skippable:t};return e.forEach(n=>{Object.keys(L).includes(n)&&s.steps.push(L[n])}),s}getModule(e,t=!1){const s={[$.completeProfile]:{steps:[L[c.updateName],L[c.updateLocation]],skippable:t},[$.planDecision]:{steps:[{slug:"plan-decision",component:(r,a,h)=>o`
                            <div class=${`stack ${h}`}>
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},st=i=>(...e)=>({_$litDirective$:i,values:e});class it{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:kt}=$t,wt=i=>i.strings===void 0,Le=()=>document.createComment(""),B=(i,e,t)=>{var s;const n=i._$AA.parentNode,r=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=n.insertBefore(Le(),r),h=n.insertBefore(Le(),r);t=new kt(a,h,i,i.options)}else{const a=t._$AB.nextSibling,h=t._$AM,l=h!==i;if(l){let d;(s=t._$AQ)===null||s===void 0||s.call(t,i),t._$AM=i,t._$AP!==void 0&&(d=i._$AU)!==h._$AU&&t._$AP(d)}if(a!==r||l){let d=t._$AA;for(;d!==a;){const b=d.nextSibling;n.insertBefore(d,r),d=b}}}return t},R=(i,e,t=i)=>(i._$AI(e,t),i),St={},nt=(i,e=St)=>i._$AH=e,jt=i=>i._$AH,ge=i=>{var e;(e=i._$AP)===null||e===void 0||e.call(i,!1,!0);let t=i._$AA;const s=i._$AB.nextSibling;for(;t!==s;){const n=t.nextSibling;t.remove(),t=n}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=st(class extends it{constructor(i){if(super(i),i.type!==M.PROPERTY&&i.type!==M.ATTRIBUTE&&i.type!==M.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!wt(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===x||e===_)return e;const t=i.element,s=i.name;if(i.type===M.PROPERTY){if(e===t[s])return x}else if(i.type===M.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return x}else if(i.type===M.ATTRIBUTE&&t.getAttribute(s)===e+"")return x;return nt(i),e}});class Et extends g{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,jsObject.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return o`
        ...
        `}_handleDone(e){e&&e.preventDefault(),this._sendDoneStepEvent()}_sendDoneStepEvent(){const e=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(e)}_handleFinish(){setTimeout(()=>{this._sendDoneStepEvent()},3e3)}createRenderRoot(){return this}}customElements.define("make-group",It);function Tt(i){return i?JSON.parse('{"'+i.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}function zt(i,e){let t={};const s=i.split("/").filter(r=>r!=""),n=e.split("/").filter(r=>r!="");return s.map((r,a)=>{/^:/.test(r)&&(t[r.substring(1)]=n[a])}),t}function Lt(i){return i?new RegExp("^(|/)"+i.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}function Dt(i,e){if(Lt(e).test(i))return!0}function Nt(i){return class extends i{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...e){super(...e),this.route="",this.canceled=!1}connectedCallback(...e){super.connectedCallback(...e),this.routing(this.constructor.routes,(...t)=>this.router(...t)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...t)=>this.router(...t))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(e,t,s,n,r,a){a&&a(e,t,s,n),r(e,t,s,n)}routing(e,t){this.canceled=!0;const s=decodeURI(window.location.pathname),n=decodeURI(window.location.search);let r=e.filter(l=>l.pattern==="*")[0],a=e.filter(l=>l.pattern!=="*"&&Dt(s,l.pattern))[0],h=Tt(n);a?(a.params=zt(a.pattern,s),a.data=a.data||{},a.authentication&&a.authentication.authenticate&&typeof a.authentication.authenticate=="function"?(this.canceled=!1,Promise.resolve(a.authentication.authenticate.bind(this).call()).then(l=>{this.canceled||(l?a.authorization&&a.authorization.authorize&&typeof a.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(a.authorization.authorize.bind(this).call()).then(d=>{this.canceled||(d?this.routed(a.name,a.params,h,a.data,t,a.callback):this.routed(a.authorization.unauthorized.name,a.params,h,a.data,t,a.callback))})):this.routed(a.name,a.params,h,a.data,t,a.callback):this.routed(a.authentication.unauthenticated.name,a.params,h,a.data,t,a.callback))})):a.authorization&&a.authorization.authorize&&typeof a.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(a.authorization.authorize.bind(this).call()).then(l=>{this.canceled||(l?this.routed(a.name,a.params,h,a.data,t,a.callback):this.routed(a.authorization.unauthorized.name,a.params,h,a.data,t,a.callback))})):this.routed(a.name,a.params,h,a.data,t,a.callback)):r&&(r.data=r.data||{},this.routed(r.name,{},h,r.data,t,r.callback))}}}function Ht(i){return class extends i{navigate(e){window.history.pushState({},null,e),window.dispatchEvent(new CustomEvent("route"))}}}function qt(){return[{name:"root",pattern:`${jsObject.base_url}`,icon:"",type:"dash-link",translation:"",data:{component:""}},{name:"getting-started",pattern:`${jsObject.base_url}/getting-started`,icon:"zume-start",type:"dash-link",translation:jsObject.translations.getting_started,data:{component:"dash-getting-started"}},{name:"set-profile",pattern:`${jsObject.urls.set_profile_wizard}`,parent:"getting-started",icon:"zume-profile",type:"direct-link",translation:jsObject.translations.set_profile,explanation:jsObject.translations.set_profile_explanation,data:{component:""}},{name:"plan-a-training",pattern:`${jsObject.urls.plan_training_wizard}`,parent:"getting-started",icon:"zume-start",type:"direct-link",translation:jsObject.translations.plan_a_training,explanation:jsObject.translations.plan_a_training_explanation,data:{component:""}},{name:"get-a-coach",pattern:`${jsObject.urls.get_coach_wizard}`,parent:"getting-started",icon:"zume-coach",type:"direct-link",translation:jsObject.translations.get_a_coach,explanation:jsObject.translations.get_a_coach_explanation,data:{component:""}},{name:"training",pattern:`${jsObject.base_url}/training`,icon:"zume-training",type:"dash-link",translation:jsObject.translations.training,data:{component:"dash-training"}},{name:"my-training",pattern:`${jsObject.base_url}/my-training`,parent:"training",icon:"zume-group",type:"dash-link",translation:jsObject.translations.my_training,explanation:jsObject.translations.my_training_explanation,data:{component:"dash-trainings"}},{name:"my-progress",pattern:`${jsObject.base_url}/my-progress`,parent:"training",icon:"zume-progress",type:"dash-link",translation:jsObject.translations.my_progress,explanation:jsObject.translations.my_progress_explanation,data:{component:"dash-progress"}},{name:"3-month-plan",pattern:`${jsObject.base_url}/3-month-plan`,parent:"training",icon:"zume-plans",type:"dash-link",translation:jsObject.translations["3_month_plan"],explanation:jsObject.translations["3_month_plan_explanation"],data:{component:"dash-progress"}},{name:"practicing",pattern:`${jsObject.base_url}/practicing`,icon:"zume-practicing",type:"dash-link",translation:jsObject.translations.practicing,data:{component:"dash-practicing"}},{name:"my-coach",pattern:`${jsObject.base_url}/my-coach`,parent:"practicing",icon:"zume-coach",type:"dash-link",translation:jsObject.translations.my_coach,explanation:jsObject.translations.my_coach_explanation,data:{component:"dash-coach"}},{name:"my-tools",pattern:`${jsObject.base_url}/my-tools`,parent:"practicing",icon:"zume-tools",type:"dash-link",translation:jsObject.translations.my_tools,explanation:jsObject.translations.my_tools_explanation,data:{component:"dash-tools"}},{name:"my-plans",pattern:`${jsObject.base_url}/my-plans`,parent:"practicing",icon:"zume-plans",type:"dash-link",translation:jsObject.translations.my_plans,explanation:jsObject.translations.my_plans_explanation,data:{component:"dash-plans"}},{name:"my-churches",pattern:`${jsObject.base_url}/my-churches`,parent:"practicing",icon:"zume-churches",type:"dash-link",translation:jsObject.translations.my_churches,explanation:jsObject.translations.my_churches_explanation,data:{component:"dash-churches"}},{name:"my-maps",pattern:`${jsObject.base_url}/my-maps`,parent:"practicing",icon:"zume-maps",type:"dash-link",translation:jsObject.translations.my_maps,explanation:jsObject.translations.my_maps_explanation,data:{component:"dash-maps"}},{name:"not-found",pattern:"*",icon:"",type:"dash-link",data:{component:"dash-not-found"}}]}class y extends Nt(g){static get properties(){return{route:{type:String},params:{type:Object},query:{type:Object},menuOffset:{type:Number,attribute:!1},userProfile:{type:Object,attribute:!1}}}static get routes(){const e={1:"dash-getting-started",2:"dash-training",3:"dash-practicing"},t=jsObject.user_stage.value||1,s=t<4?t:3;return qt().map(r=>(r.name==="root"&&(r.data.component=e[s]),r))}static getRoute(e){return y.routes.find(s=>s.name===e)}static childRoutesOf(e){return y.routes.filter(({parent:s})=>s===e)}constructor(){super(),this.route="",this.params={},this.query={},this.data={},this.menuOffset=0,this.userProfile=jsObject.user_profile,this.userState=jsObject.user_stage.state,this.updateUserProfile=this.updateUserProfile.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("user-profile:change",this.updateUserProfile),this.addEventListener("toggle-dashboard-sidebar",this.toggleSidebar)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("user-profile:change",this.updateUserProfile),this.removeEventListener("toggle-dashboard-sidebar",this.toggleSidebar)}firstUpdated(){this.menuOffset=this.getOffsetTop(".sidebar-wrapper")}router(e,t,s,n){this.route=e,this.params=t,this.query=s,this.data=n}makeHref(e){return`${jsObject.base_url}/${e}`}makeHrefRoute(e){const s=y.routes.find(({name:n})=>n===e);return s?s.pattern:(console.error("MISSING ROUTE",e),"")}renderRoute(){const{component:e}=this.data;return e?document.createElement(e):""}getOffsetTop(e){return this.querySelector(e).offsetTop}toggleSidebar(){const e=document.querySelector(".dashboard__sidebar"),t=document.querySelector(".sidebar__trigger-close-background"),s="200";e.style.transitionDuration=s,t.style.transitionDuration=s;const n=e.dataset.state;n==="open"&&(e.dataset.state="closed",t.style.opacity=0,setTimeout(()=>{t.style.visibility="hidden"},s)),(!n||n==="closed")&&(e.dataset.state="open",t.style.opacity="initial",t.style.visibility="visible")}updateUserProfile(e){const t=e.detail;this.userProfile=t}createInitials(e){return typeof e!="string"||e.length===0?"":e.split(" ").map(s=>s.length>0?s[0].toUpperCase():"").slice(0,2).join("")}static getCompletedStatus(e){const t=jsObject.user_stage.state;return!!(e==="set-profile"&&t.set_profile||e==="get-a-coach"&&t.requested_a_coach||e==="plan-a-training"&&(t.plan_created||t.joined_online_training))}static getLockedStatus(e){const t=jsObject.user_stage.state;return!!(e==="my-plans"&&!t.made_3_month_plan||["my-churches","my-maps"].includes(e)&&!t.join_community||e==="3-month-plan"&&!t.can_create_3_month_plan)}getGettingStartedPercentage(){const e=["get-a-coach","set-profile","plan-a-training"],t=e.reduce((s,n)=>y.getCompletedStatus(n)?s+1:s,0);return Math.round(t/e.length*100)}openProfile(){const e=document.querySelector("#profile-modal");jQuery(e).foundation("open")}closeProfile(){const e=document.querySelector("#profile-modal");jQuery(e).foundation("open")}render(){return o`
                        ...
                        >
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${y.childRoutesOf("getting-started").map(e=>o`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        ...
                                                        ?completed=${y.getCompletedStatus(e.name)}
                                                    ></nav-link>
                            ...
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${y.childRoutesOf("training").map(e=>o`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(e.name)}
                                                        icon=${e.icon}
                                                        text=${e.translation}
                                                        ?locked=${y.getLockedStatus(e.name)}
                                                    ></nav-link>
                            ...
                            <li class="menu-section">
                                ...
                                ></nav-link>
                                <ul class="nested is-active">
                                    ${y.childRoutesOf("practicing").map(e=>o`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(e.name)}
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",Ut);class Ft extends O{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",Ft);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const De=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},ne=st(class extends it{constructor(i){if(super(i),i.type!==M.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],r=[];let a=0;for(const h of i)n[a]=s?s(h,a):a,r[a]=t(h,a),a++;return{values:r,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const r=jt(i),{values:a,keys:h}=this.dt(e,t,s);if(!Array.isArray(r))return this.ht=h,a;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],d=[];let b,p,u=0,m=r.length-1,v=0,f=a.length-1;for(;u<=m&&v<=f;)if(r[u]===null)u++;else if(r[m]===null)m--;else if(l[u]===h[v])d[v]=R(r[u],a[v]),u++,v++;else if(l[m]===h[f])d[f]=R(r[m],a[f]),m--,f--;else if(l[u]===h[f])d[f]=R(r[u],a[f]),B(i,d[f+1],r[u]),u++,f--;else if(l[m]===h[v])d[v]=R(r[m],a[v]),B(i,r[u],r[m]),m--,v++;else if(b===void 0&&(b=De(h,v,f),p=De(l,u,m)),b.has(l[u]))if(b.has(l[m])){const E=p.get(h[v]),re=E!==void 0?r[E]:null;if(re===null){const we=B(i,r[u]);R(we,a[v]),d[v]=we}else d[v]=R(re,a[v]),B(i,r[u],re),r[E]=null;v++}else ge(r[m]),m--;else ge(r[u]),u++;for(;v<=f;){const E=B(i,d[f+1]);R(E,a[v]),d[v++]=E}for(;u<=m;){const E=r[u++];E!==null&&ge(E)}return this.ht=h,nt(i,d),x}});class Bt extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.userId=jsObject.user_profile.user_id}firstUpdated(){this.getCtas()}getCtas(){makeRequest("POST","user_ctas",{user_id:this.userId},"zume_system/v1").done(e=>{const t=Object.values(e);this.allCtas=t,this.ctas=this.shuffleArray(t).slice(0,3)})}shuffleArray(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}renderCta({content:e,content_template:t}){if(t==="card")return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-top-level",ae);class Wt extends ae{constructor(){super("getting-started")}createRenderRoot(){return this}}customElements.define("dash-getting-started",Wt);class Zt extends O{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
                    <h1 class="h3">Maps</h1>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",Zt);class Vt extends O{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-progress",Gt);class Kt extends O{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-tools",Kt);class Yt extends ae{constructor(){super("training")}createRenderRoot(){return this}}customElements.define("dash-training",Yt);class Xt extends O{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.loading=!0,this.route=y.getRoute("my-training")}firstUpdated(){super.firstUpdated()}updated(){jQuery(document).foundation()}render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",Xt);class es extends g{firstUpdated(){const e=this.offsetTop;this.style.top=e+"px"}render(){return o`
            <div class="dashboard__header right">
                <dash-sidebar-toggle displayOn="medium"></dash-sidebar-toggle>
                <launch-course></launch-course>
            </div>
        `}createRenderRoot(){return this}}customElements.define("dash-header-right",es);class ts extends g{static get properties(){return{displayOn:{type:String}}}constructor(){super(),this.displayOn="large"}toggleSidebar(){const e=new CustomEvent("toggle-dashboard-sidebar",{bubbles:!0});this.dispatchEvent(e)}render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",ts);class ke extends Ht(g){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},directLink:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.directLink=!1}handleClick(e){this.directLink||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return o`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",ke);class ss extends ke{constructor(){super()}renderText(){return this.text.split(" ").map(e=>o`
            <span>${e}</span>
        ...
        `}}customElements.define("grid-link",ss);class is extends ke{constructor(){super()}renderText(){return this.text.split(" ").map(e=>o`
            <span>${e}</span>
        `)}getIcon(){return this.locked?this.icon+"-locked":this.icon}render(){return o`
                        ...
                        ${this.completed?o`
                            ...
                            `:o`
                                <a
                                    ...
                                    @click=${this.handleClick}
                                >
                                    ${this.locked?jsObject.translations.preview:this.directLink?this.text:jsObject.translations.view_now}
                                </a>
                            `}
                    </div>
                </div>
            </div>
        `}}customElements.define("list-link",is);class ns extends g{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}updated(){jQuery(document).foundation()}render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("launch-course",ns);class as extends g{constructor(){super();S(this,"addressCallback",t=>{t.features.length<1?this.locations=-1:this.locations=t.features});S(this,"processLocation",debounce(getAddressSuggestions(this.addressCallback,jsObject.map_key)));this.userProfile={},this.locations=[]}static get properties(){return{userProfile:{type:Object},loading:{type:Boolean,attribute:!1},locations:{type:Array,attribute:!1}}}firstUpdated(){this.nameInput=this.renderRoot.querySelector("#full_name"),this.phoneInput=this.renderRoot.querySelector("#phone"),this.emailInput=this.renderRoot.querySelector("#email"),this.cityInput=this.renderRoot.querySelector("#city"),this.prefferedLanguageInput=this.renderRoot.querySelector("#preferred-language"),this.addressResultsContainer=this.renderRoot.querySelector("#address_results")}submitProfileForm(t){t.preventDefault();const s=this.nameInput.value,n=this.emailInput.value,r=this.phoneInput.value,a=this.prefferedLanguageInput.value,h={name:s,phone:r,email:n,preferred_language:a};h.location_grid_meta=getLocationGridFromMapbox(this.mapboxSelectedId,this.userProfile.location),this.loading=!0,fetch(jsObject.rest_endpoint+"/profile",{method:"POST",body:JSON.stringify(h),headers:{"X-WP-Nonce":jsObject.nonce}}).then(l=>l.json()).then(l=>{const d=new CustomEvent("user-profile:change",{bubbles:!0,detail:l});this.dispatchEvent(d)}).catch(l=>{console.error(l)}).finally(()=>{this.loading=!1})}selectAddress(t){const s=t.target.id,n=t.target.dataset.placeName;this.cityInput.value=n,this.mapboxSelectedId=s,this.locations=[]}render(){var t;return o`
            <form action="" id="profile-form" @submit=${this.submitProfileForm}>
                ...
                <div>
                    ...
                    ${Object.values(jsObject.zume_languages_by_code).map(s=>o`
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slide",k);class rs extends k{render(){return o`
        ...
        `}}customElements.define("activity-slide",rs);class os extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover">
        ...
        `}}customElements.define("break-slide",os);class ls extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover">
        ...
        `}}customElements.define("center-slide",ls);class cs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("checkin-slide",cs);class ds extends k{render(){return o`
            <div class="slides-card">
                <div class="cover">
                    <div class="center activity-card" data-large>
                        <p>${this.slide.center[0]}</p>
        ...
        `}}customElements.define("congratulations-slide",ds);class hs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("discuss-slide",hs);class us extends k{render(){return o`
            <div class="slides-card">
                <div class="cover">
        ...
        `}}customElements.define("final-slide",us);class ps extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column right">
                    <div>
        ...
        `}}customElements.define("left-image-slide",ps);class ms extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover">
        ...
        `}}customElements.define("next-steps-slide",ms);class gs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("obey-slide",gs);class vs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("overview-slide",vs);class bs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("pray-slide",bs);class fs extends k{render(){return o`
            <div>
                <div class="slides-card">
                    ${this.renderProgressBar()}
        ...
        `}}customElements.define("title-slide",fs);class $s extends k{render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("course-presenter",_s);class ks extends g{static get properties(){return{sections:{type:Array}}}render(){return o`
            <div class="container">
    ...
    `);window.customElements.define("play-button",at);class js extends g{constructor(){super();S(this,"webShareSupported",!!window.navigator.share);S(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(t){t.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return o`
        ...
        `}renderRow({join_key:e,language_note:t,post_title:s,time_of_day_note:n,timezone_note:r,...a}){const h=a.set_a_01?"a":"b",l=h==="a"?10:20,d=`set_${h}_`,b=Date.now()/1e3;let p="";for(let m=1;m<l+1;m++){const v=m<10?`0${m}`:`${m}`,f=a[d+v];if(p=f.timestamp,b<f.timestamp)break}const u=moment(p*1e3).format("MMM Do 'YY");return o`
            <tr>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",rt);class Cs extends rt{static get properties(){return{percent:{type:Number},type:{type:String}}}constructor(){super(),this.radius=50,this.lineWidth=15,this.percent=0,this.borderWidth=3,this.type="heard"}width(){return(this.radius+this.lineWidth)*2}getIconSvg(){switch(this.type){case"heard":return G`
...
//# sourceMappingURL=main-2ec73ead.js.map

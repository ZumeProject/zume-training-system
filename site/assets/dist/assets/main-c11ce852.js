var et=Object.defineProperty;var tt=(s,e,t)=>e in s?et(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var C=(s,e,t)=>(tt(s,typeof e!="symbol"?e+"":e,t),t),se=(s,e,t)=>{if(!e.has(s))throw TypeError("Cannot "+t)};var A=(s,e,t)=>(se(s,e,"read from private field"),t?t.call(s):e.get(s)),M=(s,e,t)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,t)},ie=(s,e,t,i)=>(se(s,e,"write to private field"),i?i.call(s,t):e.set(s,t),t);var T=(s,e,t)=>(se(s,e,"access private method"),t);import{createApp as st}from"https://unpkg.com/petite-vue?module";const fe=document.querySelector(".nav-toggle"),it=document.querySelector("#nav");fe&&fe.addEventListener("click",s=>{it.classList.toggle("nav--visible")});const nt=({title:s,url:e,copyFeedback:t,shareFeedback:i})=>({title:s,url:e,webShareSupported:navigator.share,clipboardSupported:navigator.clipboard,shareFeedback:"",copyFeedback:"",noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported},share(){navigator.share({title:s,url:e,text:s}).then(()=>{this.shareFeedback=i,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(n=>console.error("Error sharing",n))},copyLink(){navigator.clipboard.writeText(e).then(()=>{this.copyFeedback=t,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(n=>console.error(n))}});window.zumeInitShareLinks=()=>{st({share:nt}).mount()};var de;let at=(de=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},C(de,"prefix","Z5_"),de);window.ZumeStorage=at;var k,Y,Ie,X,je,ee,Oe,V,ue;class Te{constructor(e){M(this,Y);M(this,X);M(this,ee);M(this,V);C(this,"WIZARD_STATE_NAME","zume_wizard_state");C(this,"STALE_LIFESPAN",10*60*1e3);C(this,"MAX_LIFESPAN",60*60*1e3);M(this,k,void 0);this.moduleName=e,ie(this,k,T(this,Y,Ie).call(this))}empty(){return Object.keys(A(this,k).data).length===0}isDataStale(){return T(this,V,ue).call(this,A(this,k),this.STALE_LIFESPAN)}get(e){return A(this,k).data[e]}getAll(){return A(this,k).data}add(e,t){A(this,k).data[e]=t,T(this,ee,Oe).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(A(this,k)))}clear(){ie(this,k,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}k=new WeakMap,Y=new WeakSet,Ie=function(){const e=T(this,X,je).call(this);return e&&!T(this,V,ue).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},X=new WeakSet,je=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},ee=new WeakSet,Oe=function(){A(this,k).timestamp=Date.now()},V=new WeakSet,ue=function(e,t){return Date.now()-e.timestamp>t};const y={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},rt={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},l={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...rt},ot={[l.updateName]:{field:"name",testExistance:(s,e)=>e.has_set_name},[l.updateLocation]:{field:"location",testExistance:s=>!(s.source&&s.source==="ip")},[l.updatePhone]:{field:"phone",testExistance:s=>!!s}};/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ge=s=>(...e)=>({_$litDirective$:s,values:e});class Qe{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:ft}=gt,$t=s=>s.strings===void 0,Pe=()=>document.createComment(""),U=(s,e,t)=>{var i;const n=s._$AA.parentNode,o=e===void 0?s._$AB:e._$AA;if(t===void 0){const a=n.insertBefore(Pe(),o),d=n.insertBefore(Pe(),o);t=new ft(a,d,s,s.options)}else{const a=t._$AB.nextSibling,d=t._$AM,h=d!==s;if(h){let c;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(c=s._$AU)!==d._$AU&&t._$AP(c)}if(a!==o||h){let c=t._$AA;for(;c!==a;){const v=c.nextSibling;n.insertBefore(c,o),c=v}}}return t},z=(s,e,t=s)=>(s._$AI(e,t),s),_t={},Ke=(s,e=_t)=>s._$AH=e,yt=s=>s._$AH,he=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const n=t.nextSibling;t.remove(),t=n}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=Ge(class extends Qe{constructor(s){if(super(s),s.type!==P.PROPERTY&&s.type!==P.ATTRIBUTE&&s.type!==P.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!$t(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===w||e===_)return e;const t=s.element,i=s.name;if(s.type===P.PROPERTY){if(e===t[i])return w}else if(s.type===P.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return w}else if(s.type===P.ATTRIBUTE&&t.getAttribute(i)===e+"")return w;return Ke(s),e}});class wt extends u{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return r`
 ...
 */const Re=(s,e,t)=>{const i=new Map;for(let n=e;n<=t;n++)i.set(s[n],n);return i},Bt=Ge(class extends Qe{constructor(s){if(super(s),s.type!==P.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const n=[],o=[];let a=0;for(const d of s)n[a]=i?i(d,a):a,o[a]=t(d,a),a++;return{values:o,keys:n}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){var n;const o=yt(s),{values:a,keys:d}=this.dt(e,t,i);if(!Array.isArray(o))return this.ht=d,a;const h=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],c=[];let v,m,p=0,g=o.length-1,b=0,f=a.length-1;for(;p<=g&&b<=f;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(h[p]===d[b])c[b]=z(o[p],a[b]),p++,b++;else if(h[g]===d[f])c[f]=z(o[g],a[f]),g--,f--;else if(h[p]===d[f])c[f]=z(o[p],a[f]),U(s,c[f+1],o[p]),p++,f--;else if(h[g]===d[b])c[b]=z(o[g],a[b]),U(s,o[p],o[g]),g--,b++;else if(v===void 0&&(v=Re(d,b,f),m=Re(h,p,g)),v.has(h[p]))if(v.has(h[g])){const S=m.get(d[b]),te=S!==void 0?o[S]:null;if(te===null){const ve=U(s,o[p]);z(ve,a[b]),c[b]=ve}else c[b]=z(te,a[b]),U(s,o[p],te),o[S]=null;b++}else he(o[g]),g--;else he(o[p]),p++;for(;b<=f;){const S=U(s,c[f+1]);z(S,a[b]),c[b++]=S}for(;p<=g;){const S=o[p++];S!==null&&he(S)}return this.ht=d,Ke(s,c),w}});class Wt extends u{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.loading=!0,this.route=E.getRoute("my-plans"),this.filterName="my-plans-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){const e=this.filterStatus||"";this.fetchCommitments(e)}updated(){jQuery(document).foundation()}fetchCommitments(){const e=this.filterStatus;makeRequest("GET","commitments",{status:e},"zume_system/v1").done(t=>{this.commitments=t}).always(()=>{this.loading=!1})}openCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(e){this.value=""})}addCommitments(){jQuery(".post-training-plan").each(function(e){const t=jQuery(this).val();if(t){const n=jQuery(this).prev().text();console.log("Question: "+n+" Answer: "+t);var i=new Date;i.setDate(i.getDate()+30),this.value="",makeRequest("POST","commitment",{user_id:zumeDashboard.user_profile.user_id,post_id:zumeDashboard.user_profile.contact_id,meta_key:"tasks",note:"Question: "+n+" Answer: "+t,question:n,answer:t,date:i,category:"post_training_plan"},"zume_system/v1").done(o=>{console.log(o)})}}),this.closeCommitmentsModal()}completeCommitment(e){let t={id:e,user_id:zumeDashboard.user_profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(i=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:zumeDashboard.user_profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(i=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}filterCommitments(e){this.filterStatus=e,this.fetchCommitments(e),ZumeStorage.save(this.filterName,e),this.closeFilter()}closeFilter(){const e=this.querySelector("#filter-menu");jQuery(e).foundation("close")}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:i,id:n,status:o}=e;return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-plans",Wt);class Vt extends u{constructor(){super(),this.routeName="practicing",this.route=E.getRoute(this.routeName),this.routes=E.childRoutesOf(this.routeName)}render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-training",Jt);class Ye extends jt(u){static get properties(){return{href:{type:String},class:{type:String},disabled:{type:Boolean},completed:{type:Boolean},directLink:{type:Boolean},icon:{type:String},text:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.disabled=!1,this.completed=!1,this.directLink=!1}handleClick(e){this.directLink||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return r`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}}customElements.define("grid-link",Gt);class Qt extends u{updated(){jQuery(document).foundation()}render(){return r`

var Xe=Object.defineProperty;var et=(s,e,t)=>e in s?Xe(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var A=(s,e,t)=>(et(s,typeof e!="symbol"?e+"":e,t),t),se=(s,e,t)=>{if(!e.has(s))throw TypeError("Cannot "+t)};var E=(s,e,t)=>(se(s,e,"read from private field"),t?t.call(s):e.get(s)),M=(s,e,t)=>{if(e.has(s))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(s):e.set(s,t)},ie=(s,e,t,i)=>(se(s,e,"write to private field"),i?i.call(s,t):e.set(s,t),t);var T=(s,e,t)=>(se(s,e,"access private method"),t);import{createApp as tt}from"https://unpkg.com/petite-vue?module";var k,Y,Te,X,Ie,ee,je,V,de;class Me{constructor(e){M(this,Y);M(this,X);M(this,ee);M(this,V);A(this,"WIZARD_STATE_NAME","zume_wizard_state");A(this,"STALE_LIFESPAN",10*60*1e3);A(this,"MAX_LIFESPAN",60*60*1e3);M(this,k,void 0);this.moduleName=e,ie(this,k,T(this,Y,Te).call(this))}empty(){return Object.keys(E(this,k).data).length===0}isDataStale(){return T(this,V,de).call(this,E(this,k),this.STALE_LIFESPAN)}get(e){return E(this,k).data[e]}getAll(){return E(this,k).data}add(e,t){E(this,k).data[e]=t,T(this,ee,je).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(E(this,k)))}clear(){ie(this,k,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}k=new WeakMap,Y=new WeakSet,Te=function(){const e=T(this,X,Ie).call(this);return e&&!T(this,V,de).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},X=new WeakSet,Ie=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},ee=new WeakSet,je=function(){E(this,k).timestamp=Date.now()},V=new WeakSet,de=function(e,t){return Date.now()-e.timestamp>t};const y={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},st={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},l={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...st},it={[l.updateName]:{field:"name",testExistance:(s,e)=>e.has_set_name},[l.updateLocation]:{field:"location",testExistance:s=>!(s.source&&s.source==="ip")},[l.updatePhone]:{field:"phone",testExistance:s=>!!s}};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const G=window,pe=G.ShadowRoot&&(G.ShadyCSS===void 0||G.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,me=Symbol(),ve=new WeakMap;let Oe=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==me)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(pe&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=ve.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&ve.set(t,e))}return e}toString(){return this.cssText}};const nt=s=>new Oe(typeof s=="string"?s:s+"",void 0,me),at=(s,...e)=>{const t=s.length===1?s[0]:e.reduce((i,n,o)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+s[o+1],s[0]);return new Oe(t,s,me)},rt=(s,e)=>{pe?s.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),n=G.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=t.cssText,s.appendChild(i)})},fe=pe?s=>s:s=>s instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return nt(t)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ne;const Z=window,$e=Z.trustedTypes,ot=$e?$e.emptyScript:"",_e=Z.reactiveElementPolyfillSupport,ue={toAttribute(s,e){switch(e){case Boolean:s=s?ot:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,e){let t=s;switch(e){case Boolean:t=s!==null;break;case Number:t=s===null?null:Number(s);break;case Object:case Array:try{t=JSON.parse(s)}catch{t=null}}return t}},Le=(s,e)=>e!==s&&(e==e||s==s),ae={attribute:!0,type:String,converter:ue,reflect:!1,hasChanged:Le};let j=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,i)=>{const n=this._$Ep(i,t);n!==void 0&&(this._$Ev.set(n,i),e.push(n))}),e}static createProperty(e,t=ae){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():"__"+e,n=this.getPropertyDescriptor(e,i,t);n!==void 0&&Object.defineProperty(this.prototype,e,n)}}static getPropertyDescriptor(e,t,i){return{get(){return this[t]},set(n){const o=this[e];this[t]=n,this.requestUpdate(e,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||ae}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,i=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const n of i)this.createProperty(n,t[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const n of i)t.unshift(fe(n))}else e!==void 0&&t.push(fe(e));return t}static _$Ep(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,i;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)===null||i===void 0||i.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return rt(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostConnected)===null||i===void 0?void 0:i.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var i;return(i=t.hostDisconnected)===null||i===void 0?void 0:i.call(t)})}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$EO(e,t,i=ae){var n;const o=this.constructor._$Ep(e,i);if(o!==void 0&&i.reflect===!0){const a=(((n=i.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?i.converter:ue).toAttribute(t,i.type);this._$El=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$El=null}}_$AK(e,t){var i;const n=this.constructor,o=n._$Ev.get(e);if(o!==void 0&&this._$El!==o){const a=n.getPropertyOptions(o),d=typeof a.converter=="function"?{fromAttribute:a.converter}:((i=a.converter)===null||i===void 0?void 0:i.fromAttribute)!==void 0?a.converter:ue;this._$El=o,this[o]=d.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,i){let n=!0;e!==void 0&&(((i=i||this.constructor.getPropertyOptions(e)).hasChanged||Le)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),i.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,i))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,o)=>this[o]=n),this._$Ei=void 0);let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(e=this._$ES)===null||e===void 0||e.forEach(n=>{var o;return(o=n.hostUpdate)===null||o===void 0?void 0:o.call(n)}),this.update(i)):this._$Ek()}catch(n){throw t=!1,this._$Ek(),n}t&&this._$AE(i)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(i=>{var n;return(n=i.hostUpdated)===null||n===void 0?void 0:n.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,i)=>this._$EO(i,this[i],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};j.finalized=!0,j.elementProperties=new Map,j.elementStyles=[],j.shadowRootOptions={mode:"open"},_e==null||_e({ReactiveElement:j}),((ne=Z.reactiveElementVersions)!==null&&ne!==void 0?ne:Z.reactiveElementVersions=[]).push("1.6.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var re;const Q=window,L=Q.trustedTypes,ye=L?L.createPolicy("lit-html",{createHTML:s=>s}):void 0,K="$lit$",x=`lit$${(Math.random()+"").slice(9)}$`,ge="?"+x,lt=`<${ge}>`,N=document,q=()=>N.createComment(""),B=s=>s===null||typeof s!="object"&&typeof s!="function",Ne=Array.isArray,Fe=s=>Ne(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",oe=`[ 	
\f\r]`,H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ke=/-->/g,we=/>/g,D=RegExp(`>|${oe}(?:([^\\s"'>=/]+)(${oe}*=${oe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Se=/'/g,xe=/"/g,He=/^(?:script|style|textarea|title)$/i,ct=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),r=ct(1),w=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Ee=new WeakMap,O=N.createTreeWalker(N,129,null,!1),Ue=(s,e)=>{const t=s.length-1,i=[];let n,o=e===2?"<svg>":"",a=H;for(let h=0;h<t;h++){const c=s[h];let v,m,p=-1,g=0;for(;g<c.length&&(a.lastIndex=g,m=a.exec(c),m!==null);)g=a.lastIndex,a===H?m[1]==="!--"?a=ke:m[1]!==void 0?a=we:m[2]!==void 0?(He.test(m[2])&&(n=RegExp("</"+m[2],"g")),a=D):m[3]!==void 0&&(a=D):a===D?m[0]===">"?(a=n??H,p=-1):m[1]===void 0?p=-2:(p=a.lastIndex-m[2].length,v=m[1],a=m[3]===void 0?D:m[3]==='"'?xe:Se):a===xe||a===Se?a=D:a===ke||a===we?a=H:(a=D,n=void 0);const b=a===D&&s[h+1].startsWith("/>")?" ":"";o+=a===H?c+lt:p>=0?(i.push(v),c.slice(0,p)+K+c.slice(p)+x+b):c+x+(p===-2?(i.push(void 0),h):b)}const d=o+(s[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return[ye!==void 0?ye.createHTML(d):d,i]};class W{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let o=0,a=0;const d=e.length-1,h=this.parts,[c,v]=Ue(e,t);if(this.el=W.createElement(c,i),O.currentNode=this.el.content,t===2){const m=this.el.content,p=m.firstChild;p.remove(),m.append(...p.childNodes)}for(;(n=O.nextNode())!==null&&h.length<d;){if(n.nodeType===1){if(n.hasAttributes()){const m=[];for(const p of n.getAttributeNames())if(p.endsWith(K)||p.startsWith(x)){const g=v[a++];if(m.push(p),g!==void 0){const b=n.getAttribute(g.toLowerCase()+K).split(x),f=/([.?@])?(.*)/.exec(g);h.push({type:1,index:o,name:f[2],strings:b,ctor:f[1]==="."?Be:f[1]==="?"?We:f[1]==="@"?Ve:J})}else h.push({type:6,index:o})}for(const p of m)n.removeAttribute(p)}if(He.test(n.tagName)){const m=n.textContent.split(x),p=m.length-1;if(p>0){n.textContent=L?L.emptyScript:"";for(let g=0;g<p;g++)n.append(m[g],q()),O.nextNode(),h.push({type:2,index:++o});n.append(m[p],q())}}}else if(n.nodeType===8)if(n.data===ge)h.push({type:2,index:o});else{let m=-1;for(;(m=n.data.indexOf(x,m+1))!==-1;)h.push({type:7,index:o}),m+=x.length-1}o++}}static createElement(e,t){const i=N.createElement("template");return i.innerHTML=e,i}}function R(s,e,t=s,i){var n,o,a,d;if(e===w)return e;let h=i!==void 0?(n=t._$Co)===null||n===void 0?void 0:n[i]:t._$Cl;const c=B(e)?void 0:e._$litDirective$;return(h==null?void 0:h.constructor)!==c&&((o=h==null?void 0:h._$AO)===null||o===void 0||o.call(h,!1),c===void 0?h=void 0:(h=new c(s),h._$AT(s,t,i)),i!==void 0?((a=(d=t)._$Co)!==null&&a!==void 0?a:d._$Co=[])[i]=h:t._$Cl=h),h!==void 0&&(e=R(s,h._$AS(s,e.values),h,i)),e}class qe{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:n}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:N).importNode(i,!0);O.currentNode=o;let a=O.nextNode(),d=0,h=0,c=n[0];for(;c!==void 0;){if(d===c.index){let v;c.type===2?v=new F(a,a.nextSibling,this,e):c.type===1?v=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(v=new Je(a,this,e)),this._$AV.push(v),c=n[++h]}d!==(c==null?void 0:c.index)&&(a=O.nextNode(),d++)}return o}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class F{constructor(e,t,i,n){var o;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cp=(o=n==null?void 0:n.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=R(this,e,t),B(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==w&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Fe(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==_&&B(this._$AH)?this._$AA.nextSibling.data=e:this.$(N.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:n}=e,o=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=W.createElement(n.h,this.options)),n);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(i);else{const a=new qe(o,this),d=a.u(this.options);a.v(i),this.$(d),this._$AH=a}}_$AC(e){let t=Ee.get(e.strings);return t===void 0&&Ee.set(e.strings,t=new W(e)),t}T(e){Ne(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,n=0;for(const o of e)n===t.length?t.push(i=new F(this.k(q()),this.k(q()),this,this.options)):i=t[n],i._$AI(o),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const n=e.nextSibling;e.remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class J{constructor(e,t,i,n,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,n){const o=this.strings;let a=!1;if(o===void 0)e=R(this,e,t,0),a=!B(e)||e!==this._$AH&&e!==w,a&&(this._$AH=e);else{const d=e;let h,c;for(e=o[0],h=0;h<o.length-1;h++)c=R(this,d[i+h],t,h),c===w&&(c=this._$AH[h]),a||(a=!B(c)||c!==this._$AH[h]),c===_?e=_:e!==_&&(e+=(c??"")+o[h+1]),this._$AH[h]=c}a&&!n&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Be extends J{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}}const ht=L?L.emptyScript:"";class We extends J{constructor(){super(...arguments),this.type=4}j(e){e&&e!==_?this.element.setAttribute(this.name,ht):this.element.removeAttribute(this.name)}}class Ve extends J{constructor(e,t,i,n,o){super(e,t,i,n,o),this.type=5}_$AI(e,t=this){var i;if((e=(i=R(this,e,t,0))!==null&&i!==void 0?i:_)===w)return;const n=this._$AH,o=e===_&&n!==_||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,a=e!==_&&(n===_||o);o&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Je{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){R(this,e)}}const dt={O:K,P:x,A:ge,C:1,M:Ue,L:qe,D:Fe,R,I:F,V:J,H:We,N:Ve,U:Be,F:Je},Ce=Q.litHtmlPolyfillSupport;Ce==null||Ce(W,F),((re=Q.litHtmlVersions)!==null&&re!==void 0?re:Q.litHtmlVersions=[]).push("2.7.3");const ut=(s,e,t)=>{var i,n;const o=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let a=o._$litPart$;if(a===void 0){const d=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;o._$litPart$=a=new F(e.insertBefore(q(),d),d,void 0,t??{})}return a._$AI(s),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var le,ce;let u=class extends j{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ut(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return w}};u.finalized=!0,u._$litElement$=!0,(le=globalThis.litElementHydrateSupport)===null||le===void 0||le.call(globalThis,{LitElement:u});const Ae=globalThis.litElementPolyfillSupport;Ae==null||Ae({LitElement:u});((ce=globalThis.litElementVersions)!==null&&ce!==void 0?ce:globalThis.litElementVersions=[]).push("3.3.2");class pt extends u{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new Me}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.steps.length===0?r`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ge=s=>(...e)=>({_$litDirective$:s,values:e});class Ze{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:mt}=dt,gt=s=>s.strings===void 0,De=()=>document.createComment(""),U=(s,e,t)=>{var i;const n=s._$AA.parentNode,o=e===void 0?s._$AB:e._$AA;if(t===void 0){const a=n.insertBefore(De(),o),d=n.insertBefore(De(),o);t=new mt(a,d,s,s.options)}else{const a=t._$AB.nextSibling,d=t._$AM,h=d!==s;if(h){let c;(i=t._$AQ)===null||i===void 0||i.call(t,s),t._$AM=s,t._$AP!==void 0&&(c=s._$AU)!==d._$AU&&t._$AP(c)}if(a!==o||h){let c=t._$AA;for(;c!==a;){const v=c.nextSibling;n.insertBefore(c,o),c=v}}}return t},P=(s,e,t=s)=>(s._$AI(e,t),s),bt={},Qe=(s,e=bt)=>s._$AH=e,vt=s=>s._$AH,he=s=>{var e;(e=s._$AP)===null||e===void 0||e.call(s,!1,!0);let t=s._$AA;const i=s._$AB.nextSibling;for(;t!==i;){const n=t.nextSibling;t.remove(),t=n}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ft=Ge(class extends Ze{constructor(s){if(super(s),s.type!==z.PROPERTY&&s.type!==z.ATTRIBUTE&&s.type!==z.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!gt(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===w||e===_)return e;const t=s.element,i=s.name;if(s.type===z.PROPERTY){if(e===t[i])return w}else if(s.type===z.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return w}else if(s.type===z.ATTRIBUTE&&t.getAttribute(i)===e+"")return w;return Qe(s),e}});class $t extends u{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return r`
            ...
            ${this.variant===l.updateLocation?r`
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        id="city"
                        name="city"
                        .value="${this.city?ft(this.city):(e=this.localValue)==null?void 0:e.label}"
        ...
        `}_handleDone(e){e&&e.preventDefault(),this._sendDoneStepEvent()}_sendDoneStepEvent(){const e=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(e)}_handleFinish(){setTimeout(()=>{this._sendDoneStepEvent()},3e3)}createRenderRoot(){return this}}customElements.define("make-group",Et);function Ct(s){return s?JSON.parse('{"'+s.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}function At(s,e){let t={};const i=s.split("/").filter(o=>o!=""),n=e.split("/").filter(o=>o!="");return i.map((o,a)=>{/^:/.test(o)&&(t[o.substring(1)]=n[a])}),t}function Dt(s){return s?new RegExp("^(|/)"+s.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}function Pt(s,e){if(Dt(e).test(s))return!0}function zt(s){return class extends s{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...e){super(...e),this.route="",this.canceled=!1}connectedCallback(...e){super.connectedCallback(...e),this.routing(this.constructor.routes,(...t)=>this.router(...t)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...t)=>this.router(...t))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(e,t,i,n,o,a){a&&a(e,t,i,n),o(e,t,i,n)}routing(e,t){this.canceled=!0;const i=decodeURI(window.location.pathname),n=decodeURI(window.location.search);let o=e.filter(h=>h.pattern==="*")[0],a=e.filter(h=>h.pattern!=="*"&&Pt(i,h.pattern))[0],d=Ct(n);a?(a.params=At(a.pattern,i),a.data=a.data||{},a.authentication&&a.authentication.authenticate&&typeof a.authentication.authenticate=="function"?(this.canceled=!1,Promise.resolve(a.authentication.authenticate.bind(this).call()).then(h=>{this.canceled||(h?a.authorization&&a.authorization.authorize&&typeof a.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(a.authorization.authorize.bind(this).call()).then(c=>{this.canceled||(c?this.routed(a.name,a.params,d,a.data,t,a.callback):this.routed(a.authorization.unauthorized.name,a.params,d,a.data,t,a.callback))})):this.routed(a.name,a.params,d,a.data,t,a.callback):this.routed(a.authentication.unauthenticated.name,a.params,d,a.data,t,a.callback))})):a.authorization&&a.authorization.authorize&&typeof a.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(a.authorization.authorize.bind(this).call()).then(h=>{this.canceled||(h?this.routed(a.name,a.params,d,a.data,t,a.callback):this.routed(a.authorization.unauthorized.name,a.params,d,a.data,t,a.callback))})):this.routed(a.name,a.params,d,a.data,t,a.callback)):o&&(o.data=o.data||{},this.routed(o.name,{},d,o.data,t,o.callback))}}}function Rt(s){return class extends s{navigate(e){window.history.pushState({},null,e),window.dispatchEvent(new CustomEvent("route"))}}}class C extends zt(u){static get properties(){return{route:{type:String},params:{type:Object},query:{type:Object}}}static get routes(){return[{name:"getting-started",pattern:`${zumeDashboard.base_url}/getting-started`,icon:"",data:{component:"dash-getting-started"}},{name:"training",pattern:`${zumeDashboard.base_url}/training`,icon:"",data:{component:"dash-training"}},{name:"practicing",pattern:`${zumeDashboard.base_url}/practicing`,icon:"",data:{component:"dash-practicing"}},{name:"my-coach",pattern:`${zumeDashboard.base_url}/my-coach`,parent:"practicing",icon:"zume-coach",translation:zumeDashboard.translations.my_coach,data:{component:"dash-coach"}},{name:"my-tools",pattern:`${zumeDashboard.base_url}/my-tools`,parent:"practicing",icon:"zume-tools",translation:zumeDashboard.translations.my_tools,data:{component:"dash-tools"}},{name:"my-plans",pattern:`${zumeDashboard.base_url}/my-plans`,parent:"practicing",icon:"zume-plans",translation:zumeDashboard.translations.my_plans,data:{component:"dash-plans"}},{name:"my-churches",pattern:`${zumeDashboard.base_url}/my-churches`,parent:"practicing",icon:"zume-churches",translation:zumeDashboard.translations["my_churches`"],data:{component:"dash-churches"}},{name:"my-maps",pattern:`${zumeDashboard.base_url}/my-maps`,parent:"practicing",icon:"zume-location",translation:zumeDashboard.translations.my_maps,data:{component:"dash-maps"}},{name:"not-found",pattern:"*",icon:"",data:{component:"dash-not-found"}}]}static getRoute(e){return C.routes.find(i=>i.name===e)}static childRoutesOf(e){return C.routes.filter(({parent:i})=>i===e)}constructor(){super(),this.route="",this.params={},this.query={},this.data={},this.addEventListener("route",e=>{console.log(e)})}router(e,t,i,n){this.route=e,this.params=t,this.query=i,this.data=n}makeHref(e){return`${zumeDashboard.base_url}/${e}`}makeHrefRoute(e){const i=C.routes.find(({name:n})=>n===e);return i?i.pattern:(console.error("MISSING ROUTE",e),"")}renderRoute(){const{component:e}=this.data;return e?document.createElement(e):""}render(){return r`
            <div class="dashboard">
            ...
            <div class="dashboard__sidebar">
                <ul class="stack-2 | progress-menu accordion-menu" data-accordion-menu data-submenu-toggle="true">
                    ...
                    <li class="menu-section">
                        ...
                        ></nav-link>
                        <ul class="nested is-active">
                            ${C.childRoutesOf("practicing").map(e=>r`
                                        <li>
                                            <nav-link
                                                class="menu-btn"
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-board",C);class Mt extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",Mt);class Tt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",Tt);class It extends u{render(){return r`
            <div class="dashboard__header">
            </div>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-content",It);class jt extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-cta",jt);class Ot extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-getting-started",Ot);class Lt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
                    <h1 class="h3">Maps</h1>
                    <launch-course></launch-course>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",Lt);class Nt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-not-found",Nt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe=(s,e,t)=>{const i=new Map;for(let n=e;n<=t;n++)i.set(s[n],n);return i},Ft=Ge(class extends Ze{constructor(s){if(super(s),s.type!==z.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const n=[],o=[];let a=0;for(const d of s)n[a]=i?i(d,a):a,o[a]=t(d,a),a++;return{values:o,keys:n}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){var n;const o=vt(s),{values:a,keys:d}=this.dt(e,t,i);if(!Array.isArray(o))return this.ht=d,a;const h=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],c=[];let v,m,p=0,g=o.length-1,b=0,f=a.length-1;for(;p<=g&&b<=f;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(h[p]===d[b])c[b]=P(o[p],a[b]),p++,b++;else if(h[g]===d[f])c[f]=P(o[g],a[f]),g--,f--;else if(h[p]===d[f])c[f]=P(o[p],a[f]),U(s,c[f+1],o[p]),p++,f--;else if(h[g]===d[b])c[b]=P(o[g],a[b]),U(s,o[p],o[g]),g--,b++;else if(v===void 0&&(v=Pe(d,b,f),m=Pe(h,p,g)),v.has(h[p]))if(v.has(h[g])){const S=m.get(d[b]),te=S!==void 0?o[S]:null;if(te===null){const be=U(s,o[p]);P(be,a[b]),c[b]=be}else c[b]=P(te,a[b]),U(s,o[p],te),o[S]=null;b++}else he(o[g]),g--;else he(o[p]),p++;for(;b<=f;){const S=U(s,c[f+1]);P(S,a[b]),c[b++]=S}for(;p<=g;){const S=o[p++];S!==null&&he(S)}return this.ht=d,Qe(s,c),w}});class Ht extends u{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1}}}constructor(){super(),this.loading=!0,this.route=C.getRoute("my-plans"),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){this.fetchCommitments()}updated(){jQuery(document).foundation()}fetchCommitments(e=""){makeRequest("GET","commitments",{status:e},"zume_system/v1").done(t=>{this.commitments=t}).always(()=>{this.loading=!1})}openCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(e){this.value=""})}addCommitments(){jQuery(".post-training-plan").each(function(e){const t=jQuery(this).val();if(t){const n=jQuery(this).prev().text();console.log("Question: "+n+" Answer: "+t);var i=new Date;i.setDate(i.getDate()+30),this.value="",makeRequest("POST","commitment",{user_id:zumeDashboard.user_profile.user_id,post_id:zumeDashboard.user_profile.contact_id,meta_key:"tasks",note:"Question: "+n+" Answer: "+t,question:n,answer:t,date:i,category:"post_training_plan"},"zume_system/v1").done(o=>{console.log(o)})}}),this.closeCommitmentsModal()}completeCommitment(e){let t={id:e,user_id:zumeDashboard.user_profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(i=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:zumeDashboard.user_profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(i=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}filterCommitments(e){switch(e){case"open":this.fetchCommitments("open");break;case"closed":this.fetchCommitments("closed");break;case"all":this.fetchCommitments("");break}}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:i,id:n,status:o}=e;return r`
            <li class="list__item">
                <span>${t} <b>${i}</b></span>
                ...
                <div class="dashboard__main">
                    ${this.loading?r`<span class="loading-spinner active"></span>`:r`
                                <ul class="list">
                                    ...
                                    ${!this.loading&&this.commitments&&this.commitments.length>0?Ft(this.commitments,e=>e.id,this.renderListItem):""}
                                </ul>
                            `}
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-plans",Ht);class Ut extends u{constructor(){super(),this.routeName="practicing",this.routes=C.childRoutesOf("practicing")}render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-practicing",Ut);class qt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-tools",qt);class Bt extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-training",Bt);class Ke extends Rt(u){static get properties(){return{href:{type:String},class:{type:String},disabled:{type:Boolean},completed:{type:Boolean},directLink:{type:Boolean},icon:{type:String},text:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.disabled=!1,this.completed=!1,this.directLink=!1}handleClick(e){this.directLink||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return r`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",Ke);class Wt extends Ke{constructor(){super()}renderText(){return this.text.split(" ").map(e=>r`
            <span>${e}</span>
        `)}render(){return r`
            <a
                href=${this.href}
        ...
        `}}customElements.define("grid-link",Wt);class Vt extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("launch-course",Vt);class Jt extends u{static get properties(){return{title:{type:String},sections:{type:Array}}}render(){return r`
            <div class="container">
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slideshow",Qt);class Kt extends u{static get properties(){return{partData:{type:Object}}}render(){switch(this.partData.type){case"section":return r`<section-part .partData=${this.partData}></section-part>`;case"watch":return r`<watch-part .partData=${this.partData}></watch-part>`;case"discuss":return r`<discuss-part .partData=${this.partData}></discuss-part>`;case"read":return r`<read-part .partData=${this.partData}></read-part>`;case"see":return r`<see-part .partData=${this.partData}></see-part>`;case"share":return r`<share-part .partData=${this.partData}></share-part>`;case"listen":return r`<listen-part .partData=${this.partData}></listen-part>`;case"form":return r`<form-part .partData=${this.partData}></form-part>`;case"checkin":return r`<checkin-part .partData=${this.partData}></checkin-part>`;case"cta":default:return r`<basic-part .partData=${this.partData}></basic-part>`}}createRenderRoot(){return this}}customElements.define("part-switcher",Kt);class Yt extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("basic-part",Yt);class Xt extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        ...
        `}createRenderRoot(){return this}}customElements.define("checkin-part",Xt);class es extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("discuss-part",es);class ts extends u{static get properties(){return{partData:{type:Object}}}render(){return this.partData.t,this.partData.d,this.partData.info,r`
            ${this.title!==null?r`<h2>${this.title}</h2>`:""}
            ${this.description!==null?r`<p>${this.description}</p>`:""}
            ${this.info!==null?r`<p>${this.info}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("form-part",ts);class ss extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            <h2 class="brand">LISTEN</h2>
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("listen-part",ss);class is extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            <h2 class="brand">READ</h2>
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("read-part",is);class ns extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h2>${e}</h2>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("section-part",ns);class as extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            <h2 class="brand">SEE</h2>
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("see-part",as);class rs extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("share-part",rs);class os extends u{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,i=this.partData.info??null;return r`
            ${e!==null?r`<h3>${e}</h3>`:""}
            ${t!==null?r`<p>${t}</p>`:""}
            ${i!==null?r`<p>${i}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("watch-part",os);class Ye extends u{constructor(){super()}render(){return r`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",Ye);class ls extends u{constructor(){super();A(this,"webShareSupported",!!window.navigator.share);A(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(){navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(t=>console.error(t))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-links",ls);class cs extends u{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){makeRequest("POST","public_plans",{},"zume_system/v1").then(e=>{this.plans=e}).catch(e=>{console.log(e)}).always(()=>{this.loading=!1})}render(){return this.loading?r`<span class="loading-spinner active"></span>`:r`
            <table>
                <thead>
                    <tr>
                        <td>${this.t.name}</td>
        ...
        `}renderRow({join_key:e,language_note:t,post_title:i,time_of_day_note:n,timezone_note:o,...a}){const d=a.set_a_01?"a":"b",h=d==="a"?10:20,c=`set_${d}_`,v=Date.now()/1e3;let m="";for(let g=1;g<h+1;g++){const b=g<10?`0${g}`:`${g}`,f=a[c+b];if(m=f.timestamp,v<f.timestamp)break}const p=moment(m*1e3).format("MMM Do 'YY");return r`
            <tr>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",hs);const Re=document.querySelector(".nav-toggle"),ds=document.querySelector("#nav");Re&&Re.addEventListener("click",s=>{ds.classList.toggle("nav--visible")});const us=({title:s,url:e,copyFeedback:t,shareFeedback:i})=>({title:s,url:e,webShareSupported:navigator.share,clipboardSupported:navigator.clipboard,shareFeedback:"",copyFeedback:"",noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported},share(){navigator.share({title:s,url:e,text:s}).then(()=>{this.shareFeedback=i,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(n=>console.error("Error sharing",n))},copyLink(){navigator.clipboard.writeText(e).then(()=>{this.copyFeedback=t,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(n=>console.error(n))}});window.zumeInitShareLinks=()=>{tt({share:us}).mount()};
//# sourceMappingURL=main-4f0d0649.js.map

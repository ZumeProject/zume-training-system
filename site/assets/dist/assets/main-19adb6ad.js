var ae=Object.defineProperty;var oe=(i,t,e)=>t in i?ae(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var z=(i,t,e)=>(oe(i,typeof t!="symbol"?t+"":t,e),e),nt=(i,t,e)=>{if(!t.has(i))throw TypeError("Cannot "+e)};var D=(i,t,e)=>(nt(i,t,"read from private field"),e?e.call(i):t.get(i)),R=(i,t,e)=>{if(t.has(i))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(i):t.set(i,e)},at=(i,t,e,s)=>(nt(i,t,"write to private field"),s?s.call(i,e):t.set(i,e),e);var I=(i,t,e)=>(nt(i,t,"access private method"),e);import{createApp as re}from"https://unpkg.com/petite-vue?module";const kt=document.querySelector(".nav-toggle"),le=document.querySelector("#nav");kt&&kt.addEventListener("click",i=>{le.classList.toggle("nav--visible")});const ce=({title:i,url:t,copyFeedback:e,shareFeedback:s})=>({title:i,url:t,webShareSupported:navigator.share,clipboardSupported:navigator.clipboard,shareFeedback:"",copyFeedback:"",noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported},share(){navigator.share({title:i,url:t,text:i}).then(()=>{this.shareFeedback=s,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(n=>console.error("Error sharing",n))},copyLink(){navigator.clipboard.writeText(t).then(()=>{this.copyFeedback=e,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(n=>console.error(n))}});window.zumeInitShareLinks=()=>{re({share:ce}).mount()};var pt;let he=(pt=class{static save(t,e){localStorage.setItem(this.createKey(t),JSON.stringify(e))}static load(t){const e=localStorage.getItem(this.createKey(t));try{return JSON.parse(e)}catch{return e}}static createKey(t){return this.prefix+t}},z(pt,"prefix","Z5_"),pt);window.ZumeStorage=he;var k,X,Nt,tt,Ht,et,Ft,Z,mt;class Lt{constructor(t){R(this,X);R(this,tt);R(this,et);R(this,Z);z(this,"WIZARD_STATE_NAME","zume_wizard_state");z(this,"STALE_LIFESPAN",10*60*1e3);z(this,"MAX_LIFESPAN",60*60*1e3);R(this,k,void 0);this.moduleName=t,at(this,k,I(this,X,Nt).call(this))}empty(){return Object.keys(D(this,k).data).length===0}isDataStale(){return I(this,Z,mt).call(this,D(this,k),this.STALE_LIFESPAN)}get(t){return D(this,k).data[t]}getAll(){return D(this,k).data}add(t,e){D(this,k).data[t]=e,I(this,et,Ft).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(D(this,k)))}clear(){at(this,k,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}k=new WeakMap,X=new WeakSet,Nt=function(){const t=I(this,tt,Ht).call(this);return t&&!I(this,Z,mt).call(this,t,this.MAX_LIFESPAN)?t:{module:this.moduleName,data:{},timestamp:Date.now()}},tt=new WeakSet,Ht=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},et=new WeakSet,Ft=function(){D(this,k).timestamp=Date.now()},Z=new WeakSet,mt=function(t,e){return Date.now()-t.timestamp>e};const y={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},de={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},l={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...de},ue={[l.updateName]:{field:"name",testExistance:(i,t)=>t.has_set_name},[l.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[l.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
...
//# sourceMappingURL=main-19adb6ad.js.map

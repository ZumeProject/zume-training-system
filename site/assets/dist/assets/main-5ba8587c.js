...
\f\r]`,F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Pe=/-->/g,Ae=/>/g,A=RegExp(`>|${ue}(?:([^\\s"'>=/]+)(${ue}*=${ue}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Re=/'/g,Me=/"/g,Je=/^(?:script|style|textarea|title)$/i,Qe=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),o=Qe(1),G=Qe(2),x=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),ze=new WeakMap,N=q.createTreeWalker(q,129,null,!1),Ge=(i,e)=>{const t=i.length-1,s=[];let n,r=e===2?"<svg>":"",a=F;for(let l=0;l<t;l++){const d=i[l];let b,p,u=-1,m=0;for(;m<d.length&&(a.lastIndex=m,p=a.exec(d),p!==null);)m=a.lastIndex,a===F?p[1]==="!--"?a=Pe:p[1]!==void 0?a=Ae:p[2]!==void 0?(Je.test(p[2])&&(n=RegExp("</"+p[2],"g")),a=A):p[3]!==void 0&&(a=A):a===A?p[0]===">"?(a=n??F,u=-1):p[1]===void 0?u=-2:(u=a.lastIndex-p[2].length,b=p[1],a=p[3]===void 0?A:p[3]==='"'?Me:Re):a===Me||a===Re?a=A:a===Pe||a===Ae?a=F:(a=A,n=void 0);const v=a===A&&i[l+1].startsWith("/>")?" ":"";r+=a===F?d+bt:u>=0?(s.push(b),d.slice(0,u)+ee+d.slice(u)+C+v):d+C+(u===-2?(s.push(void 0),l):v)}const h=r+(i[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Oe!==void 0?Oe.createHTML(h):h,s]};class V{constructor({strings:e,_$litType$:t},s){let n;this.parts=[];let r=0,a=0;const h=e.length-1,l=this.parts,[d,b]=Ge(e,t);if(this.el=V.createElement(d,s),N.currentNode=this.el.content,t===2){const p=this.el.content,u=p.firstChild;u.remove(),p.append(...u.childNodes)}for(;(n=N.nextNode())!==null&&l.length<h;){if(n.nodeType===1){if(n.hasAttributes()){const p=[];for(const u of n.getAttributeNames())if(u.endsWith(ee)||u.startsWith(C)){const m=b[a++];if(p.push(u),m!==void 0){const v=n.getAttribute(m.toLowerCase()+ee).split(C),f=/([.?@])?(.*)/.exec(m);l.push({type:1,index:r,name:f[2],strings:v,ctor:f[1]==="."?Ye:f[1]==="?"?Xe:f[1]==="@"?et:Q})}else l.push({type:6,index:r})}for(const u of p)n.removeAttribute(u)}if(Je.test(n.tagName)){const p=n.textContent.split(C),u=p.length-1;if(u>0){n.textContent=H?H.emptyScript:"";for(let m=0;m<u;m++)n.append(p[m],W()),N.nextNode(),l.push({type:2,index:++r});n.append(p[u],W())}}}else if(n.nodeType===8)if(n.data===_e)l.push({type:2,index:r});else{let p=-1;for(;(p=n.data.indexOf(C,p+1))!==-1;)l.push({type:7,index:r}),p+=C.length-1}r++}}static createElement(e,t){const s=q.createElement("template");return s.innerHTML=e,s}}function z(i,e,t=i,s){var n,r,a,h;if(e===x)return e;let l=s!==void 0?(n=t._$Co)===null||n===void 0?void 0:n[s]:t._$Cl;const d=Z(e)?void 0:e._$litDirective$;return(l==null?void 0:l.constructor)!==d&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),d===void 0?l=void 0:(l=new d(i),l._$AT(i,t,s)),s!==void 0?((a=(h=t)._$Co)!==null&&a!==void 0?a:h._$Co=[])[s]=l:t._$Cl=l),l!==void 0&&(e=z(i,l._$AS(i,e.values),l,s)),e}class Ke{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:n}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:q).importNode(s,!0);N.currentNode=r;let a=N.nextNode(),h=0,l=0,d=n[0];for(;d!==void 0;){if(h===d.index){let b;d.type===2?b=new U(a,a.nextSibling,this,e):d.type===1?b=new d.ctor(a,d.name,d.strings,this,e):d.type===6&&(b=new tt(a,this,e)),this._$AV.push(b),d=n[++l]}h!==(d==null?void 0:d.index)&&(a=N.nextNode(),h++)}return r}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class U{constructor(e,t,s,n){var r;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=n,this._$Cp=(r=n==null?void 0:n.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=z(this,e,t),Z(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==x&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ve(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==_&&Z(this._$AH)?this._$AA.nextSibling.data=e:this.$(q.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:n}=e,r=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=V.createElement(n.h,this.options)),n);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.v(s);else{const a=new Ke(r,this),h=a.u(this.options);a.v(s),this.$(h),this._$AH=a}}_$AC(e){let t=ze.get(e.strings);return t===void 0&&ze.set(e.strings,t=new V(e)),t}T(e){Ze(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,n=0;for(const r of e)n===t.length?t.push(s=new U(this.k(W()),this.k(W()),this,this.options)):s=t[n],s._$AI(r),n++;n<t.length&&(this._$AR(s&&s._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const n=e.nextSibling;e.remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Q{constructor(e,t,s,n,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,n){const r=this.strings;let a=!1;if(r===void 0)e=z(this,e,t,0),a=!Z(e)||e!==this._$AH&&e!==x,a&&(this._$AH=e);else{const h=e;let l,d;for(e=r[0],l=0;l<r.length-1;l++)d=z(this,h[s+l],t,l),d===x&&(d=this._$AH[l]),a||(a=!Z(d)||d!==this._$AH[l]),d===_?e=_:e!==_&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}a&&!n&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ye extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}}const ft=H?H.emptyScript:"";class Xe extends Q{constructor(){super(...arguments),this.type=4}j(e){e&&e!==_?this.element.setAttribute(this.name,ft):this.element.removeAttribute(this.name)}}class et extends Q{constructor(e,t,s,n,r){super(e,t,s,n,r),this.type=5}_$AI(e,t=this){var s;if((e=(s=z(this,e,t,0))!==null&&s!==void 0?s:_)===x)return;const n=this._$AH,r=e===_&&n!==_||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,a=e!==_&&(n===_||r);r&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class tt{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){z(this,e)}}const $t={O:ee,P:C,A:_e,C:1,M:Ge,L:Ke,D:Ve,R:z,I:U,V:Q,H:Xe,N:et,U:Ye,F:tt},Ie=X.litHtmlPolyfillSupport;Ie==null||Ie(V,U),((he=X.litHtmlVersions)!==null&&he!==void 0?he:X.litHtmlVersions=[]).push("2.7.3");const yt=(i,e,t)=>{var s,n;const r=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=r._$litPart$;if(a===void 0){const h=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=a=new U(e.insertBefore(W(),h),h,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pe,me;let g=class extends D{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=yt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return x}};g.finalized=!0,g._$litElement$=!0,(pe=globalThis.litElementHydrateSupport)===null||pe===void 0||pe.call(globalThis,{LitElement:g});const Te=globalThis.litElementPolyfillSupport;Te==null||Te({LitElement:g});((me=globalThis.litElementVersions)!==null&&me!==void 0?me:globalThis.litElementVersions=[]).push("3.3.2");class _t extends g{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new He}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.steps.length===0?o`
                                    ...
                                    ${y.childRoutesOf("getting-started").map(e=>o`
                                                <li>
                                                    <nav-link
                                                        ...
                                                        icon=${e.icon}
                                                        text=${e.translation}
                                                        ?disableNavigate=${e.type==="direct-link"}
 ...
 */const De=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},ne=st(class extends it{constructor(i){if(super(i),i.type!==M.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],r=[];let a=0;for(const h of i)n[a]=s?s(h,a):a,r[a]=t(h,a),a++;return{values:r,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const r=jt(i),{values:a,keys:h}=this.dt(e,t,s);if(!Array.isArray(r))return this.ht=h,a;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],d=[];let b,p,u=0,m=r.length-1,v=0,f=a.length-1;for(;u<=m&&v<=f;)if(r[u]===null)u++;else if(r[m]===null)m--;else if(l[u]===h[v])d[v]=R(r[u],a[v]),u++,v++;else if(l[m]===h[f])d[f]=R(r[m],a[f]),m--,f--;else if(l[u]===h[f])d[f]=R(r[u],a[f]),B(i,d[f+1],r[u]),u++,f--;else if(l[m]===h[v])d[v]=R(r[m],a[v]),B(i,r[u],r[m]),m--,v++;else if(b===void 0&&(b=De(h,v,f),p=De(l,u,m)),b.has(l[u]))if(b.has(l[m])){const E=p.get(h[v]),re=E!==void 0?r[E]:null;if(re===null){const we=B(i,r[u]);R(we,a[v]),d[v]=we}else d[v]=R(re,a[v]),B(i,r[u],re),r[E]=null;v++}else ge(r[m]),m--;else ge(r[u]),u++;for(;v<=f;){const E=B(i,d[f+1]);R(E,a[v]),d[v++]=E}for(;u<=m;){const E=r[u++];E!==null&&ge(E)}return this.ht=h,nt(i,d),x}});class Bt extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.userId=jsObject.profile.user_id}firstUpdated(){this.getCtas()}getCtas(){makeRequest("POST","user_ctas",{user_id:this.userId},"zume_system/v1").done(e=>{const t=Object.values(e);this.allCtas=t,this.ctas=this.shuffleArray(t).slice(0,3)})}shuffleArray(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}renderCta({content:e,content_template:t}){if(t==="card")return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",ts);class ke extends Ht(g){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1}handleClick(e){this.disableNavigate||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return o`
            <a
                href=${this.href}
                class=${this.class}
...
//# sourceMappingURL=main-5ba8587c.js.map

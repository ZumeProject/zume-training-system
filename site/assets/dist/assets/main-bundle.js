                ...
                <div>
                    ...
                    <div class="list__tertiary collapse" ?data-open=${this.openDetailStates[e]}>
                        <ul class="bullets py-1">
                            ${c.map(u=>l`
                                    <li>
                                        <a href=${[jsObject.site_url,jsObject.language,u.slug].join("/")}>
                                            ${u.title}
                                        </a>
                                    </li>
                                `)}

...
`:""}`}copyInvite(){const e=this.getInviteText();navigator.clipboard&&navigator.clipboard.writeText(e).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)})}render(){const e=this.getInviteText();return c`
        ...
        `}createRenderRoot(){return this}}window.customElements.define("invite-friends",bo);class yo extends w{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},code:{attribute:!1},message:{attribute:!1},errorMessage:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.code="",this.errorMessage="",this.showTrainings=!1,this.loading=!1}firstUpdated(){const e=new URL(location.href);if(!e.searchParams.has("code")){this.message="",this.loading=!1,this.showTrainings=!0;return}const t=e.searchParams.get("code");this.connectToPlan(t)}connectToPlan(e){this.loading=!0,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}})),this.message=this.t.please_wait,this.code=e,makeRequest("POST","connect/public-plan",{code:e},"zume_system/v1").then(t=>{console.log(t),this.message=this.t.success.replace("%s",t.name),this._sendDoneStepEvent()}).fail(({responseJSON:t})=>{console.log(t),this.message="",t.code==="bad_plan_code"?this.setErrorMessage(this.t.broken_link):this.setErrorMessage(this.t.error),this._sendDoneStepEvent()}).always(()=>{this.loading=!1,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}}))})}_sendDoneStepEvent(){setTimeout(()=>{const e=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(e)},2e3)}setErrorMessage(e){this.errorMessage=e,setTimeout(()=>{this.errorMessage=""},3e3)}_handleChosenTraining(e){console.log(e);const{code:t}=e.detail;this.showTrainings=!1,this.connectToPlan(t)}render(){return c`
            ...
            <span class="loading-spinner ${this.loading?"active":""}"></span>
            <div class="warning banner" data-state=${this.errorMessage.length?"":"empty"}>${this.errorMessage}</div>
        `}createRenderRoot(){return this}}customElements.define("join-training",yo);class wo extends w{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object}}}render(){return c`
        ...
        `}_handleDone(e){if(e&&e.preventDefault(),Object.keys(this.state).length===0){this.setErrorMessage(this.t.missing_response);return}this._sendDoneStepEvent()}_sendDoneStepEvent(){const e=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(e)}_handleFinish(){setTimeout(()=>{this._sendDoneStepEvent()},3e3)}_handleChange(e){e.target.type==="checkbox"&&(this.state[e.target.value]=e.target.checked),e.target.type==="text"&&(this.state.value=e.target.value),e.target.type==="select-one"&&(this.state.value=e.target.value),this.stateManager.add(this.variant,this.state)}createRenderRoot(){return this}}customElements.define("request-coach",_o);class So extends w{constructor(){super();C(this,"module");C(this,"steps");this.t={},this.display=[]}static get properties(){return{t:{type:Object},name:{type:String},howOften:{type:String},howManySessions:{type:String},scheduleDecision:{type:String},whatLocation:{type:String},date:{type:String},time:{type:String},display:{type:Array}}}connectedCallback(){super.connectedCallback(),this.howOfterDict={weekly:this.t.weekly,biweekly:this.t.biweekly,monthly:this.t.monthly,other:this.t.other},this.howManyDict={20:this.t.hour_1_session_20,10:this.t.hour_2_session_10,5:this.t.hour_4_session_5},this.scheduleDecisionDict={yes:this.t.yes,no:this.t.no}}handleChange(t){const s=t.target.dataset.step;this.dispatchEvent(new CustomEvent("wizard:goto-step",{bubbles:!0,detail:{slug:s}})),window.scrollTo(0,0)}shouldDisplay(){return this.display.length>0}renderSummary(t){switch(t){case h.name:return c`
                    <div class="stack--1">
 ...
 */const fi=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},ce=Li(class extends Ri{constructor(i){if(super(i),i.type!==fe.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],a=[];let r=0;for(const o of i)n[r]=s?s(o,r):r,a[r]=t(o,r),r++;return{values:a,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const a=pa(i),{values:r,keys:o}=this.dt(e,t,s);if(!Array.isArray(a))return this.ht=o,r;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],d=[];let u,m,g=0,p=a.length-1,b=0,S=r.length-1;for(;g<=p&&b<=S;)if(a[g]===null)g++;else if(a[p]===null)p--;else if(l[g]===o[b])d[b]=ue(a[g],r[b]),g++,b++;else if(l[p]===o[S])d[S]=ue(a[p],r[S]),p--,S--;else if(l[g]===o[S])d[S]=ue(a[g],r[S]),Fe(i,d[S+1],a[g]),g++,S--;else if(l[p]===o[b])d[b]=ue(a[p],r[b]),Fe(i,a[g],a[p]),p--,b++;else if(u===void 0&&(u=fi(o,b,S),m=fi(l,g,p)),u.has(l[g]))if(u.has(l[p])){const T=m.get(o[b]),K=T!==void 0?a[T]:null;if(K===null){const te=Fe(i,a[g]);ue(te,r[b]),d[b]=te}else d[b]=ue(K,r[b]),Fe(i,a[g],K),a[T]=null;b++}else Ut(a[p]),p--;else Ut(a[g]),g++;for(;b<=S;){const T=Fe(i,d[S+1]);ue(T,r[b]),d[b++]=T}for(;g<=p;){const T=a[g++];T!==null&&Ut(T)}return this.ht=o,Pi(i,d),Y}});class de extends w{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle(),window.scrollTo({top:0,behavior:"instant"})}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const a=Math.round(n.contentRect.height),r=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,a,r)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let a;s<window.innerWidth/2?a=this.initialOffset:a=this.initialOffset+t,n.style.top=a+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Ao extends de{static get properties(){return{showTeaser:{type:Boolean},churches:{type:Array,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.route=_.getRoute("my-churches"),this.churches=[],this.renderChurch=this.renderChurch.bind(this),this.addChurch=this.addChurch.bind(this),this.handleSubmit=this.handleSubmit.bind(this)}firstUpdated(){super.firstUpdated(),document.querySelector("#add-church-form").addEventListener("submit",this.handleSubmit)}updated(){jQuery(document).foundation()}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(e=>{const t=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(t)})}handleSubmit(e){e.preventDefault(),this.addChurch()}addChurch(){const e=this.churches.length+1,t=[{id:e,name:"This is a new church",location:"Birmingham, UK",depth:0},{id:`${e}-1`,name:"Tea Shop 1",location:"Birmingham, UK",parent:e,depth:1},{id:`${e}-2`,name:"Tea Shop 2",location:"Birmingham, UK",parent:e,depth:1},{id:`${e}-2-1`,name:"Tea Shop 2 child",location:"Birmingham, UK",parent:`${e}-2`,depth:2},{id:`${e}-3`,name:"Breakfast Shop",location:"Birmingham, UK",parent:e,depth:1}];this.churches=[...this.churches,...t],this.closeChurchModal()}editChurch(e){console.log("edit church",e)}deleteChurch(e){console.log("delete church",e)}openChurchModal(){if(this.showTeaser)return;const e=document.querySelector("#new-church-form");jQuery(e).foundation("open")}closeChurchModal(){const e=document.querySelector("#new-church-form");jQuery(e).foundation("close"),this.clearChurchModal()}clearChurchModal(){jQuery("#add-church-form input").each(function(e){this.value=""})}renderChurch({id:e,name:t,location:s,depth:n}){return c`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-progress",Uo);class qo extends Dt{constructor(){super("training")}createRenderRoot(){return this}}customElements.define("dash-training",qo);class Vo extends de{static get properties(){return{showTeaser:{type:Boolean},id:{type:Number},loading:{type:Boolean,attribute:!1},training:{type:Object,attribute:!1},sessions:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.loading=!1,this.route=_.getRoute("my-training"),this.renderListItem=this.renderListItem.bind(this)}connectedCallback(){super.connectedCallback(),this.id!=="teaser"&&(this.loading=!0,this.getTraining().then(()=>{this.refreshSessions(),this.groupMembers=this.getParticipants()}).always(()=>{this.loading=!1}))}firstUpdated(){super.firstUpdated()}updated(){jQuery(document).foundation()}getTraining(){const e=jsObject.training_groups[this.id];return this.code=e.join_key,makeRequest("GET",`plan/${this.code}`,{},"zume_system/v1").then(t=>{this.training=t}).promise()}refreshSessions(e){e&&(this.training.completed_sessions=e),this.sessions=this.getSessions(),this.currentSession=this.getCurrentSession()}getSessions(){const e=this.getTrainingType(),t=this.getNumberOfSessions(),s=[];for(let n=1;n<t+1;n++){const a=n<10?`0${n}`:`${n}`,r=e+"_"+a,o=this.training[r];s.push({id:r,name:jsObject.translations.session_x.replace("%d",n),datetime:o?Number(o.timestamp)*1e3:0,completed:this.training.completed_sessions.includes(r)})}return s}getParticipants(){return[{id:4,name:"Bonnie Sue"}]}getTrainingType(){return this.training.set_type.key}getNumberOfSessions(){switch(this.training.set_type.key){case"set_a":return 10;case"set_b":return 20;case"set_c":return 5}}getCurrentSession(){this.getTrainingType();for(let e=0;e<this.sessions.length;e++){const t=this.sessions[e];if(!t.completed)return t.id}return""}createTraining(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,detail:{type:O.makeFirstGroup}}))}editSession(e){}markSessionCompleted(e){makeRequest("POST","plan/complete-session",{key:this.training.join_key,session_id:e},"zume_system/v1").then(t=>{this.refreshSessions(t)})}renderListItem(e){const{id:t,name:s,datetime:n,completed:a}=e;return c`
        ...
        `}render(){return c`
            <div class="dashboard__content">
                ...
                <dash-header-right></dash-header-right>
                <div class="dashboard__main">
                    ${this.loading?c`<span class="loading-spinner active"></span>`:c`
                                ${this.showTeaser?c`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",Vo);class Ho extends w{firstUpdated(){const e=this.offsetTop;this.style.top=e+"px"}render(){return c`
            <div class="dashboard__header right">
                <dash-sidebar-toggle displayOn="medium"></dash-sidebar-toggle>
                <launch-course></launch-course>
            </div>
        `}createRenderRoot(){return this}}customElements.define("dash-header-right",Ho);class Zo extends w{static get properties(){return{displayOn:{type:String}}}constructor(){super(),this.displayOn="large"}toggleSidebar(){const e=new CustomEvent("toggle-dashboard-sidebar",{bubbles:!0});this.dispatchEvent(e)}render(){return c`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",Zo);class $s extends Wn(w){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1}handleClick(e){this.disableNavigate||(e.preventDefault(),this.navigate(this.href)),e.preventDefault()}printBool(e){return e?"true":"false"}render(){return c`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",$s);class Bo extends $s{constructor(){super()}renderText(){return this.text.split(" ").map(e=>c`
            <span>${e}</span>
        ...
        `}}customElements.define("grid-link",Bo);class Go extends $s{constructor(){super()}renderText(){return this.text.split(" ").map(e=>c`
            <span>${e}</span>
        `)}getIcon(){return this.locked?this.icon+"-locked":this.icon}render(){return c`
            <div class="container-inline">
                <div
        ...
        `}createRenderRoot(){return this}}customElements.define("course-presenter",pl);class fl extends w{static get properties(){return{sections:{type:Array}}}render(){return c`
        ...
        `}createRenderRoot(){return this}}customElements.define("activity-3-month-plan",bl);class Un extends w{constructor(){super()}render(){return c`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",Un);class yl extends w{constructor(){super();C(this,"webShareSupported",!!window.navigator.share);C(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},alwaysShow:{type:Boolean},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(t){t.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return c`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-list",wl);class $l extends w{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){makeRequest("POST","public_plans",{},"zume_system/v1").then(e=>{this.plans=e}).catch(e=>{console.log(e)}).always(()=>{this.loading=!1})}render(){return this.loading?c`<span class="loading-spinner active"></span>`:c`
            <table>
                <thead>
                    <tr>
                        <td>${this.t.name}</td>
 ...
 */function*bi(i,e){if(i!==void 0){let t=0;for(const s of i)yield e(s,t++)}}class Vn extends w{static get properties(){return{startDate:{type:String},endDate:{type:String},selectedDays:{type:Array},view:{type:String},showToday:{type:Boolean},monthToShow:{attribute:!1}}}constructor(){super(),this.monthToShow=null,this.startDate="",this.endDate="",this.selectedDays=[],this.showToday=!1,this.today=v.now().toISODate(),this.view="slider"}nextView(e){this.shadowRoot.querySelectorAll(".selected-time").forEach(t=>t.classList.remove("selected-time")),this.monthToShow=e}selectDay(e,t){const s=this.selectedDays.filter(n=>n.date===t);s.length===0?this.dispatchEvent(new CustomEvent("day-added",{detail:{date:t}})):s.forEach(({id:n})=>{this.dispatchEvent(new CustomEvent("day-removed",{detail:{id:n}}))}),this.shadowRoot.querySelectorAll(".selected-time").forEach(n=>n.classList.remove("selected-time")),e.target.classList.add("selected-time")}getDaysOfTheWeekInitials(e="en-US",t="long"){const s=new Date,n=864e5,a=new Intl.DateTimeFormat(e,{weekday:t}).format;return[...Array(7).keys()].map(r=>a(new Date().getTime()-(s.getDay()-r)*n))}buildCalendarDays(e="en-US",t){const s=t.startOf("month").startOf("day"),n=[],a=new Intl.DateTimeFormat(e,{day:"numeric"}).format;for(let r=0;r<t.daysInMonth;r++){const o=s.plus({days:r}),l=o.plus({days:1}),d=this.endDate&&o>v.fromISO(this.endDate)||l<=v.fromISO(this.startDate),u={key:o.toISODate(),formatted:a(o.toMillis()),disabled:d};n.push(u)}return n}addMonth(){const e=v.fromISO(this.endDate).plus({months:1}).endOf("month").toISODate();this.dispatchEvent(new CustomEvent("calendar-extended",{detail:{newEndDate:e}})),this.endDate=e}isSelected(e){return!!this.selectedDays.find(s=>s.date===e)}renderCalendar(e){const t=this.getDaysOfTheWeekInitials(navigator.language,"narrow"),s=e.startOf("month").weekday,n=this.buildCalendarDays(navigator.language,e);return c`
        ...
        `]);customElements.define("calendar-select",Vn);class _l extends w{static get properties(){return{t:{type:Object},selectedDays:{type:Array},date:{type:String,attribute:!1}}}connectedCallback(){super.connectedCallback(),this.renderDate=this.renderDate.bind(this)}onChange(e){this.date=e.target.value}addDate(){this.date&&this.dispatchEvent(new CustomEvent("day-added",{detail:{date:this.date}}))}removeDate(e){this.dispatchEvent(new CustomEvent("day-removed",{detail:{id:e}}))}renderDate({date:e,id:t},s){return c`
            <li>
                <div class="d-flex align-items-center justify-content-between">
        ...
        `}createRenderRoot(){return this}}customElements.define("calendar-list",_l);class Hn extends w{static get properties(){return{percentage:{type:Number}}}render(){return c`

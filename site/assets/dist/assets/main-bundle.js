...
<!--             <div
        ...
        `}}customElements.define("watch-slide",Sl);class Ol extends P{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>

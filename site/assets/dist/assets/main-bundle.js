        ...
        `}render(){var t,e,s,n;return l`
            <div class="dashboard__content">
                ...
                <div class="dashboard__main content">
                    ...
                    ${this.showTeaser&&!this.loading&&!this.error?l`
                        ...
                        `:l`
                            <ul class="list">
                                ${!this.loading&&this.sessions&&this.sessions.length>0?et(this.sessions,a=>a.id,this.renderListItem):""}
                            </ul>
                        `}
                </div>
                                ...
                                <div class="card | group-members | grow-0">
                                    ...
                                    <div class="collapse" data-state="open">
                                        ...
                                        ${!this.loading&&this.groupMembers&&this.groupMembers.length>0?l`
                                                <ol class="ps-1">
                                                    ${et(this.groupMembers,a=>a.id,this.renderMemberItem)}
                                                </ol>
                                            `:""}
                                    </div>
                                    <button
            ...
            <div class="reveal small" id="edit-session-modal" data-reveal data-v-offset="20">
                ...
                <div class="stack">
                    ...
                    <h3 class="text-center brand-light">${(e=this.sessionToEdit)==null?void 0:e.name}</h3>
                    <div class="cluster justify-content-center gapy-0">
                        <input type="date" name="date" class="fit-content m0" value=${(s=this.sessionToEdit)==null?void 0:s.date} @change=${this._handleChange} onclick="this.showPicker()" >
                        <input type="time" name="time" class="fit-content m0" value=${(n=this.sessionToEdit)==null?void 0:n.time} @change=${this._handleChange} min="00:00" max="23:55" step="300" onclick="this.showPicker()" />
                    </div>

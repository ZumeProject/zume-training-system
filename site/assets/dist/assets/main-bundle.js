...
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/const _a=(i,t,e)=>{const s=new Map;for(let n=t;n<=e;n++)s.set(i[n],n);return s},wt=Rr(class extends Fr{constructor(i){if(super(i),i.type!==ye.CHILD)throw Error("repeat() can only be used in text expressions")}ct(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);const n=[],a=[];let r=0;for(const o of i)n[r]=s?s(o,r):r,a[r]=e(o,r),r++;return{values:a,keys:n}}render(i,t,e){return this.ct(i,t,e).values}update(i,[t,e,s]){var n;const a=Ol(i),{values:r,keys:o}=this.ct(t,e,s);if(!Array.isArray(a))return this.ut=o,r;const h=(n=this.ut)!==null&&n!==void 0?n:this.ut=[],u=[];let y,j,x=0,O=a.length-1,R=0,H=r.length-1;for(;x<=O&&R<=H;)if(a[x]===null)x++;else if(a[O]===null)O--;else if(h[x]===o[R])u[R]=ve(a[x],r[R]),x++,R++;else if(h[O]===o[H])u[H]=ve(a[O],r[H]),O--,H--;else if(h[x]===o[H])u[H]=ve(a[x],r[H]),es(i,u[H+1],a[x]),x++,H--;else if(h[O]===o[R])u[R]=ve(a[O],r[R]),es(i,a[x],a[O]),O--,R++;else if(y===void 0&&(y=_a(o,R,H),j=_a(h,x,O)),y.has(h[x]))if(y.has(h[O])){const et=j.get(o[R]),ht=et!==void 0?a[et]:null;if(ht===null){const ft=es(i,a[x]);ve(ft,r[R]),u[R]=ft}else u[R]=ve(ht,r[R]),es(i,a[x],ht),a[et]=null;R++}else ji(a[O]),O--;else ji(a[x]),x++;for(;R<=H;){const et=es(i,u[H+1]);ve(et,r[R]),u[R++]=et}for(;x<=O;){const et=a[x++];et!==null&&ji(et)}return this.ut=o,Ur(i,u),Vt}});class El extends B{static get properties(){return{t:{type:Object},selectedDays:{type:Array},date:{type:String,attribute:!1},datePickerOpen:{type:Boolean,attribute:!1}}}constructor(){super(),this.datePickerOpen=!1,this.toggleDatePicker=this.toggleDatePicker.bind(this)}firstUpdated(){jQuery(this.renderRoot).foundation()}connectedCallback(){super.connectedCallback(),this.renderDate=this.renderDate.bind(this)}addDate(){this.date&&this.dispatchEvent(new CustomEvent("day-added",{detail:{date:this.date}}))}removeDate(t){this.dispatchEvent(new CustomEvent("day-removed",{detail:{id:t}}))}renderDate({date:t,id:e},s){return l`
            <li>
...
*/const Xr=Symbol.for(""),e1=i=>{if((i==null?void 0:i.r)===Xr)return i==null?void 0:i._$litStatic$},qt=(i,...t)=>({_$litStatic$:t.reduce((e,s,n)=>e+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
        ...
        `}footer(){let t="";return this.noUrlChange&&this.stepIndex>0&&this.type!==P.makeAGroup&&this.step.slug!==m.connectingToCoach&&(t=l`
                <button
                    @click=${this._onBack}
                ...
                >
                    <ul class="pt-0 ps-2" role="list" data-brand-light>
                        ${y.map(x=>l`
                                <li>
                                    <a
                                        href=${this.makeTrainingItemHref(x,n)}
                    ...
                    <ul>
                        ${this.isGroupLeader()?l`
                                  ...
                                  <li>
                                      ...
                                      <button
                                          class="menu-btn"
                                          @click=${x=>this.markSessionUncompleted(n,x)}
                                      >
                                          <span
                                              class="icon z-icon-pencil"
                                          ></span
                                      ...
                                      `:l`<button
                                          class="menu-btn"
                                          @click=${x=>this.markSessionCompleted(n,x)}
                                      >
                                          <span
                                              class="icon z-icon-pencil"
                                          ></span
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",v1);class y1 extends B{static get properties(){return{activeTrainingGroups:{type:Object,attribute:!1},inactiveTrainingGroups:{type:Object,attribute:!1},inactiveTrainingGroupsOpen:{type:Boolean,attribute:!1}}}constructor(){super(),this.activeTrainingGroups=jsObject.active_training_groups,this.inactiveTrainingGroups=jsObject.inactive_training_groups,this.routeName=L.myTrainings,this.route=W.getRoute(this.routeName),this.inactiveTrainingGroupsOpen=!1}firstUpdated(){Tt(this.renderRoot,"dash-trainings-list")}makeTrainingHref(t){return W.routes.find(({name:n})=>n===L.myTraining).pattern.replace(":code",t)}createTraining(){this.dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,detail:{type:P.planDecision}}))}toggleInactiveTrainingGroups(){this.inactiveTrainingGroupsOpen=!this.inactiveTrainingGroupsOpen}render(){return l`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <div class="dashboard__title">
                        <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("checkin-dashboard",E1);class x1 extends B{static get properties(){return{host:{type:Object},hostProgressList:{type:Object},displayOnly:{type:Boolean}}}toggleHost(t,e=[]){this.dispatchEvent(new CustomEvent("host:toggle",{detail:{host:t,additionalHostToCredit:e}}))}render(){return l`
        ...
        `}}customElements.define("discuss-slide",N1);class P1 extends $t{constructor(){super();const t=new URL(location.href);this.isTrainingMode=t.searchParams.has("training")}dispatchOpenMenu(){this.dispatchEvent(new CustomEvent("presenter:open-menu",{bubbles:!0}))}render(){return l`
            <div class="slides-card">
                <div class="cover-page">
        ...
        `}}customElements.define("final-slide",P1);class A1 extends $t{render(){return l`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column right">
                    <div>
        ...
        `}}customElements.define("left-image-slide",A1);class z1 extends $t{render(){return l`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">

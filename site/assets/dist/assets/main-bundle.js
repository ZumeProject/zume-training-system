                        ...
                        >
                            ...
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${_.childRoutesOf("training").map(e=>{const t=_.getLockedStatus(e.name,this.userState),s=_.getCompletedStatus(e.name,this.userState),n=e.type==="handled-link";return c`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(e.name)}

var Qn=Object.defineProperty;var Kn=(i,e,t)=>e in i?Qn(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var C=(i,e,t)=>(Kn(i,typeof e!="symbol"?e+"":e,t),t),At=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var L=(i,e,t)=>(At(i,e,"read from private field"),t?t.call(i):e.get(i)),U=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},se=(i,e,t,s)=>(At(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var W=(i,e,t)=>(At(i,e,"access private method"),t);var Qt;let Xn=(Qt=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},C(Qt,"prefix","Z5_"),Qt);window.ZumeStorage=Xn;var P,kt,yi,Je,Kt,_t,wi,Qe,Xt,St,$i,Ke,es;class ls{constructor(e){U(this,kt);U(this,Je);U(this,_t);U(this,Qe);U(this,St);U(this,Ke);C(this,"WIZARD_STATE_NAME","zume_wizard_state");C(this,"STALE_LIFESPAN",10*60*1e3);C(this,"MAX_LIFESPAN",60*60*1e3);U(this,P,void 0);C(this,"moduleName");this.moduleName=e,se(this,P,W(this,kt,yi).call(this))}isEmpty(){return Object.keys(L(this,P).data).length===0}isDataStale(){return W(this,Ke,es).call(this,L(this,P),this.STALE_LIFESPAN)}has(e){return Object.prototype.hasOwnProperty.call(L(this,P).data,e)}get(e){return L(this,P).data[e]}getAll(){return L(this,P).data}add(e,t){L(this,P).data[e]=t,W(this,Qe,Xt).call(this)}remove(e){delete L(this,P).data[e],W(this,Qe,Xt).call(this)}clear(){se(this,P,W(this,Je,Kt).call(this)),localStorage.removeItem(this.WIZARD_STATE_NAME)}}P=new WeakMap,kt=new WeakSet,yi=function(){const e=W(this,_t,wi).call(this);return e&&!W(this,Ke,es).call(this,e,this.MAX_LIFESPAN)&&e.module===this.moduleName?e:W(this,Je,Kt).call(this)},Je=new WeakSet,Kt=function(){return{module:this.moduleName,data:{},timestamp:Date.now()}},_t=new WeakSet,wi=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},Qe=new WeakSet,Xt=function(){W(this,St,$i).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(L(this,P)))},St=new WeakSet,$i=function(){L(this,P).timestamp=Date.now()},Ke=new WeakSet,es=function(e,t){return Date.now()-e.timestamp>t};const M={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinATraining:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin",setProfile:"set-profile",joinCommunity:"join-the-community"},A={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision",joinCommunity:"joinCommunity"},ea={planDecision:"plan-decision",howManySessions:"how-many-sessions",howOften:"how-often",startDate:"what-start-date",location:"what-location",review:"review-steps"},h={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",joinCommunity:"join-community",...ea},ta={[h.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[h.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[h.updatePhone]:{field:"phone",testExistance:i=>!!i}},sa={[M.gettingStarted]:{[A.completeProfile]:R([h.updateName,h.updateLocation],!1),[A.planDecision]:R([h.planDecision],!1)},[M.setProfile]:{[A.completeProfile]:R([h.updateName,h.updateLocation],!0)},[M.makeAGroup]:{[A.makePlan]:R([h.howManySessions,h.howOften,h.startDate,h.location,h.review,h.inviteFriends],!0)},[M.getACoach]:{[A.completeProfile]:R([h.updateName,h.updateLocation,h.updatePhone]),[A.getACoach]:R([h.contactPreferences,h.languagePreferences,h.howCanWeServe,h.connectingToCoach])},[M.joinATraining]:{[A.completeProfile]:R([h.updateName,h.updateLocation,h.updatePhone]),[A.joinTraining]:R([h.joinTraining],!0)},[M.connectWithFriend]:{[A.completeProfile]:R([h.updateName,h.updateLocation],!0),[A.connectFriend]:R([h.connectToFriend])},[M.joinFriendsPlan]:{[A.completeProfile]:R([h.updateName,h.updateLocation],!0),[A.joinFriendsTraining]:R([h.joinFriendsPlan])},[M.joinCommunity]:{[A.joinCommunity]:R([h.joinCommunity],!0)},[M.checkin]:{[A.checkin]:R([h.checkinSubmit])}};function R(i=[],e=!1){const t={steps:[],skippable:e};return i.forEach(s=>{Object.values(h).includes(s)&&t.steps.push(s)}),t}var le,ve,Ot,ki,Et,_i,Ct,Si;class ia{constructor(e){U(this,Ot);U(this,Et);U(this,Ct);U(this,le,void 0);U(this,ve,void 0);C(this,"profile");se(this,le,{}),se(this,ve,[]),this.profile=e}reset(){se(this,le,{})}isTypeValid(e){return!!Object.values(M).includes(e)}isLoaded(){return Object.keys(L(this,le)).length!==0}getSteps(e){return W(this,Et,_i).call(this,e),L(this,ve)}}le=new WeakMap,ve=new WeakMap,Ot=new WeakSet,ki=function(e){return this.isTypeValid(e)?sa[e]:{}},Et=new WeakSet,_i=function(e){const t=W(this,Ot,ki).call(this,e);Object.keys(t).length!==0&&W(this,Ct,Si).call(this,t)},Ct=new WeakSet,Si=function(e){se(this,le,e),se(this,ve,[]),Object.entries(L(this,le)).forEach(([t,{steps:s,skippable:n}])=>{s.forEach(a=>{const r=ta[a];let o=null;if(r&&this.profile){if(r.testExistance(this.profile[r.field],this.profile))return;o=this.profile[r.field]}const l={slug:a,module:t,skippable:n};o!==null&&(l.value=o),L(this,ve).push(l)})})};/**
 * @license
 ...
 */const fi=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},we=Li(class extends Ri{constructor(i){if(super(i),i.type!==pe.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],a=[];let r=0;for(const o of i)n[r]=s?s(o,r):r,a[r]=t(o,r),r++;return{values:a,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const a=pa(i),{values:r,keys:o}=this.dt(e,t,s);if(!Array.isArray(a))return this.ht=o,r;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],d=[];let u,m,g=0,p=a.length-1,b=0,_=r.length-1;for(;g<=p&&b<=_;)if(a[g]===null)g++;else if(a[p]===null)p--;else if(l[g]===o[b])d[b]=he(a[g],r[b]),g++,b++;else if(l[p]===o[_])d[_]=he(a[p],r[_]),p--,_--;else if(l[g]===o[_])d[_]=he(a[g],r[_]),Fe(i,d[_+1],a[g]),g++,_--;else if(l[p]===o[b])d[b]=he(a[p],r[b]),Fe(i,a[g],a[p]),p--,b++;else if(u===void 0&&(u=fi(o,b,_),m=fi(l,g,p)),u.has(l[g]))if(u.has(l[p])){const j=m.get(o[b]),K=j!==void 0?a[j]:null;if(K===null){const te=Fe(i,a[g]);he(te,r[b]),d[b]=te}else d[b]=he(K,r[b]),Fe(i,a[g],K),a[j]=null;b++}else Wt(a[p]),p--;else Wt(a[g]),g++;for(;b<=_;){const j=Fe(i,d[_+1]);he(j,r[b]),d[b++]=j}for(;g<=p;){const j=a[g++];j!==null&&Wt(j)}return this.ht=o,Pi(i,d),G}});class ce extends w{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle(),window.scrollTo({top:0,behavior:"instant"})}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const a=Math.round(n.contentRect.height),r=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,a,r)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let a;s<window.innerWidth/2?a=this.initialOffset:a=this.initialOffset+t,n.style.top=a+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Ao extends ce{static get properties(){return{showTeaser:{type:Boolean},churches:{type:Array,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.route=S.getRoute("my-churches"),this.churches=[],this.renderChurch=this.renderChurch.bind(this),this.addChurch=this.addChurch.bind(this),this.handleSubmit=this.handleSubmit.bind(this)}firstUpdated(){super.firstUpdated(),document.querySelector("#add-church-form").addEventListener("submit",this.handleSubmit)}updated(){jQuery(document).foundation()}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(e=>{const t=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(t)})}handleSubmit(e){e.preventDefault(),this.addChurch()}addChurch(){const e=this.churches.length+1,t=[{id:e,name:"This is a new church",location:"Birmingham, UK",depth:0},{id:`${e}-1`,name:"Tea Shop 1",location:"Birmingham, UK",parent:e,depth:1},{id:`${e}-2`,name:"Tea Shop 2",location:"Birmingham, UK",parent:e,depth:1},{id:`${e}-2-1`,name:"Tea Shop 2 child",location:"Birmingham, UK",parent:`${e}-2`,depth:2},{id:`${e}-3`,name:"Breakfast Shop",location:"Birmingham, UK",parent:e,depth:1}];this.churches=[...this.churches,...t],this.closeChurchModal()}editChurch(e){console.log("edit church",e)}deleteChurch(e){console.log("delete church",e)}openChurchModal(){if(this.showTeaser)return;const e=document.querySelector("#new-church-form");jQuery(e).foundation("open")}closeChurchModal(){const e=document.querySelector("#new-church-form");jQuery(e).foundation("close"),this.clearChurchModal()}clearChurchModal(){jQuery("#add-church-form input").each(function(e){this.value=""})}renderChurch({id:e,name:t,location:s,depth:n}){return c`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",Zo);class $s extends Un(w){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1}handleClick(e){this.disableNavigate||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return c`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("activity-3-month-plan",bl);class Wn extends w{constructor(){super()}render(){return c`
            <div class="container">
                <div class="circle">

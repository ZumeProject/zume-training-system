 ...
 */const ye=Symbol.for(""),ts=n=>{if((n==null?void 0:n.r)===ye)return n==null?void 0:n._$litStatic$},T=(n,...t)=>({_$litStatic$:t.reduce((e,s,i)=>e+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+n[i+1],n[0]),r:ye}),Vt=new Map,es=n=>(t,...e)=>{const s=e.length;let i,a;const r=[],l=[];let c,d=0,v=!1;for(;d<s;){for(c=t[d];d<s&&(a=e[d],(i=ts(a))!==void 0);)c+=i+t[++d],v=!0;d!==s&&l.push(a),r.push(c),d++}if(d===s&&r.push(t[s]),v){const u=r.join("$$lit$$");(t=Vt.get(u))===void 0&&(r.raw=r,Vt.set(u,t=r)),e=l}return n(t,...e)},ss=es(o);class is extends m{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},translations:{type:Object},noUrlChange:{type:Boolean},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),this._handlePlanDecision=this._handlePlanDecision.bind(this),this.stateManager=new zt}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._handleHistoryPopState),window.addEventListener("plan-decision",this._handlePlanDecision)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState),window.removeEventListener("plan-decision",this._handlePlanDecision)}firstUpdated(){this.loadWizard(),this._handleHistoryPopState(!0),this.translations&&(this.t=window.SHAREDFUNCTIONS.escapeObject(this.translations))}willUpdate(t){t.has("type")&&this.type===""&&this.wizard&&this.wizard.reset(),t.has("type")&&this.type!==""&&this.loadWizard()}loadWizard(){this.wizard=new ze(this.user),this.steps=this.wizard.getSteps(this.type),this._gotoStep(0)}render(){if(!(!this.wizard||!this.wizard.isLoaded()))return this.wizard.isTypeValid(this.type)?this.steps.length===0?o`
 ...
 */const Gt=(n,t,e)=>{const s=new Map;for(let i=t;i<=e;i++)s.set(n[i],i);return s},B=be(class extends fe{constructor(n){if(super(n),n.type!==U.CHILD)throw Error("repeat() can only be used in text expressions")}dt(n,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);const i=[],a=[];let r=0;for(const l of n)i[r]=s?s(l,r):r,a[r]=e(l,r),r++;return{values:a,keys:i}}render(n,t,e){return this.dt(n,t,e).values}update(n,[t,e,s]){var i;const a=He(n),{values:r,keys:l}=this.dt(t,e,s);if(!Array.isArray(a))return this.ht=l,r;const c=(i=this.ht)!==null&&i!==void 0?i:this.ht=[],d=[];let v,u,p=0,g=a.length-1,f=0,$=r.length-1;for(;p<=g&&f<=$;)if(a[p]===null)p++;else if(a[g]===null)g--;else if(c[p]===l[f])d[f]=q(a[p],r[f]),p++,f++;else if(c[g]===l[$])d[$]=q(a[g],r[$]),g--,$--;else if(c[p]===l[$])d[$]=q(a[p],r[$]),G(n,d[$+1],a[p]),p++,$--;else if(c[g]===l[f])d[f]=q(a[g],r[f]),G(n,a[p],a[g]),g--,f++;else if(v===void 0&&(v=Gt(l,f,$),u=Gt(c,p,g)),v.has(c[p]))if(v.has(c[g])){const A=u.get(l[f]),bt=A!==void 0?a[A]:null;if(bt===null){const Rt=G(n,a[p]);q(Rt,r[f]),d[f]=Rt}else d[f]=q(bt,r[f]),G(n,a[p],bt),a[A]=null;f++}else jt(a[g]),g--;else jt(a[p]),p++;for(;f<=$;){const A=G(n,d[$+1]);q(A,r[f]),d[f++]=A}for(;p<=g;){const A=a[p++];A!==null&&jt(A)}return this.ht=l,$e(n,d),z}});class I extends m{constructor(){super();const e=document.querySelector("html").dataset.dir;this.isRtl=e==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle(),window.scrollTo({top:0,behavior:"instant"})}attachResizeObeserver(){const t=document.querySelector("dash-header-right"),e=new ResizeObserver(s=>{for(let i of s){if(!i.contentRect)return;const a=Math.round(i.contentRect.height),r=Math.round(i.contentRect.width);this.updateHeaderStyle(!1,a,r)}});this.resizeObserver=e,e.observe(t)}updateHeaderStyle(t=!0,e=0,s=window.innerWidth){const i=document.querySelector(".dashboard__header.left");t&&(this.initialOffset=i.offsetTop);let a;s<window.innerWidth/2?a=this.initialOffset:a=this.initialOffset+e,i.style.top=a+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class cs extends I{static get properties(){return{showTeaser:{type:Boolean},churches:{type:Array,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.route=b.getRoute("my-churches"),this.churches=[],this.renderChurch=this.renderChurch.bind(this),this.addChurch=this.addChurch.bind(this),this.handleSubmit=this.handleSubmit.bind(this)}firstUpdated(){super.firstUpdated(),document.querySelector("#add-church-form").addEventListener("submit",this.handleSubmit)}updated(){jQuery(document).foundation()}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(t=>{const e=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(e)})}handleSubmit(t){t.preventDefault(),this.addChurch()}addChurch(){const t=this.churches.length+1,e=[{id:t,name:"This is a new church",location:"Birmingham, UK",depth:0},{id:`${t}-1`,name:"Tea Shop 1",location:"Birmingham, UK",parent:t,depth:1},{id:`${t}-2`,name:"Tea Shop 2",location:"Birmingham, UK",parent:t,depth:1},{id:`${t}-2-1`,name:"Tea Shop 2 child",location:"Birmingham, UK",parent:`${t}-2`,depth:2},{id:`${t}-3`,name:"Breakfast Shop",location:"Birmingham, UK",parent:t,depth:1}];this.churches=[...this.churches,...e],this.closeChurchModal()}editChurch(t){console.log("edit church",t)}deleteChurch(t){console.log("delete church",t)}openChurchModal(){if(this.showTeaser)return;const t=document.querySelector("#new-church-form");jQuery(t).foundation("open")}closeChurchModal(){const t=document.querySelector("#new-church-form");jQuery(t).foundation("close"),this.clearChurchModal()}clearChurchModal(){jQuery("#add-church-form input").each(function(t){this.value=""})}renderChurch({id:t,name:e,location:s,depth:i}){return o`
        ...
        `}}customElements.define("video-slide",Us);class Ns extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("watch-slide",Ns);class Ds extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>

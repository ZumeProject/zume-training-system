 ...
 */var pe,me;let g=class extends q{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=_t(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return C}};g.finalized=!0,g._$litElement$=!0,(pe=globalThis.litElementHydrateSupport)===null||pe===void 0||pe.call(globalThis,{LitElement:g});const Le=globalThis.litElementPolyfillSupport;Le==null||Le({LitElement:g});((me=globalThis.litElementVersions)!==null&&me!==void 0?me:globalThis.litElementVersions=[]).push("3.3.2");class kt extends g{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},translations:{type:Object},noUrlChange:{type:Boolean},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new He}resetWizard(){this.modules={}}firstUpdated(){this.translations&&(this.t=window.SHAREDFUNCTIONS.escapeObject(this.translations))}willUpdate(e){e.has("type")&&this.type===""&&this.resetWizard()}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.isWizardTypeValid(this.type)?this.steps.length===0?r`
        ...
        `}footer(){return this.stepIndex===this.steps.length-1?this.finishButton():""}_onBack(){if(this.stepIndex>0){const e=this.stepIndex-1;this._gotoStep(e)}}_onNext(){if(this.stepIndex+1<this.steps.length){const e=this.stepIndex+1;this._gotoStep(e)}else this._onFinish()}_onSkip(){const e=this.step.module;for(let t=this.stepIndex+1;t<this.steps.length;t++)if(this.steps[t].module!==e){this._gotoStep(t);return}this._onFinish()}_onQuit(){this._onFinish(!0)}_onFinish(e=!1){if(this.stateManager.clear(),this.resetWizard(),!this.finishUrl){this.dispatchEvent(new CustomEvent("user-state:change",{bubbles:!0})),this.dispatchEvent(new CustomEvent("wizard-finished",{bubbles:!0}));return}const t=new URL(this.finishUrl);e||(this.type===w.checkin?t.searchParams.set("completed",this.type):t.searchParams.set("completed",this.type)),window.location.href=t}_gotoStep(e,t=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(e),this.step=this.steps[this.stepIndex],t&&!this.noUrlChange)){const s=new URL(window.location.href),n=s.pathname.split("/"),o=n[n.length-1];let a="";Object.values(w).includes(o)?a=n.join("/")+"/"+this.step.slug+s.search:a=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,a)}}clampSteps(e){let t=e;return e>this.steps.length-1&&(t=this.steps.length-1),e<0&&(t=0),t}_handleHistoryPopState(e=!1){const s=new URL(window.location.href).pathname.split("/"),n=s[s.length-1];Object.values(w).includes(n)&&this._gotoStep(0,!1);let o="",a=0;this.steps.forEach(({slug:d,module:c},h)=>{if(o!==c&&(o=c,a=h),n===d){if(e===!0&&this.stateManager.isDataStale()){this._gotoStep(a);return}this._gotoStep(h,!1)}})}_handlePlanDecision(e){switch(e.target.dataset.decision){case"make":this.updateWizard(w.makeAGroup);break;case"join":this.updateWizard(w.joinATraining);break;case"skip":default:this._onSkip();break}}_handleLoading(e){const{loading:t}=e.detail;this.loading=t}makeModule(e=[],t=!1){const s={steps:[],skippable:t};return e.forEach(n=>{Object.keys(D).includes(n)&&s.steps.push(D[n])}),s}getModule(e,t=!1){const s={[$.completeProfile]:{steps:[D[l.updateName],D[l.updateLocation]],skippable:t},[$.planDecision]:{steps:[{slug:"plan-decision",component:(o,a,d)=>r`
                            <div class=${`stack ${d}`}>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:wt}=yt,St=i=>i.strings===void 0,De=()=>document.createComment(""),W=(i,e,t)=>{var s;const n=i._$AA.parentNode,o=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=n.insertBefore(De(),o),d=n.insertBefore(De(),o);t=new wt(a,d,i,i.options)}else{const a=t._$AB.nextSibling,d=t._$AM,c=d!==i;if(c){let h;(s=t._$AQ)===null||s===void 0||s.call(t,i),t._$AM=i,t._$AP!==void 0&&(h=i._$AU)!==d._$AU&&t._$AP(h)}if(a!==o||c){let h=t._$AA;for(;h!==a;){const b=h.nextSibling;n.insertBefore(h,o),h=b}}}return t},T=(i,e,t=i)=>(i._$AI(e,t),i),jt={},at=(i,e=jt)=>i._$AH=e,Ct=i=>i._$AH,ge=i=>{var e;(e=i._$AP)===null||e===void 0||e.call(i,!1,!0);let t=i._$AA;const s=i._$AB.nextSibling;for(;t!==s;){const n=t.nextSibling;t.remove(),t=n}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt=it(class extends nt{constructor(i){if(super(i),i.type!==M.PROPERTY&&i.type!==M.ATTRIBUTE&&i.type!==M.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!St(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===C||e===_)return e;const t=i.element,s=i.name;if(i.type===M.PROPERTY){if(e===t[s])return C}else if(i.type===M.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return C}else if(i.type===M.ATTRIBUTE&&t.getAttribute(s)===e+"")return C;return at(i),e}});class Et extends g{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,jsObject.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return r`
            ...
            ${this.variant===l.updateLocation?r`
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        id="city"
                        name="city"
                        .value="${this.city?xt(this.city):(e=this.localValue)==null?void 0:e.label}"
 ...
 */const qe=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},z=it(class extends nt{constructor(i){if(super(i),i.type!==M.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],o=[];let a=0;for(const d of i)n[a]=s?s(d,a):a,o[a]=t(d,a),a++;return{values:o,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const o=Ct(i),{values:a,keys:d}=this.dt(e,t,s);if(!Array.isArray(o))return this.ht=d,a;const c=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],h=[];let b,p,u=0,m=o.length-1,f=0,y=a.length-1;for(;u<=m&&f<=y;)if(o[u]===null)u++;else if(o[m]===null)m--;else if(c[u]===d[f])h[f]=T(o[u],a[f]),u++,f++;else if(c[m]===d[y])h[y]=T(o[m],a[y]),m--,y--;else if(c[u]===d[y])h[y]=T(o[u],a[y]),W(i,h[y+1],o[u]),u++,y--;else if(c[m]===d[f])h[f]=T(o[m],a[f]),W(i,o[u],o[m]),m--,f++;else if(b===void 0&&(b=qe(d,f,y),p=qe(c,u,m)),b.has(c[u]))if(b.has(c[m])){const x=p.get(d[f]),re=x!==void 0?o[x]:null;if(re===null){const Se=W(i,o[u]);T(Se,a[f]),h[f]=Se}else h[f]=T(re,a[f]),W(i,o[u],re),o[x]=null;f++}else ge(o[m]),m--;else ge(o[u]),u++;for(;f<=y;){const x=W(i,h[y+1]);T(x,a[f]),h[f++]=x}for(;u<=m;){const x=o[u++];x!==null&&ge(x)}return this.ht=d,at(i,h),C}});class O extends g{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle()}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const o=Math.round(n.contentRect.height),a=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,o,a)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let o;s<window.innerWidth/2?o=this.initialOffset:o=this.initialOffset+t,n.style.top=o+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Bt extends O{static get properties(){return{showTeaser:{type:Boolean},loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.loading=!0,this.route=v.getRoute("3-month-plan"),this.filterName="3-month-plan-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){super.firstUpdated();const e=this.filterStatus||"";this.fetchCommitments(e)}updated(){jQuery(document).foundation()}fetchCommitments(){const e=this.filterStatus;makeRequest("GET","commitments",{status:e},"zume_system/v1").done(t=>{this.commitments=t}).always(()=>{this.loading=!1})}openCommitmentsModal(){if(this.showTeaser)return;const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(e){this.value=""})}addCommitments(){const e=[];return jQuery(".post-training-plan").each(function(t){const s=jQuery(this).val();if(s){const o=jQuery(this).prev().text();console.log("Question: "+o+" Answer: "+s);var n=new Date;n.setDate(n.getDate()+30),this.value="";const a=makeRequest("POST","commitment",{user_id:jsObject.profile.user_id,post_id:jsObject.profile.contact_id,meta_key:"tasks",note:"Question: "+o+" Answer: "+s,question:o,answer:s,date:n,category:"post_training_plan"},"zume_system/v1");e.push(a.promise())}}),console.log(e),Promise.all(e).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(s=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}filterCommitments(e){this.filterStatus=e,this.fetchCommitments(e),ZumeStorage.save(this.filterName,e),this.closeFilter()}closeFilter(){const e=this.querySelector("#filter-menu");jQuery(e).foundation("close")}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:s,id:n,status:o}=e;return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("profile-form",rs);class k extends g{static get properties(){return{slide:{type:Object},id:{type:String}}}constructor(){super(),this.maxPercentage=80,this.resizeCallback=this.resizeCallback.bind(this)}connectedCallback(){super.connectedCallback(),this.dir=document.querySelector("html").dir,window.addEventListener("resize",this.resizeCallback)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this.resizeCallback)}firstUpdated(){this.resizeSlide(window),this.fitContentToSlide(".activity-card"),this.fitContentToSlide(".content-area__text")}resizeCallback(e){this.resizeSlide(e.currentTarget)}fitContentToSlide(e){const t=this.renderRoot.querySelector(e);if(!t)return;const s=t.getBoundingClientRect().height,n=this.renderRoot.querySelector(".stage"),o=n?n.getBoundingClientRect().height:0,a=s/(this.slideHeight-o)*100;if(a>this.maxPercentage){const c=2*this.maxPercentage/a;t.style.fontSize=`calc( var(--slide-unit) * ${c} )`}}resizeSlide(e){const t=document.querySelectorAll(".slides-card"),s=document.querySelectorAll(".video-slide"),n=[...t,s],{innerWidth:o,innerHeight:a}=e,d=o/a>16/9,c=d?16/9*a/100:o/100,h=d?a:9/16*o;this.slideUnit=c,this.slideHeight=h,n.forEach(b=>{b.style=`
                --slide-unit: ${c}px;
                --slide-height: ${h}px;
            `})}renderProgressBar(){let e=[],t=[];for(let s=0;s<this.slide.progress_bar.length;s++){const n=this.slide.progress_bar[s];if(!n){e.push(t),e.push(!1),t=[];continue}t.push(n)}return e.push(t),r`
    ...
    `);window.customElements.define("play-button",rt);class Es extends g{constructor(){super();S(this,"webShareSupported",!!window.navigator.share);S(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(t){t.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return r`
        ...
        `}renderRow({join_key:e,language_note:t,post_title:s,time_of_day_note:n,timezone_note:o,...a}){const d=a.set_a_01?"a":"b",c=d==="a"?10:20,h=`set_${d}_`,b=Date.now()/1e3;let p="";for(let m=1;m<c+1;m++){const f=m<10?`0${m}`:`${m}`,y=a[h+f];if(p=y.timestamp,b<y.timestamp)break}const u=moment(p*1e3).format("MMM Do 'YY");return r`
            <tr>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",ot);class zs extends ot{static get properties(){return{percent:{type:Number},type:{type:String}}}constructor(){super(),this.radius=50,this.lineWidth=15,this.percent=0,this.borderWidth=3,this.type="heard"}width(){return(this.radius+this.lineWidth)*2}getIconSvg(){switch(this.type){case"heard":return K`

var lt=Object.defineProperty;var ct=(i,e,t)=>e in i?lt(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var S=(i,e,t)=>(ct(i,typeof e!="symbol"?e+"":e,t),t),oe=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var P=(i,e,t)=>(oe(i,e,"read from private field"),t?t.call(i):e.get(i)),I=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},le=(i,e,t,s)=>(oe(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var L=(i,e,t)=>(oe(i,e,"access private method"),t);var ve;let dt=(ve=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},S(ve,"prefix","Z5_"),ve);window.ZumeStorage=dt;var j,se,He,ie,Fe,ne,Be,V,fe;class Ne{constructor(e){I(this,se);I(this,ie);I(this,ne);I(this,V);S(this,"WIZARD_STATE_NAME","zume_wizard_state");S(this,"STALE_LIFESPAN",10*60*1e3);S(this,"MAX_LIFESPAN",60*60*1e3);I(this,j,void 0);this.moduleName=e,le(this,j,L(this,se,He).call(this))}empty(){return Object.keys(P(this,j).data).length===0}isDataStale(){return L(this,V,fe).call(this,P(this,j),this.STALE_LIFESPAN)}get(e){return P(this,j).data[e]}getAll(){return P(this,j).data}add(e,t){P(this,j).data[e]=t,L(this,ne,Be).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(P(this,j)))}clear(){le(this,j,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}j=new WeakMap,se=new WeakSet,He=function(){const e=L(this,ie,Fe).call(this);return e&&!L(this,V,fe).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},ie=new WeakSet,Fe=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},ne=new WeakSet,Be=function(){P(this,j).timestamp=Date.now()},V=new WeakSet,fe=function(e,t){return Date.now()-e.timestamp>t};const w={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinATraining:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin",setProfile:"set-profile",joinCommunity:"join-the-community"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision",joinCommunity:"joinCommunity"},ht={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},c={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...ht},ut={[c.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[c.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[c.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Y=window,ye=Y.ShadowRoot&&(Y.ShadyCSS===void 0||Y.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_e=Symbol(),je=new WeakMap;let We=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==_e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ye&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=je.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&je.set(t,e))}return e}toString(){return this.cssText}};const pt=i=>new We(typeof i=="string"?i:i+"",void 0,_e),mt=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,n,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+i[o+1],i[0]);return new We(t,i,_e)},gt=(i,e)=>{ye?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const s=document.createElement("style"),n=Y.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=t.cssText,i.appendChild(s)})},Ce=ye?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return pt(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ce;const X=window,xe=X.trustedTypes,bt=xe?xe.emptyScript:"",Ee=X.reactiveElementPolyfillSupport,$e={toAttribute(i,e){switch(e){case Boolean:i=i?bt:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Qe=(i,e)=>e!==i&&(e==e||i==i),de={attribute:!0,type:String,converter:$e,reflect:!1,hasChanged:Qe};let U=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,s)=>{const n=this._$Ep(s,t);n!==void 0&&(this._$Ev.set(n,s),e.push(n))}),e}static createProperty(e,t=de){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const s=typeof e=="symbol"?Symbol():"__"+e,n=this.getPropertyDescriptor(e,s,t);n!==void 0&&Object.defineProperty(this.prototype,e,n)}}static getPropertyDescriptor(e,t,s){return{get(){return this[t]},set(n){const o=this[e];this[t]=n,this.requestUpdate(e,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||de}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,s=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const n of s)this.createProperty(n,t[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)t.unshift(Ce(n))}else e!==void 0&&t.push(Ce(e));return t}static _$Ep(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,s;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)===null||s===void 0||s.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return gt(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostConnected)===null||s===void 0?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostDisconnected)===null||s===void 0?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$EO(e,t,s=de){var n;const o=this.constructor._$Ep(e,s);if(o!==void 0&&s.reflect===!0){const a=(((n=s.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?s.converter:$e).toAttribute(t,s.type);this._$El=e,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$El=null}}_$AK(e,t){var s;const n=this.constructor,o=n._$Ev.get(e);if(o!==void 0&&this._$El!==o){const a=n.getPropertyOptions(o),d=typeof a.converter=="function"?{fromAttribute:a.converter}:((s=a.converter)===null||s===void 0?void 0:s.fromAttribute)!==void 0?a.converter:$e;this._$El=o,this[o]=d.fromAttribute(t,a.type),this._$El=null}}requestUpdate(e,t,s){let n=!0;e!==void 0&&(((s=s||this.constructor.getPropertyOptions(e)).hasChanged||Qe)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),s.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,s))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,o)=>this[o]=n),this._$Ei=void 0);let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(e=this._$ES)===null||e===void 0||e.forEach(n=>{var o;return(o=n.hostUpdate)===null||o===void 0?void 0:o.call(n)}),this.update(s)):this._$Ek()}catch(n){throw t=!1,this._$Ek(),n}t&&this._$AE(s)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(s=>{var n;return(n=s.hostUpdated)===null||n===void 0?void 0:n.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,s)=>this._$EO(s,this[s],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};U.finalized=!0,U.elementProperties=new Map,U.elementStyles=[],U.shadowRootOptions={mode:"open"},Ee==null||Ee({ReactiveElement:U}),((ce=X.reactiveElementVersions)!==null&&ce!==void 0?ce:X.reactiveElementVersions=[]).push("1.6.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var he;const ee=window,N=ee.trustedTypes,Oe=N?N.createPolicy("lit-html",{createHTML:i=>i}):void 0,te="$lit$",E=`lit$${(Math.random()+"").slice(9)}$`,ke="?"+E,vt=`<${ke}>`,H=document,Q=()=>H.createComment(""),Z=i=>i===null||typeof i!="object"&&typeof i!="function",Ze=Array.isArray,Ge=i=>Ze(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",ue=`[ 	
\f\r]`,B=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Pe=/-->/g,ze=/>/g,A=RegExp(`>|${ue}(?:([^\\s"'>=/]+)(${ue}*=${ue}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ae=/'/g,Te=/"/g,Ve=/^(?:script|style|textarea|title)$/i,Je=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),r=Je(1),K=Je(2),C=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Me=new WeakMap,q=H.createTreeWalker(H,129,null,!1),Ke=(i,e)=>{const t=i.length-1,s=[];let n,o=e===2?"<svg>":"",a=B;for(let l=0;l<t;l++){const h=i[l];let b,u,p=-1,m=0;for(;m<h.length&&(a.lastIndex=m,u=a.exec(h),u!==null);)m=a.lastIndex,a===B?u[1]==="!--"?a=Pe:u[1]!==void 0?a=ze:u[2]!==void 0?(Ve.test(u[2])&&(n=RegExp("</"+u[2],"g")),a=A):u[3]!==void 0&&(a=A):a===A?u[0]===">"?(a=n??B,p=-1):u[1]===void 0?p=-2:(p=a.lastIndex-u[2].length,b=u[1],a=u[3]===void 0?A:u[3]==='"'?Te:Ae):a===Te||a===Ae?a=A:a===Pe||a===ze?a=B:(a=A,n=void 0);const f=a===A&&i[l+1].startsWith("/>")?" ":"";o+=a===B?h+vt:p>=0?(s.push(b),h.slice(0,p)+te+h.slice(p)+E+f):h+E+(p===-2?(s.push(void 0),l):f)}const d=o+(i[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Oe!==void 0?Oe.createHTML(d):d,s]};class G{constructor({strings:e,_$litType$:t},s){let n;this.parts=[];let o=0,a=0;const d=e.length-1,l=this.parts,[h,b]=Ke(e,t);if(this.el=G.createElement(h,s),q.currentNode=this.el.content,t===2){const u=this.el.content,p=u.firstChild;p.remove(),u.append(...p.childNodes)}for(;(n=q.nextNode())!==null&&l.length<d;){if(n.nodeType===1){if(n.hasAttributes()){const u=[];for(const p of n.getAttributeNames())if(p.endsWith(te)||p.startsWith(E)){const m=b[a++];if(u.push(p),m!==void 0){const f=n.getAttribute(m.toLowerCase()+te).split(E),y=/([.?@])?(.*)/.exec(m);l.push({type:1,index:o,name:y[2],strings:f,ctor:y[1]==="."?Xe:y[1]==="?"?et:y[1]==="@"?tt:J})}else l.push({type:6,index:o})}for(const p of u)n.removeAttribute(p)}if(Ve.test(n.tagName)){const u=n.textContent.split(E),p=u.length-1;if(p>0){n.textContent=N?N.emptyScript:"";for(let m=0;m<p;m++)n.append(u[m],Q()),q.nextNode(),l.push({type:2,index:++o});n.append(u[p],Q())}}}else if(n.nodeType===8)if(n.data===ke)l.push({type:2,index:o});else{let u=-1;for(;(u=n.data.indexOf(E,u+1))!==-1;)l.push({type:7,index:o}),u+=E.length-1}o++}}static createElement(e,t){const s=H.createElement("template");return s.innerHTML=e,s}}function R(i,e,t=i,s){var n,o,a,d;if(e===C)return e;let l=s!==void 0?(n=t._$Co)===null||n===void 0?void 0:n[s]:t._$Cl;const h=Z(e)?void 0:e._$litDirective$;return(l==null?void 0:l.constructor)!==h&&((o=l==null?void 0:l._$AO)===null||o===void 0||o.call(l,!1),h===void 0?l=void 0:(l=new h(i),l._$AT(i,t,s)),s!==void 0?((a=(d=t)._$Co)!==null&&a!==void 0?a:d._$Co=[])[s]=l:t._$Cl=l),l!==void 0&&(e=R(i,l._$AS(i,e.values),l,s)),e}class Ye{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:n}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:H).importNode(s,!0);q.currentNode=o;let a=q.nextNode(),d=0,l=0,h=n[0];for(;h!==void 0;){if(d===h.index){let b;h.type===2?b=new F(a,a.nextSibling,this,e):h.type===1?b=new h.ctor(a,h.name,h.strings,this,e):h.type===6&&(b=new st(a,this,e)),this._$AV.push(b),h=n[++l]}d!==(h==null?void 0:h.index)&&(a=q.nextNode(),d++)}return o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class F{constructor(e,t,s,n){var o;this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=n,this._$Cp=(o=n==null?void 0:n.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=R(this,e,t),Z(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==C&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ge(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==_&&Z(this._$AH)?this._$AA.nextSibling.data=e:this.$(H.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:n}=e,o=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=G.createElement(n.h,this.options)),n);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const a=new Ye(o,this),d=a.u(this.options);a.v(s),this.$(d),this._$AH=a}}_$AC(e){let t=Me.get(e.strings);return t===void 0&&Me.set(e.strings,t=new G(e)),t}T(e){Ze(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,n=0;for(const o of e)n===t.length?t.push(s=new F(this.k(Q()),this.k(Q()),this,this.options)):s=t[n],s._$AI(o),n++;n<t.length&&(this._$AR(s&&s._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const n=e.nextSibling;e.remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class J{constructor(e,t,s,n,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=_}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,n){const o=this.strings;let a=!1;if(o===void 0)e=R(this,e,t,0),a=!Z(e)||e!==this._$AH&&e!==C,a&&(this._$AH=e);else{const d=e;let l,h;for(e=o[0],l=0;l<o.length-1;l++)h=R(this,d[s+l],t,l),h===C&&(h=this._$AH[l]),a||(a=!Z(h)||h!==this._$AH[l]),h===_?e=_:e!==_&&(e+=(h??"")+o[l+1]),this._$AH[l]=h}a&&!n&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Xe extends J{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}}const ft=N?N.emptyScript:"";class et extends J{constructor(){super(...arguments),this.type=4}j(e){e&&e!==_?this.element.setAttribute(this.name,ft):this.element.removeAttribute(this.name)}}class tt extends J{constructor(e,t,s,n,o){super(e,t,s,n,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=R(this,e,t,0))!==null&&s!==void 0?s:_)===C)return;const n=this._$AH,o=e===_&&n!==_||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,a=e!==_&&(n===_||o);o&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class st{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){R(this,e)}}const $t={O:te,P:E,A:ke,C:1,M:Ke,L:Ye,D:Ge,R,I:F,V:J,H:et,N:tt,U:Xe,F:st},Re=ee.litHtmlPolyfillSupport;Re==null||Re(G,F),((he=ee.litHtmlVersions)!==null&&he!==void 0?he:ee.litHtmlVersions=[]).push("2.7.3");const yt=(i,e,t)=>{var s,n;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let a=o._$litPart$;if(a===void 0){const d=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;o._$litPart$=a=new F(e.insertBefore(Q(),d),d,void 0,t??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var pe,me;let g=class extends U{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=yt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return C}};g.finalized=!0,g._$litElement$=!0,(pe=globalThis.litElementHydrateSupport)===null||pe===void 0||pe.call(globalThis,{LitElement:g});const Ie=globalThis.litElementPolyfillSupport;Ie==null||Ie({LitElement:g});((me=globalThis.litElementVersions)!==null&&me!==void 0?me:globalThis.litElementVersions=[]).push("3.3.2");class _t extends g{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},translations:{type:Object},noUrlChange:{type:Boolean},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new Ne}resetWizard(){this.modules={}}firstUpdated(){this.translations&&(this.t=window.SHAREDFUNCTIONS.escapeObject(this.translations))}willUpdate(e){e.has("type")&&this.type===""&&this.resetWizard()}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.isWizardTypeValid(this.type)?this.steps.length===0?r`
        ...
        `:r`
            ...
            `}containerSize(){const e=this.steps[this.stepIndex];return(e.slug=c.joinTraining)?"container-md":"container-xsm"}currentStep(){const e=this.steps[this.stepIndex];return e.component(e,this.t,"w-100")}headerButtons(){const{skippable:e}=this.step,t=this.stepIndex===this.steps.length-1;return r`
        <div class="cluster | inline s-3">
            ${e&&!t?r`<button @click=${this._onSkip} class="brand">${this.t.skip}</button>`:""}
            ${!e&&!t&&!this.noUrlChange?r`
        ...
        `}footer(){return this.stepIndex===this.steps.length-1?this.finishButton():""}_onBack(){if(this.stepIndex>0){const e=this.stepIndex-1;this._gotoStep(e)}}_onNext(){if(this.stepIndex+1<this.steps.length){const e=this.stepIndex+1;this._gotoStep(e)}else this._onFinish()}_onSkip(){const e=this.step.module;for(let t=this.stepIndex+1;t<this.steps.length;t++)if(this.steps[t].module!==e){this._gotoStep(t);return}this._onFinish()}_onQuit(){this._onFinish(!0)}_handleFinish(){this._onFinish()}_onFinish(e=!1){if(this.stateManager.clear(),this.resetWizard(),!this.finishUrl){this.dispatchEvent(new CustomEvent("user-state:change",{bubbles:!0})),this.dispatchEvent(new CustomEvent("wizard-finished",{bubbles:!0}));return}const t=new URL(this.finishUrl);if(e===!1)if(this.type===w.checkin){const n=new URL(location.href).searchParams.get("code");if(n!==null){const o=new URL(jsObject.checkin_dashboard_url);o.searchParams.set("code",n),console.log("GOTO Checkin Dashboard"),window.location.href=o.href;return}}else t.searchParams.set("completed",this.type);console.log("GOTO Dashboard",e),window.location.href=t.href}_gotoStep(e,t=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(e),this.step=this.steps[this.stepIndex],t&&!this.noUrlChange)){const s=new URL(window.location.href),n=s.pathname.split("/"),o=n[n.length-1];let a="";Object.values(w).includes(o)?a=n.join("/")+"/"+this.step.slug+s.search:a=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,a)}}clampSteps(e){let t=e;return e>this.steps.length-1&&(t=this.steps.length-1),e<0&&(t=0),t}_handleHistoryPopState(e=!1){const s=new URL(window.location.href).pathname.split("/"),n=s[s.length-1];Object.values(w).includes(n)&&this._gotoStep(0,!1);let o="",a=0;this.steps.forEach(({slug:d,module:l},h)=>{if(o!==l&&(o=l,a=h),n===d){if(e===!0&&this.stateManager.isDataStale()){this._gotoStep(a);return}this._gotoStep(h,!1)}})}_handlePlanDecision(e){switch(e.target.dataset.decision){case"make":this.updateWizard(w.makeAGroup);break;case"join":this.updateWizard(w.joinATraining);break;case"skip":default:this._onSkip();break}}_handleLoading(e){const{loading:t}=e.detail;this.loading=t}makeModule(e=[],t=!1){const s={steps:[],skippable:t};return e.forEach(n=>{Object.keys(D).includes(n)&&s.steps.push(D[n])}),s}getModule(e,t=!1){const s={[$.completeProfile]:{steps:[D[c.updateName],D[c.updateLocation]],skippable:t},[$.planDecision]:{steps:[{slug:"plan-decision",component:(o,a,d)=>r`
                            <div class=${`stack ${d}`}>
                        ...
                        `}],skippable:t},[$.joinCommunity]:{steps:[{slug:"join",component:(o,a,d)=>r`
                            <div class=${`stack ${d}`}>
                        ...
                        `}]},[$.makePlan]:this.makeModule([c.howManySessions,c.whatTimeOfDay,c.howOften,c.startDate,c.inviteFriends],t),[$.inviteFriends]:{steps:[D[c.inviteFriends]],skippable:t},[$.joinTraining]:{steps:[D[c.joinTraining]]}};return Object.keys(s).includes(e)?s[e]:s[$.completeProfile]}isWizardLoaded(){return Object.keys(this.modules).length!==0}loadWizard(e,t=!1){this.modules=e,t===!1&&(this.steps=[],this.stepIndex=0),Object.entries(this.modules).forEach(([s,{steps:n,skippable:o}])=>{const a=jsObject.profile;n.forEach(({component:d,slug:l})=>{const h=ut[l];let b=null;if(h&&a){if(h.testExistance(a[h.field],a))return;b=a[h.field]}const u={component:d,slug:l,module:s,skippable:o,doneHandler:this._onNext,handleLoading:this._handleLoading};b!==null&&(u.value=b),this.steps.push(u)})}),t===!1&&this._gotoStep(0)}updateWizard(e){const t=this.getWizard(e);Object.keys(t).length!==0&&this.loadWizard(t)}isWizardTypeValid(e){return!!Object.values(w).includes(e)}getWizard(e){return this.isWizardTypeValid(e)?{[w.gettingStarted]:{[$.completeProfile]:this.makeModule([c.updateName,c.updateLocation],!0),[$.planDecision]:this.getModule($.planDecision)},[w.setProfile]:{[$.completeProfile]:this.makeModule([c.updateName,c.updateLocation],!0)},[w.makeAGroup]:{[$.makePlan]:this.getModule($.makePlan)},[w.getACoach]:{[$.completeProfile]:this.makeModule([c.updateName,c.updateLocation,c.updatePhone]),[$.getACoach]:this.makeModule([c.contactPreferences,c.languagePreferences,c.howCanWeServe,c.connectingToCoach])},[w.joinATraining]:{[$.completeProfile]:this.makeModule([c.updateName,c.updateLocation,c.updatePhone]),[$.joinTraining]:this.getModule($.joinTraining)},[w.connectWithFriend]:{[$.completeProfile]:this.makeModule([c.updateName,c.updateLocation],!0),[$.connectFriend]:this.makeModule([c.connectToFriend])},[w.joinFriendsPlan]:{[$.completeProfile]:this.makeModule([c.updateName,c.updateLocation],!0),[$.joinFriendsTraining]:this.makeModule([c.joinFriendsPlan])},[w.joinCommunity]:{[$.joinCommunity]:this.getModule($.joinCommunity)},[w.checkin]:{[$.checkin]:this.makeModule([c.checkinSubmit])}}[e]:{}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState)}createRenderRoot(){return this}}window.customElements.define("zume-wizard",_t);const D={[c.updateName]:{slug:c.updateName,component:(i,e,t)=>r`
            <complete-profile
                class=${t}
                name=${i.slug}
                module=${i.module}
            ...
            ></complete-profile>
        `},[c.updateLocation]:{slug:c.updateLocation,component:(i,e,t)=>r`
            <complete-profile
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                value=${JSON.stringify(i.value)}
            ></complete-profile>
        `},[c.updatePhone]:{slug:c.updatePhone,component:(i,e,t)=>r`
            <complete-profile
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                value=${JSON.stringify(i.value)}
            ></complete-profile>
        `},[c.contactPreferences]:{slug:c.contactPreferences,component:(i,e,t)=>r`
            <request-coach
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @done-step=${i.doneHandler}
            ></request-coach>
        `},[c.languagePreferences]:{slug:c.languagePreferences,component:(i,e,t)=>r`
            <request-coach
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @done-step=${i.doneHandler}
            ></request-coach>
        `},[c.howCanWeServe]:{slug:c.howCanWeServe,component:(i,e,t)=>r`
            <request-coach
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @done-step=${i.doneHandler}
            ></request-coach>
        `},[c.connectingToCoach]:{slug:c.connectingToCoach,component:(i,e,t)=>r`
            <request-coach
                class=${t}
                name=${i.slug}
                module=${i.module}
            ...
            ></request-coach>
        `},[c.inviteFriends]:{slug:c.inviteFriends,component:(i,e,t)=>r`
            <invite-friends
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                .t=${e.share}
            ></invite-friends>
        `},[c.joinTraining]:{slug:c.joinTraining,component:(i,e,t)=>r`
            <join-training
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @loadingChange=${i.handleLoading}
            ></join-training>
        `},[c.joinFriendsPlan]:{slug:c.joinFriendsPlan,component:(i,e,t)=>r`
            <join-friends-training
                ...
                @loadingChange=${i.handleLoading}
            ></join-friends-training>
        `},[c.connectToFriend]:{slug:c.connectToFriend,component:(i,e,t)=>r`
            <connect-friend
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @loadingChange=${i.handleLoading}
            ></connect-friend>
        `},[c.checkinSubmit]:{slug:c.checkinSubmit,component:(i,e,t)=>r`
            <session-checkin
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @loadingChange=${i.handleLoading}
            ></session-checkin>
        `},[c.howManySessions]:{slug:c.howManySessions,component:(i,e,t)=>r`
            <make-group
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @done-step=${i.doneHandler}
            ></make-group>
        `},[c.whatTimeOfDay]:{slug:c.whatTimeOfDay,component:(i,e,t)=>r`
            <make-group
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @done-step=${i.doneHandler}
            ></make-group>
        `},[c.howOften]:{slug:c.howOften,component:(i,e,t)=>r`
            <make-group
                class=${t}
                name=${i.slug}
                module=${i.module}
                ...
                @done-step=${i.doneHandler}
            ></make-group>
        `},[c.startDate]:{slug:c.startDate,component:(i,e,t)=>r`
            <make-group
                class=${t}
                name=${i.slug}
                module=${i.module}
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},it=i=>(...e)=>({_$litDirective$:i,values:e});class nt{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:kt}=$t,wt=i=>i.strings===void 0,Le=()=>document.createComment(""),W=(i,e,t)=>{var s;const n=i._$AA.parentNode,o=e===void 0?i._$AB:e._$AA;if(t===void 0){const a=n.insertBefore(Le(),o),d=n.insertBefore(Le(),o);t=new kt(a,d,i,i.options)}else{const a=t._$AB.nextSibling,d=t._$AM,l=d!==i;if(l){let h;(s=t._$AQ)===null||s===void 0||s.call(t,i),t._$AM=i,t._$AP!==void 0&&(h=i._$AU)!==d._$AU&&t._$AP(h)}if(a!==o||l){let h=t._$AA;for(;h!==a;){const b=h.nextSibling;n.insertBefore(h,o),h=b}}}return t},T=(i,e,t=i)=>(i._$AI(e,t),i),St={},at=(i,e=St)=>i._$AH=e,jt=i=>i._$AH,ge=i=>{var e;(e=i._$AP)===null||e===void 0||e.call(i,!1,!0);let t=i._$AA;const s=i._$AB.nextSibling;for(;t!==s;){const n=t.nextSibling;t.remove(),t=n}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct=it(class extends nt{constructor(i){if(super(i),i.type!==M.PROPERTY&&i.type!==M.ATTRIBUTE&&i.type!==M.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!wt(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===C||e===_)return e;const t=i.element,s=i.name;if(i.type===M.PROPERTY){if(e===t[s])return C}else if(i.type===M.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return C}else if(i.type===M.ATTRIBUTE&&t.getAttribute(s)===e+"")return C;return at(i),e}});class xt extends g{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,jsObject.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return r`
        <form class="inputs stack" @submit=${this._handleSubmit}>
            ${this.variant===c.updateName?r`
            ...
            ${this.variant===c.updateLocation?r`
            ...
            `:""}
            ${[c.updatePhone,c.updateName].includes(this.variant)?r`
                <div class="cluster | mx-auto">
                    <button type="submit" class="btn" ?disabled=${this.loading}>${this.t.next}</button>
                    <span class="loading-spinner ${this.loading?"active":""}"></span>
                </div>
        ...
        <form class="inputs stack-2" @submit=${this._handleDone}>
            ...
            ${this.variant===c.languagePreferences?r`
            ...
            ${this.variant===c.howCanWeServe?r`
            ...
            `:""}
            ${this.variant===c.connectingToCoach?r`
        ...
        `}createRenderRoot(){return this}}customElements.define("session-checkin",Tt);class Mt extends g{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},state:{attribute:!1},errorMessage:{attribute:!1},message:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.state={},this.errorMessage="",this.message="",this.loading=!1}setErrorMessage(e){this.errorMessage=e,setTimeout(()=>{this.errorMessage=""},3e3)}render(){return r`
            ...
            `:""}
            ${this.variant===c.whatTimeOfDay?r`
            ...
            `:""}
            ${this.variant===c.startDate?r`
                <h2>When do you plan to start?</h2>
                <input type="date">
                <button class="btn" @click=${this._handleDone}>Done</button>
            `:""}

        `}_handleDone(e){e&&e.preventDefault(),this._sendDoneStepEvent()}_sendDoneStepEvent(){const e=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(e)}_handleFinish(){setTimeout(()=>{this._sendDoneStepEvent()},3e3)}createRenderRoot(){return this}}customElements.define("make-group",Mt);function Rt(i){return i?JSON.parse('{"'+i.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}function It(i,e){let t={};const s=i.split("/").filter(o=>o!=""),n=e.split("/").filter(o=>o!="");return s.map((o,a)=>{/^:/.test(o)&&(t[o.substring(1)]=n[a])}),t}function Lt(i){return i?new RegExp("^(|/)"+i.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}function Dt(i,e){if(Lt(e).test(i))return!0}function Ut(i){return class extends i{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...e){super(...e),this.route="",this.canceled=!1}connectedCallback(...e){super.connectedCallback(...e),this.routing(this.constructor.routes,(...t)=>this.router(...t)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...t)=>this.router(...t))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(e,t,s,n,o,a){a&&a(e,t,s,n),o(e,t,s,n)}routing(e,t){this.canceled=!0;const s=decodeURI(window.location.pathname),n=decodeURI(window.location.search);let o=e.filter(l=>l.pattern==="*")[0],a=e.filter(l=>l.pattern!=="*"&&Dt(s,l.pattern))[0],d=Rt(n);a?(a.params=It(a.pattern,s),a.data=a.data||{},a.authentication&&a.authentication.authenticate&&typeof a.authentication.authenticate=="function"?(this.canceled=!1,Promise.resolve(a.authentication.authenticate.bind(this).call()).then(l=>{this.canceled||(l?a.authorization&&a.authorization.authorize&&typeof a.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(a.authorization.authorize.bind(this).call()).then(h=>{this.canceled||(h?this.routed(a.name,a.params,d,a.data,t,a.callback):this.routed(a.authorization.unauthorized.name,a.params,d,a.data,t,a.callback))})):this.routed(a.name,a.params,d,a.data,t,a.callback):this.routed(a.authentication.unauthenticated.name,a.params,d,a.data,t,a.callback))})):a.authorization&&a.authorization.authorize&&typeof a.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(a.authorization.authorize.bind(this).call()).then(l=>{this.canceled||(l?this.routed(a.name,a.params,d,a.data,t,a.callback):this.routed(a.authorization.unauthorized.name,a.params,d,a.data,t,a.callback))})):this.routed(a.name,a.params,d,a.data,t,a.callback)):o&&(o.data=o.data||{},this.routed(o.name,{},d,o.data,t,o.callback))}}}function qt(i){return class extends i{navigate(e){window.history.pushState({},null,e),window.dispatchEvent(new CustomEvent("route"))}}}function be(i){return(e,t)=>{e.preventDefault(),t(new CustomEvent("open-wizard",{bubbles:!0,detail:{type:i}}))}}function De(){return[{name:"root",pattern:`${jsObject.base_url}`,icon:"",type:"dash-link",translation:"",data:{makeComponent:()=>""}},{name:"getting-started",pattern:`${jsObject.base_url}/getting-started`,icon:"zume-start",type:"dash-link",translation:jsObject.translations.getting_started,data:{makeComponent:i=>r`<dash-getting-started></dash-getting-started>`}},{name:"set-profile",pattern:"#",parent:"getting-started",icon:"zume-profile",type:"handled-link",clickHandler:be("set-profile"),translation:jsObject.translations.set_profile,explanation:jsObject.translations.set_profile_explanation,data:{makeComponent:()=>""}},{name:"join-a-training",pattern:"#",parent:"getting-started",icon:"zume-start",type:"handled-link",clickHandler:be("getting-started"),translation:jsObject.translations.plan_a_training,explanation:jsObject.translations.plan_a_training_explanation,data:{makeComponent:()=>""}},{name:"get-a-coach",pattern:"#",parent:"getting-started",icon:"zume-coach",type:"handled-link",clickHandler:be("get-a-coach"),translation:jsObject.translations.get_a_coach,explanation:jsObject.translations.get_a_coach_explanation,data:{makeComponent:()=>""}},{name:"training",pattern:`${jsObject.base_url}/training`,icon:"zume-training",type:"dash-link",translation:jsObject.translations.training,data:{makeComponent:i=>r`<dash-training></dash-training>`}},{name:"my-training",pattern:`${jsObject.base_url}/my-training`,parent:"training",icon:"zume-group",type:"dash-link",translation:jsObject.translations.my_training,explanation:jsObject.translations.my_training_explanation,data:{makeComponent:i=>r`<dash-trainings ?showTeaser=${i}></dash-trainings>`}},{name:"my-progress",pattern:`${jsObject.base_url}/my-progress`,parent:"training",icon:"zume-progress",type:"dash-link",translation:jsObject.translations.my_progress,explanation:jsObject.translations.my_progress_explanation,data:{makeComponent:i=>r`<dash-progress ?showTeaser=${i}></dash-progress>`}},{name:"3-month-plan",pattern:`${jsObject.base_url}/3-month-plan`,parent:"training",icon:"zume-plans",type:"dash-link",translation:jsObject.translations["3_month_plan"],explanation:jsObject.translations["3_month_plan_explanation"],data:{makeComponent:i=>r`<dash-3-month-plan ?showTeaser=${i}></dash-3-month-plan>`}},{name:"practicing",pattern:`${jsObject.base_url}/practicing`,icon:"zume-practicing",type:"dash-link",translation:jsObject.translations.practicing,data:{makeComponent:i=>r`<dash-practicing></dash-practicing>`}},{name:"my-coach",pattern:`${jsObject.base_url}/my-coach`,parent:"practicing",icon:"zume-coach",type:"dash-link",translation:jsObject.translations.my_coach,explanation:jsObject.translations.my_coach_explanation,data:{makeComponent:i=>r`<dash-coach ?showTeaser=${i}></dash-coach>`}},{name:"my-plans",pattern:`${jsObject.base_url}/my-plans`,parent:"practicing",icon:"zume-plans",type:"dash-link",translation:jsObject.translations.my_plans,explanation:jsObject.translations.my_plans_explanation,data:{makeComponent:i=>r`<dash-plans ?showTeaser=${i}></dash-plans>`}},{name:"my-churches",pattern:`${jsObject.base_url}/my-churches`,parent:"practicing",icon:"zume-churches",type:"dash-link",translation:jsObject.translations.my_churches,explanation:jsObject.translations.my_churches_explanation,data:{makeComponent:i=>r`<dash-churches ?showTeaser=${i}></dash-churches>`}},{name:"my-maps",pattern:`${jsObject.base_url}/my-maps`,parent:"practicing",icon:"zume-maps",type:"dash-link",translation:jsObject.translations.my_maps,explanation:jsObject.translations.my_maps_explanation,data:{makeComponent:i=>r`<dash-maps ?showTeaser=${i}></dash-maps>`}},{name:"not-found",pattern:"*",icon:"",type:"dash-link",data:{makeComponent:i=>r`<dash-not-found></dash-not-found>`}}]}class v extends Ut(g){static get properties(){return{route:{type:String},params:{type:Object},query:{type:Object},menuOffset:{type:Number,attribute:!1},userProfile:{type:Object,attribute:!1},userState:{type:Object,attribute:!1},wizardType:{type:String,attribute:!1}}}static get routes(){const e={1:"getting-started",2:"training",3:"practicing"},t=jsObject.user_stage.value||1,s=t<4?t:3,n=De().find(({name:d})=>d===e[s]),{makeComponent:o}=n.data;return De().map(d=>(d.name==="root"&&(d.data={makeComponent:o}),d))}static getRoute(e){return v.routes.find(s=>s.name===e)}static childRoutesOf(e){return v.routes.filter(({parent:s})=>s===e)}constructor(){super(),this.route="",this.params={},this.query={},this.data={},this.menuOffset=0,this.userProfile=jsObject.profile,this.userState=jsObject.user_stage.state,this.wizardType="",this.allCtas=[],this.ctas=[],this.userId=jsObject.profile.user_id,this.updateUserProfile=this.updateUserProfile.bind(this),this.updateWizardType=this.updateWizardType.bind(this),this.refetchState=this.refetchState.bind(this),this.refetchHost=this.refetchHost.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("user-profile:change",this.updateUserProfile),window.addEventListener("toggle-dashboard-sidebar",this.toggleSidebar),window.addEventListener("open-wizard",this.updateWizardType),window.addEventListener("wizard-finished",this.closeWizard),window.addEventListener("user-state:change",this.refetchState),window.addEventListener("user-host:change",this.refetchHost)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("user-profile:change",this.updateUserProfile),window.removeEventListener("toggle-dashboard-sidebar",this.toggleSidebar),window.removeEventListener("open-wizard",this.updateWizardType),window.removeEventListener("wizard-finished",this.closeWizard),window.removeEventListener("user-host:change",this.refetchHost)}firstUpdated(){this.menuOffset=this.getOffsetTop(".sidebar-wrapper"),this.getCtas()}updateWizardType(e){const t=e.detail.type;this.openWizard(t)}router(e,t,s,n){this.route=e,this.params=t,this.query=s,this.data=n}makeHref(e){return`${jsObject.base_url}/${e}`}makeHrefRoute(e){const s=v.routes.find(({name:n})=>n===e);return s?s.pattern:(console.error("MISSING ROUTE",e),"")}renderRoute(){const{makeComponent:e}=this.data;if(!e)return"";const t=v.getLockedStatus(this.route,this.userState);return e(t)}getOffsetTop(e){return this.querySelector(e).offsetTop}toggleSidebar(){const e=document.querySelector(".dashboard__sidebar"),t=document.querySelector(".sidebar__trigger-close-background"),s="200";e.style.transitionDuration=s,t.style.transitionDuration=s;const n=e.dataset.state;n==="open"&&(e.dataset.state="closed",t.style.opacity=0,setTimeout(()=>{t.style.visibility="hidden"},s)),(!n||n==="closed")&&(e.dataset.state="open",t.style.opacity="initial",t.style.visibility="visible")}updateUserProfile(e){const t=e.detail;this.userProfile=t}createInitials(e){return typeof e!="string"||e.length===0?"":e.split(" ").map(s=>s.length>0?s[0].toUpperCase():"").slice(0,2).join("")}static getCompletedStatus(e,t){return!!(e==="set-profile"&&t.set_profile_location&&t.set_profile_name||e==="get-a-coach"&&t.requested_a_coach||e==="join-a-training"&&(t.plan_created||t.joined_online_training))}static getLockedStatus(e,t){return!!(e==="my-plans"&&!t.made_3_month_plan||["my-churches","my-maps"].includes(e)&&!t.join_community||e==="3-month-plan"&&!t.can_create_3_month_plan||e==="my-training"&&!t.plan_created&&!t.joined_online_training)}getGettingStartedPercentage(){const e=["get-a-coach","set-profile","join-a-training"],t=e.reduce((s,n)=>v.getCompletedStatus(n,this.userState)?s+1:s,0);return Math.round(t/e.length*100)}openWizard(e){const t=document.querySelector("#wizard-modal");jQuery(t).foundation("open"),this.wizardType=e}closeWizard(){this.wizardType="";const e=document.querySelector("#wizard-modal");jQuery(e).foundation("close")}refetchState(){makeRequest("GET","user_stage",{},"zume_system/v1").done(e=>{(!e||!e.state)&&console.error("Stage or state data not returned from api"),jsObject.user_stage=e,this.userState=e.state})}refetchHost(){makeRequest("GET","user_host",{},"zume_system/v1").done(e=>{e||console.error("Host not returned from api"),jsObject.host_progress=e})}getCtas(){const e=new URL(location.href);e.searchParams.has("completed")&&e.searchParams.get("completed");const t=[],s=this.makeCelebration("joined-community");t.push(s),makeRequest("POST","user_ctas",{user_id:this.userId},"zume_system/v1").done(n=>{const o=Object.values(n);this.allCtas=o;const a=d=>{for(let l=d.length-1;l>0;l--){const h=Math.floor(Math.random()*(l+1));[d[l],d[h]]=[d[h],d[l]]}return d};this.ctas=[...t,...a(this.allCtas)].slice(0,3),jsObject.ctas=this.ctas,this.dispatchEvent(new CustomEvent("ctas:changed",{bubbles:!0}))})}makeCelebration(e){let t="",s="";switch(e){case"joined-community":t=jsObject.translations.joined_community,s=jsObject.images_url+"/thumbs-up.svg";break}return{content_template:"celebration",content:{title:jsObject.translations.congratulations,description:t,imageUrl:s}}}openProfile(){const e=document.querySelector("#profile-modal");jQuery(e).foundation("open")}closeProfile(){const e=document.querySelector("#profile-modal");jQuery(e).foundation("close")}openCommunityModal(e){e.preventDefault();const t=document.querySelector("#community-modal");jQuery(t).foundation("open")}closeCommunityModal(){const e=document.querySelector("#community-modal");jQuery(e).foundation("close")}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(e=>{this.refetchState()})}hasJoinedCommunity(){return!!this.userState.join_community}openResourcesModal(e){e.preventDefault();const t=document.querySelector("#resources-modal");jQuery(t).foundation("open")}closeResourcesModal(){const e=document.querySelector("#resources-modal");jQuery(e).foundation("close")}render(){return r`
                        ...
                        >
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${v.childRoutesOf("getting-started").map(e=>r`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                            ...
                            <li class="menu-section">
                                ...
                                <ul class="nested is-active">
                                    ${v.childRoutesOf("training").map(e=>r`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(e.name)}
                            ...
                            <li class="menu-section">
                                ...
                                ></nav-link>
                                <ul class="nested is-active">
                                    ${v.childRoutesOf("practicing").map(e=>r`
                                                <li>
                                                    <nav-link
                                                        class="menu-btn"
                                                        href=${this.makeHrefRoute(e.name)}
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ue=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},z=it(class extends nt{constructor(i){if(super(i),i.type!==M.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],o=[];let a=0;for(const d of i)n[a]=s?s(d,a):a,o[a]=t(d,a),a++;return{values:o,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const o=jt(i),{values:a,keys:d}=this.dt(e,t,s);if(!Array.isArray(o))return this.ht=d,a;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],h=[];let b,u,p=0,m=o.length-1,f=0,y=a.length-1;for(;p<=m&&f<=y;)if(o[p]===null)p++;else if(o[m]===null)m--;else if(l[p]===d[f])h[f]=T(o[p],a[f]),p++,f++;else if(l[m]===d[y])h[y]=T(o[m],a[y]),m--,y--;else if(l[p]===d[y])h[y]=T(o[p],a[y]),W(i,h[y+1],o[p]),p++,y--;else if(l[m]===d[f])h[f]=T(o[m],a[f]),W(i,o[p],o[m]),m--,f++;else if(b===void 0&&(b=Ue(d,f,y),u=Ue(l,p,m)),b.has(l[p]))if(b.has(l[m])){const x=u.get(d[f]),re=x!==void 0?o[x]:null;if(re===null){const Se=W(i,o[p]);T(Se,a[f]),h[f]=Se}else h[f]=T(re,a[f]),W(i,o[p],re),o[x]=null;f++}else ge(o[m]),m--;else ge(o[p]),p++;for(;f<=y;){const x=W(i,h[y+1]);T(x,a[f]),h[f++]=x}for(;p<=m;){const x=o[p++];x!==null&&ge(x)}return this.ht=d,at(i,h),C}});class O extends g{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle()}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const o=Math.round(n.contentRect.height),a=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,o,a)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let o;s<window.innerWidth/2?o=this.initialOffset:o=this.initialOffset+t,n.style.top=o+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Nt extends O{static get properties(){return{showTeaser:{type:Boolean},loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.loading=!0,this.route=v.getRoute("3-month-plan"),this.filterName="3-month-plan-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){super.firstUpdated();const e=this.filterStatus||"";this.fetchCommitments(e)}updated(){jQuery(document).foundation()}fetchCommitments(){const e=this.filterStatus;makeRequest("GET","commitments",{status:e},"zume_system/v1").done(t=>{this.commitments=t}).always(()=>{this.loading=!1})}openCommitmentsModal(){if(this.showTeaser)return;const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(e){this.value=""})}addCommitments(){const e=[];return jQuery(".post-training-plan").each(function(t){const s=jQuery(this).val();if(s){const o=jQuery(this).prev().text();console.log("Question: "+o+" Answer: "+s);var n=new Date;n.setDate(n.getDate()+30),this.value="";const a=makeRequest("POST","commitment",{user_id:jsObject.profile.user_id,post_id:jsObject.profile.contact_id,meta_key:"tasks",note:"Question: "+o+" Answer: "+s,question:o,answer:s,date:n,category:"post_training_plan"},"zume_system/v1");e.push(a.promise())}}),console.log(e),Promise.all(e).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(s=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}filterCommitments(e){this.filterStatus=e,this.fetchCommitments(e),ZumeStorage.save(this.filterName,e),this.closeFilter()}closeFilter(){const e=this.querySelector("#filter-menu");jQuery(e).foundation("close")}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:s,id:n,status:o}=e;return r`
        ...
        `}unlock3MonthPlan(){makeRequest("POST","log",{type:"training",subtype:"26_heard"},"zume_system/v1/").done(e=>{const t=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(t);const s=new CustomEvent("user-host:change",{bubbles:!0});this.dispatchEvent(s),this.showTeaser=!1})}render(){return console.log(this.route),r`
            <div class="dashboard__content" data-no-secondary-area>
                ...
                <div class="dashboard__main">
                    ${this.showTeaser?r`
                        ...
                        `:""}
                    ${this.loading&&!this.showTeaser?r`<span class="loading-spinner active"></span>`:r`
                                <ul class="list">
                                    ${!this.loading&&this.commitments&&this.commitments.length>0?z(this.commitments,e=>e.id,this.renderListItem):""}
                                </ul>
                            `}
                        ...
                        `:r`
                            <ul class="list">
                                ${this.churches.length===0?r`
                                    ...
                                    `:z(this.churches,e=>`${e.id}`,this.renderChurch)}
                            </ul>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",Ht);class Ft extends O{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",Ft);class Bt extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.ctas=[],this.getCtas=this.getCtas.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("ctas:changed",this.getCtas)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ctas:changed",this.getCtas)}firstUpdated(){this.getCtas()}getCtas(){this.ctas=jsObject.ctas??[]}renderCta({content:e,content_template:t}){if(t==="card")return r`
                <div class="stack | card cta">
                    <h2 class="h5 text-center">${e.title}</h2>
                    <p>${e.description}</p>
                    <a href="${e.link}" class="btn light uppercase">${e.link_text}</a>
                </div>
            `;if(t==="celebration")return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-top-level",ae);class Wt extends ae{constructor(){super("getting-started")}createRenderRoot(){return this}}customElements.define("dash-getting-started",Wt);class Qt extends O{static get properties(){return{showTeaser:{type:Boolean}}}constructor(){super(),this.showTeaser=!1}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(e=>{const t=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(t)})}render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
                    <h1 class="h3">Maps</h1>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",Qt);class Zt extends O{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-plans",Gt);class Vt extends ae{constructor(){super("practicing")}createRenderRoot(){return this}}customElements.define("dash-practicing",Vt);class Jt extends O{static get properties(){return{loading:{type:Boolean,attribute:!1},filteredItems:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1},hostProgress:{type:Object,attribute:!1}}}constructor(){super(),this.loading=!1,this.route=v.getRoute("my-progress"),this.trainingItems=Object.values(jsObject.training_items),this.hostProgress=jsObject.host_progress,this.filterName="my-progress-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.filteredItems=this.filterItems(this.filterStatus),this.openStates={},this.trainingItems.forEach(e=>{this.openStates[e.key]=!1}),this.renderListItem=this.renderListItem.bind(this),this.closeInfoModal=this.closeInfoModal.bind(this)}updated(){jQuery(document).foundation()}openInfoModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeInfoModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}filterProgress(e){this.filterStatus=e,this.filteredItems=this.filterItems(e),console.log(this.filteredItems),ZumeStorage.save(this.filterName,e),this.closeFilter()}filterItems(e){switch(e){case"heard":return this.trainingItems.filter(t=>{const s=t.host[0].key;return!!(this.hostProgress.list[s]||!1)});case"not-heard":return this.trainingItems.filter(t=>{const s=t.host[0].key;return!(this.hostProgress.list[s]||!1)});default:return[...this.trainingItems]}}closeFilter(){const e=this.querySelector("#filter-menu");jQuery(e).foundation("close")}toggleHost(e,t){t.stopImmediatePropagation();const{type:s,subtype:n,key:o}=e,a=this.hostProgress.list[o];a===!1&&makeRequest("POST","host",{type:s,subtype:n,user_id:jsObject.profile.user_id},"zume_system/v1").done(d=>{Array.isArray(d)&&(this.hostProgress.list[o]=!0),this.loadHostStatus()}),a===!0&&makeRequest("DELETE","host",{type:s,subtype:n,user_id:jsObject.profile.user_id},"zume_system/v1").done(d=>{Array.isArray(d)&&(this.hostProgress.list[o]=!1),this.loadHostStatus()})}loadHostStatus(){makeRequest("GET","host",{user_id:jsObject.profile.user_id},"zume_system/v1").done(e=>{this.hostProgress=e})}toggleDetails(e){const t=this.querySelector(`#details-${e}`),s=this.openStates[e],n=t.scrollHeight,o="200";s===!1?(t.style.height=n+"px",t.style.transitionDuration=o+"ms",t.dataset.state="opening",this.openStates[e]=!0,setTimeout(()=>{t.style.height="auto",t.dataset.state="open"},o)):(t.style.height=n+"px",t.dataset.state="closing",this.openStates[e]=!1,setTimeout(()=>{t.style.height="0"},10),setTimeout(()=>{t.dataset.state="closed"},o))}renderListItem(e){const{title:t,description:s,host:n,slug:o,key:a}=e;let d=[jsObject.site_url,jsObject.language,o].join("/");return jsObject.language==="en"&&(d=[jsObject.site_url,o].join("/")),r`
                ...
                <div>
                    ...
                    <div class="collapse" id="details-${a}" data-state="closed">
                        <div class="stack--2 mt--2">
                            ...
                            <div class="cluster">
                                <share-links url=${d} title=${t} .t=${jsObject.share_translations}></share-links>

                                ${jsObject.has_pieces_pages?r`
                                        <a class="btn light uppercase" href=${d} @click=${l=>l.stopImmediatePropagation()}>${jsObject.translations.view}</a>
                                    `:""}
                            </div>
                        </div>
                    </div>
        ...
        `}render(){var e,t,s,n,o,a,d,l;return r`
            <div class="dashboard__content" data-no-secondary-area>
                <div class="dashboard__header left">
                    <div class="dashboard__title">
                        <dash-sidebar-toggle></dash-sidebar-toggle>
                ...
                <div class="dashboard__main">
                    ${r`
                            <ul class="list">
                                ${z(this.filteredItems,h=>h.key,this.renderListItem)}
                            </ul>
                        `}
                </div>
            </div>
            <div class="reveal large" id="new-commitments-form" data-reveal data-v-offset="20">
                ...
                <div class="stack-2 host-info mx-2">
                    ...
                    <div class="switcher gap-1 align-items-center switcher-width-20">
                        <host-progress-circle class="grow-0" type="shared" percent=${((a=(o=this.hostProgress)==null?void 0:o.percent)==null?void 0:a.s)||0}></host-progress-circle>
                        <div class="stack--2">
                    ...
                    <div class="switcher gap-1 align-items-center switcher-width-20">
                        <host-progress-circle class="grow-0" type="trained" percent=${((l=(d=this.hostProgress)==null?void 0:d.percent)==null?void 0:l.t)||0}></host-progress-circle>
                        <div class="stack--2">
        ...
        `}renderMemberItem(e){console.log(e);const{name:t}=e;return r`
            <li>
                ${t}
            </li>
        `}render(){return r`
            <div class="dashboard__content">
                ...
                <div class="dashboard__main">
                    ${this.showTeaser?r`
                        ...
                        `:r`
                            <ul class="list">
                                ${!this.loading&&this.sessions&&this.sessions.length>0?z(this.sessions,e=>e.id,this.renderListItem):""}
                            </ul>
                        `}
                </div>
                <div class="dashboard__secondary stack">
                    ...
                    <div class="card | group-members | grow-0">
                        ...
                        <div class="collapse" data-state="open">
                            ...
                            ${!this.loading&&this.groupMembers&&this.groupMembers.length>0?r`
                                    <ol class="ps-1">
                                        ${z(this.groupMembers,e=>e.id,this.renderMemberItem)}
                                    </ol>
                                `:""}
                        </div>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",Yt);class Xt extends g{firstUpdated(){const e=this.offsetTop;this.style.top=e+"px"}render(){return r`
            <div class="dashboard__header right">
                <dash-sidebar-toggle displayOn="medium"></dash-sidebar-toggle>
                <launch-course></launch-course>
            </div>
        `}createRenderRoot(){return this}}customElements.define("dash-header-right",Xt);class es extends g{static get properties(){return{displayOn:{type:String}}}constructor(){super(),this.displayOn="large"}toggleSidebar(){const e=new CustomEvent("toggle-dashboard-sidebar",{bubbles:!0});this.dispatchEvent(e)}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",es);class we extends qt(g){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1}handleClick(e){this.disableNavigate||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return r`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",we);class ts extends we{constructor(){super()}renderText(){return this.text.split(" ").map(e=>r`
            <span>${e}</span>
        ...
        `}}customElements.define("grid-link",ts);class ss extends we{constructor(){super()}renderText(){return this.text.split(" ").map(e=>r`
            <span>${e}</span>
        `)}getIcon(){return this.locked?this.icon+"-locked":this.icon}render(){return r`
        ...
        `}}customElements.define("list-link",ss);class is extends g{static get properties(){return{translations:{type:Object},urls:{type:Object},position:{type:String},asLink:{type:Boolean}}}constructor(){super(),typeof jsObject<"u"&&(this.translations=jsObject.translations,this.urls=jsObject.urls),this.position="bottom";const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}updated(){jQuery(document).foundation()}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("launch-course",is);class ns extends g{constructor(){super();S(this,"addressCallback",t=>{t.features.length<1?this.locations=-1:this.locations=t.features});S(this,"processLocation",debounce(getAddressSuggestions(this.addressCallback,jsObject.map_key)));this.userProfile={},this.locations=[]}static get properties(){return{userProfile:{type:Object},loading:{type:Boolean,attribute:!1},locations:{type:Array,attribute:!1}}}firstUpdated(){this.nameInput=this.renderRoot.querySelector("#full_name"),this.phoneInput=this.renderRoot.querySelector("#phone"),this.emailInput=this.renderRoot.querySelector("#email"),this.preferredEmailInput=this.renderRoot.querySelector("#communications_email"),this.cityInput=this.renderRoot.querySelector("#city"),this.prefferedLanguageInput=this.renderRoot.querySelector("#preferred_language"),this.addressResultsContainer=this.renderRoot.querySelector("#address_results")}submitProfileForm(t){t.preventDefault();const s=this.nameInput.value,n=this.emailInput.value,o=this.preferredEmailInput.value,a=this.phoneInput.value,d=this.prefferedLanguageInput.value,l={name:s,phone:a,email:n,communications_email:o,preferred_language:d};l.location_grid_meta=getLocationGridFromMapbox(this.mapboxSelectedId,this.userProfile.location),this.loading=!0,fetch(jsObject.rest_endpoint+"/profile",{method:"POST",body:JSON.stringify(l),headers:{"X-WP-Nonce":jsObject.nonce}}).then(h=>h.json()).then(h=>{const b=new CustomEvent("user-profile:change",{bubbles:!0,detail:h});this.dispatchEvent(b);const u=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(u)}).catch(h=>{console.error(h)}).finally(()=>{this.loading=!1})}selectAddress(t){const s=t.target.id,n=t.target.dataset.placeName;this.cityInput.value=n,this.mapboxSelectedId=s,this.locations=[]}render(){var t;return r`
            <form action="" id="profile-form" @submit=${this.submitProfileForm}>
                ...
                <div class="">
                    ...
                    ${Array.isArray(this.locations)?"":r`
                            ${jsObject.translations.no_locations}
                        `}
                    ${Array.isArray(this.locations)&&this.locations.length>0?r`
                            <div id="address_results" class="stack my-0">
                                ${this.locations.map(s=>r`
                                    <div
                ...
                <div>
                    ...
                    ${Object.values(jsObject.languages).map(s=>r`
        ...
        `}}customElements.define("activity-slide",as);class rs extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
                    <div class="grow-1 d-flex align-items-center">
                        <div class="center activity-card stack--2" data-large>
                            ...
                            ${this.slide.center[1]?r`<span>${this.slide.center[1]}</span>`:""}
                        </div>
                    </div>
                </div>
            </div>
        `}}customElements.define("break-slide",rs);class os extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("center-slide",os);class ls extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("checkin-slide",ls);class cs extends k{render(){return r`
            <div class="slides-card">
        ...
        `}}customElements.define("congratulations-slide",cs);class ds extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("discuss-slide",ds);class hs extends k{render(){return r`
            <div class="slides-card">
                <div class="cover-page">
        ...
        `}}customElements.define("final-slide",hs);class us extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column right">
                    <div>
        ...
        `}}customElements.define("left-image-slide",us);class ps extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("next-steps-slide",ps);class ms extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("obey-slide",ms);class gs extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("overview-slide",gs);class bs extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("pray-slide",bs);class vs extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("review-slide",vs);class fs extends k{render(){return r`
            <div>
                <div class="slides-card">
                    ${this.renderProgressBar()}
        ...
        `}}customElements.define("video-slide",$s);class ys extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("watch-slide",ys);class _s extends k{render(){return r`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("look-back-slide",_s);const qe=["slideshow","guide"];class ks extends g{static get properties(){return{languageCode:{type:String},homeUrl:{type:String},assetsPath:{type:String},zumeSessions:{attribute:!1},menu:{attribute:!1},lessonIndex:{attribute:!1},sessionKey:{attribute:!1},view:{attribute:!1},linkNodes:{attribute:!1},showIndex:{attribute:!1}}}constructor(){super(),this.handleSessionLink=this.handleSessionLink.bind(this),this.handleHistoryPopState=this.handleHistoryPopState.bind(this)}connectedCallback(){super.connectedCallback();const e=new URL(window.location.href),{sessions:t,menu:s}=this.getZumeSessions(e);this.zumeSessions=t,this.menu=s;const n=this.getLessonIndex(e);this.lessonIndex=n,this.sessionKey="",this.view=this.getView(e),this.changeSession(n,!1,t),window.addEventListener("popstate",this.handleHistoryPopState)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this.handleHistoryPopState)}firstUpdated(){document.querySelectorAll(".language-selector").forEach(function(t){t.addEventListener("click",()=>{const s=t.dataset.value,n=new URL(location.href),o=n.pathname.substring(1).split("/");let a="";o.length>0&&jsObject.zume_languages.includes(o[0])?a=o.slice(1).join("/"):a=o.join("/"),s!=="en"?a="/"+s+"/"+a:a="/"+a,a+=n.search,location.href=a})})}getView(e){if(e.searchParams.has("view")){const t=e.searchParams.get("view");if(qe.includes(t))return t}else return"slideshow"}getLessonIndex(e){if(e.searchParams.has("session")){const t=e.searchParams.get("session");if(t==="index")return"index";const s=Number(t);return Number.isInteger(s)?s-1:0}else return 0}getZumeSessions(e){const t=e.searchParams.get("type")||"10";this.type=t;let s,n;switch(t){case"10":s=zume10Sessions,n=zume10SessionsMenu;break;case"20":s=zume20Sessions,n=zume20SessionsMenu;break;case"intensive":s=zumeIntensiveSessions,n=zumeIntensiveSessionsMenu;break;default:s=zume10Sessions,n=zume10SessionsMenu;break}return{sessions:s,menu:n}}handleSessionLink(e){const t=e.target,s=Number(t.dataset.sessionNumber);this.lessonIndex=s,this.showIndex===!0&&(this.showIndex=!1),this.changeSession(this.lessonIndex),this.closeMenu()}handleSubSectionLink(e,t){this.lessonIndex=e,this.showIndex===!0&&(this.showIndex=!1),this.changeSession(this.lessonIndex),this.sessionKey=t,this.closeMenu()}getNextSession(){this.lessonIndex+=1,this.changeSession(this.lessonIndex)}getPreviousSession(){this.lessonIndex-=1,this.changeSession(this.lessonIndex)}changeSession(e,t=!0,s=null){if(e==="index"){this.showIndex=!0;return}else this.showIndex=!1;const n=s||this.zumeSessions;let o=e;e<0&&(o=0),e>n.length-1&&(o=n.length-1),this.lessonIndex=o,this.session=n[o],t&&this.pushHistory()}pushHistory(){const e=this.lessonIndex,t=this.view,s=new URL(window.location.href);e!==null&&Number.isInteger(e)&&s.searchParams.set("session",e+1),t&&s.searchParams.set("view",t),window.history.pushState(null,null,s.href)}handleHistoryPopState(){var n;const e=new URL(location.href),t=e.searchParams.has("session")?e.searchParams.get("session"):null,s=e.searchParams.get("view");(n=document.querySelector(".js-off-canvas-overlay"))==null||n.classList.remove("is-visible"),Number.isInteger(Number(t))&&(this.lessonIndex=t-1,this.changeSession(this.lessonIndex,!1)),t==="index"&&(this.lessonIndex="index",this.changeSession("index",!1)),s&&qe.includes(s)&&(this.view=s)}getSessionSections(){return this.session?this.session:[]}switchViews(e=!0){this.view==="guide"?this.view="slideshow":this.view="guide",e===!0&&this.pushHistory()}openMenu(){const e=this.querySelector("#offCanvas");jQuery(e).foundation("open")}closeMenu(){const e=this.querySelector("#offCanvas");jQuery(e).foundation("close")}render(){this.showIndex;const e=this.type==="intensive"?"container-xsm":"container-sm";return r`
            ...
            <nav class="stack | bg-white px-0 text-center | presenter-menu off-canvas ${this.dir==="rtl"?"position-right":"position-left"} justify-content-between py-1" id="offCanvas" data-off-canvas data-transition="overlap">
                <div class="stack">
                    ...
                    <ul class="vertical menu accordion-menu" data-accordion-menu data-submenu-toggle="true" data-multi-open="false">
                        ${Object.values(this.menu).map(({title:t,submenu:s},n)=>r`
                            <li>
                                <a
                                    class="session-link"
                                ...
                                <ul class="menu vertical nested ${this.lessonIndex===n?"is-active":""}">
                                    ${s.map(({key:o,title:a,length:d})=>r`
                                            <a
                                                class="session-link"
                                                data-subitem
                                                href=${`#${o}`}
                                                @click=${()=>this.handleSubSectionLink(n,o)}
                                            >
            ...
            <div class="">
                ${this.view==="guide"?r`<course-guide .sections=${this.getSessionSections()}></course-guide>`:r`<course-slideshow .sections=${this.getSessionSections()} startSlideKey=${this.sessionKey}></course-slideshow>`}
            </div>
        `}createRenderRoot(){return this}}customElements.define("course-presenter",ks);class ws extends g{static get properties(){return{sections:{type:Array}}}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("course-guide",ws);class Ss extends g{static get properties(){return{sections:{type:Array},startSlideKey:{type:String},sectionIndex:{attribute:!1},currentSlide:{attribute:!1},index:{attribute:!1}}}constructor(){super(),this.reset(),this.sections=[],this.startSlideKey="",this.listenForKeyboard=this.listenForKeyboard.bind(this),this.listenForMouseClick=this.listenForMouseClick.bind(this)}reset(){this.sectionIndex=-1,this.currentSlide=null}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.listenForKeyboard),document.addEventListener("mousedown",this.listenForMouseClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.listenForKeyboard),document.removeEventListener("mousedown",this.listenForMouseClick)}update(e){if(e.has("sections")&&this.reset(),e.has("startSlideKey")&&this.startSlideKey!==""){const t=this.sections.findIndex(({key:s})=>s===this.startSlideKey);this.setSlide(t)}super.update(e)}nextSlide(){if(this.sectionIndex>=this.sections.length-1){this.sectionIndex=this.sections.length-1;return}this.setSlide(this.sectionIndex+1)}previousSlide(){this.sectionIndex<0&&(this.sectionIndex=0),this.setSlide(this.sectionIndex-1)}leftSlide(){document.querySelector("html").dir==="rtl"?this.nextSlide():this.previousSlide()}rightSlide(){document.querySelector("html").dir==="rtl"?this.previousSlide():this.nextSlide()}listenForKeyboard(e){["ArrowRight"].includes(e.code)&&this.rightSlide(),["Space"].includes(e.code)&&this.nextSlide(),["ArrowLeft"].includes(e.code)&&this.leftSlide(),["Backspace"].includes(e.code)&&this.previousSlide()}listenForMouseClick(e){if(e.target.id==="hamburger-menu")return;const t=l=>l.id==="offCanvas"||l.classList.contains("js-off-canvas-overlay")||l.classList.contains("bypass-nav-click");if(this.hasParent(e.target,t))return;const{x:s,type:n,which:o}=e;if(n!=="mousedown"||o!==1)return;const{innerWidth:a}=window,d=1/2*a;s<d&&this.leftSlide(),s>a-d&&this.rightSlide()}hasParent(e,t){let s=e;const n=50;let o=0;for(;s;){if(t(s))return!0;if(s=s.parentElement,o=o+1,o>n)return!1}return!1}setSlide(e){this.sectionIndex=e;const t=this.sections[e];this.currentSlide=t}render(){return this.sectionIndex<0&&this.setSlide(0),r`
            <div class="cover-page">
                <div>
                    <slide-switcher .slide=${this.currentSlide} showControls></slide-switcher>
                </div>
            </div>
        `}createRenderRoot(){return this}}customElements.define("course-slideshow",Ss);class js extends g{static get properties(){return{slide:{type:Object},showControls:{type:Boolean}}}render(){if(this.slide)switch(this.slide.type){case"title":return r`<title-slide .slide=${this.slide} id=${this.slide.key}></title-slide>`;case"checkin":return r`<checkin-slide .slide=${this.slide} id=${this.slide.key}></checkin-slide>`;case"pray":return r`<pray-slide .slide=${this.slide} id=${this.slide.key}></pray-slide>`;case"review":return r`<review-slide .slide=${this.slide} id=${this.slide.key}></review-slide>`;case"overview":return r`<overview-slide .slide=${this.slide} id=${this.slide.key}></overview-slide>`;case"challenge":case"center":return r`<center-slide .slide=${this.slide} id=${this.slide.key}></center-slide>`;case"watch":return r`<watch-slide .slide=${this.slide} id=${this.slide.key}></watch-slide>`;case"video":return r`<video-slide .slide=${this.slide} id=${this.slide.key} ?showButtons=${this.showControls}></video-slide>`;case"look_back":return r`<look-back-slide .slide=${this.slide} id=${this.slide.key}></look-back-slide>`;case"discuss":return r`<discuss-slide .slide=${this.slide} id=${this.slide.key}></discuss-slide>`;case"left_content":case"activity":return r`<activity-slide .slide=${this.slide} id=${this.slide.key}></activity-slide>`;case"obey":return r`<obey-slide .slide=${this.slide} id=${this.slide.key}></obey-slide>`;case"left_image":return r`<left-image-slide .slide=${this.slide} id=${this.slide.key}></left-image-slide>`;case"next_steps":return r`<next-steps-slide .slide=${this.slide} id=${this.slide.key}></next-steps-slide>`;case"break":return r`<break-slide .slide=${this.slide} id=${this.slide.key}></break-slide>`;case"congratulations":return r`<congratulations-slide .slide=${this.slide} id=${this.slide.key}></congratulations-slide>`;case"final":return r`<final-slide .slide=${this.slide} id=${this.slide.key}></final-slide>`;default:return r`<course-slide .slide=${this.slide} id=${this.slide.key}></course-slide>`}}createRenderRoot(){return this}}customElements.define("slide-switcher",js);class rt extends g{constructor(){super()}render(){return r`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",rt);class Cs extends g{constructor(){super();S(this,"webShareSupported",!!window.navigator.share);S(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(t){t.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return r`
        ...
        `}render(){return r`
            <div class="container-xsm">
                ...
                <div class="share-list__wrapper">
                    <ul class="stack  | mt-0">
                        ${z(this.items,t=>t.key,this.renderListItem)}
                    </ul>
                </div>
            </div>
        `}createRenderRoot(){return this}}customElements.define("share-list",xs);class Es extends g{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){makeRequest("POST","public_plans",{},"zume_system/v1").then(e=>{this.plans=e}).catch(e=>{console.log(e)}).always(()=>{this.loading=!1})}render(){return this.loading?r`<span class="loading-spinner active"></span>`:r`
            <table>
                <thead>
                    <tr>
                        <td>${this.t.name}</td>
        ...
        `}renderRow({join_key:e,language_note:t,post_title:s,time_of_day_note:n,timezone_note:o,...a}){const d=a.set_a_01?"a":"b",l=d==="a"?10:20,h=`set_${d}_`,b=Date.now()/1e3;let u="";for(let m=1;m<l+1;m++){const f=m<10?`0${m}`:`${m}`,y=a[h+f];if(u=y.timestamp,b<y.timestamp)break}const p=moment(u*1e3).format("MMM Do 'YY");return r`
            <tr>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",ot);class Os extends ot{static get properties(){return{percent:{type:Number},type:{type:String}}}constructor(){super(),this.radius=50,this.lineWidth=15,this.percent=0,this.borderWidth=3,this.type="heard"}width(){return(this.radius+this.lineWidth)*2}getIconSvg(){switch(this.type){case"heard":return K`
                ...
                `}}iconSize(){return this.width()/2}iconPosition(){const e=(this.width()-this.iconSize())/2;return[e,e]}render(){const e=this.iconSize(),[t,s]=this.iconPosition();return r`
            <div
                class="progress-circle"
        ...
        `}createRenderRoot(){return this}}customElements.define("host-progress-circle",Os);

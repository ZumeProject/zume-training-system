 ...
 */const De=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},P=at(class extends rt{constructor(i){if(super(i),i.type!==R.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],o=[];let a=0;for(const c of i)n[a]=s?s(c,a):a,o[a]=t(c,a),a++;return{values:o,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const o=xt(i),{values:a,keys:c}=this.dt(e,t,s);if(!Array.isArray(o))return this.ht=c,a;const l=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],h=[];let b,u,p=0,m=o.length-1,f=0,y=a.length-1;for(;p<=m&&f<=y;)if(o[p]===null)p++;else if(o[m]===null)m--;else if(l[p]===c[f])h[f]=M(o[p],a[f]),p++,f++;else if(l[m]===c[y])h[y]=M(o[m],a[y]),m--,y--;else if(l[p]===c[y])h[y]=M(o[p],a[y]),Z(i,h[y+1],o[p]),p++,y--;else if(l[m]===c[f])h[f]=M(o[m],a[f]),Z(i,o[p],o[m]),m--,f++;else if(b===void 0&&(b=De(c,f,y),u=De(l,p,m)),b.has(l[p]))if(b.has(l[m])){const x=u.get(c[f]),le=x!==void 0?o[x]:null;if(le===null){const Ce=Z(i,o[p]);M(Ce,a[f]),h[f]=Ce}else h[f]=M(le,a[f]),Z(i,o[p],le),o[x]=null;f++}else ve(o[m]),m--;else ve(o[p]),p++;for(;f<=y;){const x=Z(i,h[y+1]);M(x,a[f]),h[f++]=x}for(;p<=m;){const x=o[p++];x!==null&&ve(x)}return this.ht=c,ot(i,h),C}});class O extends g{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle()}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const o=Math.round(n.contentRect.height),a=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,o,a)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let o;s<window.innerWidth/2?o=this.initialOffset:o=this.initialOffset+t,n.style.top=o+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Ft extends O{static get properties(){return{showTeaser:{type:Boolean},loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.loading=!0,this.route=v.getRoute("3-month-plan"),this.filterName="3-month-plan-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){super.firstUpdated();const e=this.filterStatus||"";this.fetchCommitments(e)}updated(){jQuery(document).foundation()}fetchCommitments(){const e=this.filterStatus;makeRequest("GET","commitments",{status:e},"zume_system/v1").done(t=>{this.commitments=t}).always(()=>{this.loading=!1})}openCommitmentsModal(){if(this.showTeaser)return;const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(e){this.value=""})}addCommitments(){const e=[];return jQuery(".post-training-plan").each(function(t){const s=jQuery(this).val();if(s){const o=jQuery(this).prev().text();console.log("Question: "+o+" Answer: "+s);var n=new Date;n.setDate(n.getDate()+30),this.value="";const a=makeRequest("POST","commitment",{user_id:jsObject.profile.user_id,post_id:jsObject.profile.contact_id,meta_key:"tasks",note:"Question: "+o+" Answer: "+s,question:o,answer:s,date:n,category:"post_training_plan"},"zume_system/v1");e.push(a.promise())}}),console.log(e),Promise.all(e).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(s=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}filterCommitments(e){this.filterStatus=e,this.fetchCommitments(e),ZumeStorage.save(this.filterName,e),this.closeFilter()}closeFilter(){const e=this.querySelector("#filter-menu");jQuery(e).foundation("close")}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:s,id:n,status:o}=e;return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",Bt);class Wt extends O{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",Wt);const z=class extends g{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.hiddenCtaKeys=[],this.celebrationKeys=[],this.manageCtas=this.manageCtas.bind(this),this.transitionCelebrations=this.transitionCelebrations.bind(this),this.removeCelebrations=this.removeCelebrations.bind(this),this.renderCta=this.renderCta.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("ctas:changed",this.manageCtas)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ctas:changed",this.manageCtas)}firstUpdated(){this.manageCtas()}manageCtas(){const e=this.getCtas(),t=e.filter(({content_template:s})=>s==="celebration");t.length>0&&(this.ctas=e.slice(0,z.MAX_CTAS+t.length),this.hiddenCtaKeys=e.slice(z.MAX_CTAS).map(({key:s})=>s),t.forEach(({key:s})=>{this.celebrationKeys.push(s)}),this.timeout=setTimeout(this.transitionCelebrations,z.FADE_TIMEOUT)),this.allCtas=e}getCtas(){return jsObject.allCtas??[]}transitionCelebrations(){this.getCtaElements(this.celebrationKeys).forEach(s=>{s.style.height=s.clientHeight+"px",setTimeout(()=>{s.classList.add("transition-out"),s.style.height=""},10)}),this.getCtaElements(this.hiddenCtaKeys).forEach(s=>{s.classList.remove("hiding"),s.classList.add("showing")}),setTimeout(this.removeCelebrations,z.TRANSITION_TIMEOUT)}getCtaElements(e){return this.renderRoot.querySelectorAll(e.map(t=>`[data-key="${t}"]`).join(","))}removeCelebrations(){this.ctas=this.ctas.filter(({content_template:e})=>e!=="celebration")}renderCta({content:e,content_template:t,key:s}){const n=this.hiddenCtaKeys.includes(s)?"hiding":"showing";if(t==="card")return r`
                <div class="stack | card cta ${n}" data-key=${s} style="--duration: ${z.TRANSITION_TIMEOUT}ms">
                    <h2 class="h5 text-center">${e.title}</h2>
                    <p>${e.description}</p>
                    <a href="${e.link}" class="btn light uppercase">${e.link_text}</a>
                </div>
            `;if(t==="celebration")return r`
                <div class="stack | card celebration ${n}" data-key=${s} style="--duration: ${z.TRANSITION_TIMEOUT}ms">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",Zt);class Vt extends O{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",Xt);class es extends g{firstUpdated(){const e=this.offsetTop;this.style.top=e+"px"}render(){return r`
    ...
    `);window.customElements.define("play-button",lt);class xs extends g{constructor(){super();w(this,"webShareSupported",!!window.navigator.share);w(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(t){t.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",ct);class Ts extends ct{static get properties(){return{percent:{type:Number},type:{type:String}}}constructor(){super(),this.radius=50,this.lineWidth=15,this.percent=0,this.borderWidth=3,this.type="heard"}width(){return(this.radius+this.lineWidth)*2}getIconSvg(){switch(this.type){case"heard":return X`
        ...
        `}createRenderRoot(){return this}}customElements.define("host-progress-circle",Ts);

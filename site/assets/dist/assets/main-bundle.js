var Ee=Object.defineProperty;var Oe=(n,t,e)=>t in n?Ee(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var y=(n,t,e)=>(Oe(n,typeof t!="symbol"?t+"":t,e),e),$t=(n,t,e)=>{if(!t.has(n))throw TypeError("Cannot "+e)};var j=(n,t,e)=>($t(n,t,"read from private field"),e?e.call(n):t.get(n)),E=(n,t,e)=>{if(t.has(n))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(n):t.set(n,e)},P=(n,t,e,s)=>($t(n,t,"write to private field"),s?s.call(n,e):t.set(n,e),e);var O=(n,t,e)=>($t(n,t,"access private method"),e);var xt;let ze=(xt=class{static save(t,e){localStorage.setItem(this.createKey(t),JSON.stringify(e))}static load(t){const e=localStorage.getItem(this.createKey(t));try{return JSON.parse(e)}catch{return e}}static createKey(t){return this.prefix+t}},y(xt,"prefix","Z5_"),xt);window.ZumeStorage=ze;var x,ht,se,st,Et,ut,ie,it,Ot,pt,ne,nt,zt;class Pt{constructor(t){E(this,ht);E(this,st);E(this,ut);E(this,it);E(this,pt);E(this,nt);y(this,"WIZARD_STATE_NAME","zume_wizard_state");y(this,"STALE_LIFESPAN",10*60*1e3);y(this,"MAX_LIFESPAN",60*60*1e3);E(this,x,void 0);y(this,"moduleName");this.moduleName=t,P(this,x,O(this,ht,se).call(this))}isEmpty(){return Object.keys(j(this,x).data).length===0}isDataStale(){return O(this,nt,zt).call(this,j(this,x),this.STALE_LIFESPAN)}has(t){return Object.prototype.hasOwnProperty.call(j(this,x).data,t)}get(t){return j(this,x).data[t]}getAll(){return j(this,x).data}add(t,e){j(this,x).data[t]=e,O(this,it,Ot).call(this)}remove(t){delete j(this,x).data[t],O(this,it,Ot).call(this)}clear(){P(this,x,O(this,st,Et).call(this)),localStorage.removeItem(this.WIZARD_STATE_NAME)}}x=new WeakMap,ht=new WeakSet,se=function(){const t=O(this,ut,ie).call(this);return t&&!O(this,nt,zt).call(this,t,this.MAX_LIFESPAN)&&t.module===this.moduleName?t:O(this,st,Et).call(this)},st=new WeakSet,Et=function(){return{module:this.moduleName,data:{},timestamp:Date.now()}},ut=new WeakSet,ie=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},it=new WeakSet,Ot=function(){O(this,pt,ne).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(j(this,x)))},pt=new WeakSet,ne=function(){j(this,x).timestamp=Date.now()},nt=new WeakSet,zt=function(t,e){return Date.now()-t.timestamp>e};const _={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinATraining:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin",setProfile:"set-profile",joinCommunity:"join-the-community"},S={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision",joinCommunity:"joinCommunity"},Ae={planDecision:"plan-decision",howManySessions:"how-many-sessions",howOften:"how-often",startDate:"what-start-date",location:"what-location",review:"review-steps"},h={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",joinCommunity:"join-community",...Ae},Me={[h.updateName]:{field:"name",testExistance:(n,t)=>t.has_set_name},[h.updateLocation]:{field:"location",testExistance:n=>!(n.source&&n.source==="ip")},[h.updatePhone]:{field:"phone",testExistance:n=>!!n}},Pe={[_.gettingStarted]:{[S.completeProfile]:C([h.updateName,h.updateLocation],!1),[S.planDecision]:C([h.planDecision],!1)},[_.setProfile]:{[S.completeProfile]:C([h.updateName,h.updateLocation],!0)},[_.makeAGroup]:{[S.makePlan]:C([h.howManySessions,h.howOften,h.startDate,h.location,h.review,h.inviteFriends],!0)},[_.getACoach]:{[S.completeProfile]:C([h.updateName,h.updateLocation,h.updatePhone]),[S.getACoach]:C([h.contactPreferences,h.languagePreferences,h.howCanWeServe,h.connectingToCoach])},[_.joinATraining]:{[S.completeProfile]:C([h.updateName,h.updateLocation,h.updatePhone]),[S.joinTraining]:C([h.joinTraining],!0)},[_.connectWithFriend]:{[S.completeProfile]:C([h.updateName,h.updateLocation],!0),[S.connectFriend]:C([h.connectToFriend])},[_.joinFriendsPlan]:{[S.completeProfile]:C([h.updateName,h.updateLocation],!0),[S.joinFriendsTraining]:C([h.joinFriendsPlan])},[_.joinCommunity]:{[S.joinCommunity]:C([h.joinCommunity],!0)},[_.checkin]:{[S.checkin]:C([h.checkinSubmit])}};function C(n=[],t=!1){const e={steps:[],skippable:t};return n.forEach(s=>{Object.values(h).includes(s)&&e.steps.push(s)}),e}var R,N,mt,ae,gt,re,vt,oe;class Te{constructor(t){E(this,mt);E(this,gt);E(this,vt);E(this,R,void 0);E(this,N,void 0);y(this,"profile");P(this,R,{}),P(this,N,[]),this.profile=t}reset(){P(this,R,{})}isTypeValid(t){return!!Object.values(_).includes(t)}isLoaded(){return Object.keys(j(this,R)).length!==0}getSteps(t){return O(this,gt,re).call(this,t),j(this,N)}}R=new WeakMap,N=new WeakMap,mt=new WeakSet,ae=function(t){return this.isTypeValid(t)?Pe[t]:{}},gt=new WeakSet,re=function(t){const e=O(this,mt,ae).call(this,t);Object.keys(e).length!==0&&O(this,vt,oe).call(this,e)},vt=new WeakSet,oe=function(t){P(this,R,t),P(this,N,[]),Object.entries(j(this,R)).forEach(([e,{steps:s,skippable:i}])=>{s.forEach(a=>{const r=Me[a];let l=null;if(r&&this.profile){if(r.testExistance(this.profile[r.field],this.profile))return;l=this.profile[r.field]}const c={slug:a,module:e,skippable:i};l!==null&&(c.value=l),j(this,N).push(c)})})};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ot=window,Tt=ot.ShadowRoot&&(ot.ShadyCSS===void 0||ot.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Rt=Symbol(),Ut=new WeakMap;let le=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Rt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Tt&&t===void 0){const s=e!==void 0&&e.length===1;s&&(t=Ut.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&Ut.set(e,t))}return t}toString(){return this.cssText}};const Re=n=>new le(typeof n=="string"?n:n+"",void 0,Rt),ce=(n,...t)=>{const e=n.length===1?n[0]:t.reduce((s,i,a)=>s+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[a+1],n[0]);return new le(e,n,Rt)},Ie=(n,t)=>{Tt?n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):t.forEach(e=>{const s=document.createElement("style"),i=ot.litNonce;i!==void 0&&s.setAttribute("nonce",i),s.textContent=e.cssText,n.appendChild(s)})},Dt=Tt?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return Re(e)})(n):n;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var yt;const lt=window,Nt=lt.trustedTypes,Le=Nt?Nt.emptyScript:"",Ht=lt.reactiveElementPolyfillSupport,At={toAttribute(n,t){switch(t){case Boolean:n=n?Le:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,t){let e=n;switch(t){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},de=(n,t)=>t!==n&&(t==t||n==n),_t={attribute:!0,type:String,converter:At,reflect:!1,hasChanged:de};let B=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(t){var e;this.finalize(),((e=this.h)!==null&&e!==void 0?e:this.h=[]).push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach((e,s)=>{const i=this._$Ep(s,e);i!==void 0&&(this._$Ev.set(i,s),t.push(i))}),t}static createProperty(t,e=_t){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const s=typeof t=="symbol"?Symbol():"__"+t,i=this.getPropertyDescriptor(t,s,e);i!==void 0&&Object.defineProperty(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){return{get(){return this[e]},set(i){const a=this[t];this[e]=i,this.requestUpdate(t,a,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||_t}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),t.h!==void 0&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const e=this.properties,s=[...Object.getOwnPropertyNames(e),...Object.getOwnPropertySymbols(e)];for(const i of s)this.createProperty(i,e[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const i of s)e.unshift(Dt(i))}else t!==void 0&&e.push(Dt(t));return e}static _$Ep(t,e){const s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}u(){var t;this._$E_=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(t=this.constructor.h)===null||t===void 0||t.forEach(e=>e(this))}addController(t){var e,s;((e=this._$ES)!==null&&e!==void 0?e:this._$ES=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((s=t.hostConnected)===null||s===void 0||s.call(t))}removeController(t){var e;(e=this._$ES)===null||e===void 0||e.splice(this._$ES.indexOf(t)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((t,e)=>{this.hasOwnProperty(e)&&(this._$Ei.set(e,this[e]),delete this[e])})}createRenderRoot(){var t;const e=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return Ie(e,this.constructor.elementStyles),e}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$ES)===null||t===void 0||t.forEach(e=>{var s;return(s=e.hostConnected)===null||s===void 0?void 0:s.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$ES)===null||t===void 0||t.forEach(e=>{var s;return(s=e.hostDisconnected)===null||s===void 0?void 0:s.call(e)})}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$EO(t,e,s=_t){var i;const a=this.constructor._$Ep(t,s);if(a!==void 0&&s.reflect===!0){const r=(((i=s.converter)===null||i===void 0?void 0:i.toAttribute)!==void 0?s.converter:At).toAttribute(e,s.type);this._$El=t,r==null?this.removeAttribute(a):this.setAttribute(a,r),this._$El=null}}_$AK(t,e){var s;const i=this.constructor,a=i._$Ev.get(t);if(a!==void 0&&this._$El!==a){const r=i.getPropertyOptions(a),l=typeof r.converter=="function"?{fromAttribute:r.converter}:((s=r.converter)===null||s===void 0?void 0:s.fromAttribute)!==void 0?r.converter:At;this._$El=a,this[a]=l.fromAttribute(e,r.type),this._$El=null}}requestUpdate(t,e,s){let i=!0;t!==void 0&&(((s=s||this.constructor.getPropertyOptions(t)).hasChanged||de)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),s.reflect===!0&&this._$El!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,s))):i=!1),!this.isUpdatePending&&i&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((i,a)=>this[a]=i),this._$Ei=void 0);let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),(t=this._$ES)===null||t===void 0||t.forEach(i=>{var a;return(a=i.hostUpdate)===null||a===void 0?void 0:a.call(i)}),this.update(s)):this._$Ek()}catch(i){throw e=!1,this._$Ek(),i}e&&this._$AE(s)}willUpdate(t){}_$AE(t){var e;(e=this._$ES)===null||e===void 0||e.forEach(s=>{var i;return(i=s.hostUpdated)===null||i===void 0?void 0:i.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((e,s)=>this._$EO(s,this[s],e)),this._$EC=void 0),this._$Ek()}updated(t){}firstUpdated(t){}};B.finalized=!0,B.elementProperties=new Map,B.elementStyles=[],B.shadowRootOptions={mode:"open"},Ht==null||Ht({ReactiveElement:B}),((yt=lt.reactiveElementVersions)!==null&&yt!==void 0?yt:lt.reactiveElementVersions=[]).push("1.6.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var wt;const ct=window,Q=ct.trustedTypes,Ft=Q?Q.createPolicy("lit-html",{createHTML:n=>n}):void 0,dt="$lit$",M=`lit$${(Math.random()+"").slice(9)}$`,It="?"+M,qe=`<${It}>`,Z=document,X=()=>Z.createComment(""),tt=n=>n===null||typeof n!="object"&&typeof n!="function",he=Array.isArray,ue=n=>he(n)||typeof(n==null?void 0:n[Symbol.iterator])=="function",kt=`[ 	
\f\r]`,J=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Bt=/-->/g,Wt=/>/g,L=RegExp(`>|${kt}(?:([^\\s"'>=/]+)(${kt}*=${kt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Kt=/'/g,Qt=/"/g,pe=/^(?:script|style|textarea|title)$/i,me=n=>(t,...e)=>({_$litType$:n,strings:t,values:e}),o=me(1),rt=me(2),z=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),Zt=new WeakMap,K=Z.createTreeWalker(Z,129,null,!1),ge=(n,t)=>{const e=n.length-1,s=[];let i,a=t===2?"<svg>":"",r=J;for(let c=0;c<e;c++){const d=n[c];let m,u,p=-1,g=0;for(;g<d.length&&(r.lastIndex=g,u=r.exec(d),u!==null);)g=r.lastIndex,r===J?u[1]==="!--"?r=Bt:u[1]!==void 0?r=Wt:u[2]!==void 0?(pe.test(u[2])&&(i=RegExp("</"+u[2],"g")),r=L):u[3]!==void 0&&(r=L):r===L?u[0]===">"?(r=i??J,p=-1):u[1]===void 0?p=-2:(p=r.lastIndex-u[2].length,m=u[1],r=u[3]===void 0?L:u[3]==='"'?Qt:Kt):r===Qt||r===Kt?r=L:r===Bt||r===Wt?r=J:(r=L,i=void 0);const f=r===L&&n[c+1].startsWith("/>")?" ":"";a+=r===J?d+qe:p>=0?(s.push(m),d.slice(0,p)+dt+d.slice(p)+M+f):d+M+(p===-2?(s.push(void 0),c):f)}const l=a+(n[e]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Ft!==void 0?Ft.createHTML(l):l,s]};class et{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let a=0,r=0;const l=t.length-1,c=this.parts,[d,m]=ge(t,e);if(this.el=et.createElement(d,s),K.currentNode=this.el.content,e===2){const u=this.el.content,p=u.firstChild;p.remove(),u.append(...p.childNodes)}for(;(i=K.nextNode())!==null&&c.length<l;){if(i.nodeType===1){if(i.hasAttributes()){const u=[];for(const p of i.getAttributeNames())if(p.endsWith(dt)||p.startsWith(M)){const g=m[r++];if(u.push(p),g!==void 0){const f=i.getAttribute(g.toLowerCase()+dt).split(M),$=/([.?@])?(.*)/.exec(g);c.push({type:1,index:a,name:$[2],strings:f,ctor:$[1]==="."?be:$[1]==="?"?fe:$[1]==="@"?$e:at})}else c.push({type:6,index:a})}for(const p of u)i.removeAttribute(p)}if(pe.test(i.tagName)){const u=i.textContent.split(M),p=u.length-1;if(p>0){i.textContent=Q?Q.emptyScript:"";for(let g=0;g<p;g++)i.append(u[g],X()),K.nextNode(),c.push({type:2,index:++a});i.append(u[p],X())}}}else if(i.nodeType===8)if(i.data===It)c.push({type:2,index:a});else{let u=-1;for(;(u=i.data.indexOf(M,u+1))!==-1;)c.push({type:7,index:a}),u+=M.length-1}a++}}static createElement(t,e){const s=Z.createElement("template");return s.innerHTML=t,s}}function H(n,t,e=n,s){var i,a,r,l;if(t===z)return t;let c=s!==void 0?(i=e._$Co)===null||i===void 0?void 0:i[s]:e._$Cl;const d=tt(t)?void 0:t._$litDirective$;return(c==null?void 0:c.constructor)!==d&&((a=c==null?void 0:c._$AO)===null||a===void 0||a.call(c,!1),d===void 0?c=void 0:(c=new d(n),c._$AT(n,e,s)),s!==void 0?((r=(l=e)._$Co)!==null&&r!==void 0?r:l._$Co=[])[s]=c:e._$Cl=c),c!==void 0&&(t=H(n,c._$AS(n,t.values),c,s)),t}class ve{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:s},parts:i}=this._$AD,a=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:Z).importNode(s,!0);K.currentNode=a;let r=K.nextNode(),l=0,c=0,d=i[0];for(;d!==void 0;){if(l===d.index){let m;d.type===2?m=new V(r,r.nextSibling,this,t):d.type===1?m=new d.ctor(r,d.name,d.strings,this,t):d.type===6&&(m=new ye(r,this,t)),this._$AV.push(m),d=i[++c]}l!==(d==null?void 0:d.index)&&(r=K.nextNode(),l++)}return a}v(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class V{constructor(t,e,s,i){var a;this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cp=(a=i==null?void 0:i.isConnected)===null||a===void 0||a}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=H(this,t,e),tt(t)?t===w||t==null||t===""?(this._$AH!==w&&this._$AR(),this._$AH=w):t!==this._$AH&&t!==z&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):ue(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==w&&tt(this._$AH)?this._$AA.nextSibling.data=t:this.$(Z.createTextNode(t)),this._$AH=t}g(t){var e;const{values:s,_$litType$:i}=t,a=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=et.createElement(i.h,this.options)),i);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===a)this._$AH.v(s);else{const r=new ve(a,this),l=r.u(this.options);r.v(s),this.$(l),this._$AH=r}}_$AC(t){let e=Zt.get(t.strings);return e===void 0&&Zt.set(t.strings,e=new et(t)),e}T(t){he(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const a of t)i===e.length?e.push(s=new V(this.k(X()),this.k(X()),this,this.options)):s=e[i],s._$AI(a),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class at{constructor(t,e,s,i,a){this.type=1,this._$AH=w,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=w}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,i){const a=this.strings;let r=!1;if(a===void 0)t=H(this,t,e,0),r=!tt(t)||t!==this._$AH&&t!==z,r&&(this._$AH=t);else{const l=t;let c,d;for(t=a[0],c=0;c<a.length-1;c++)d=H(this,l[s+c],e,c),d===z&&(d=this._$AH[c]),r||(r=!tt(d)||d!==this._$AH[c]),d===w?t=w:t!==w&&(t+=(d??"")+a[c+1]),this._$AH[c]=d}r&&!i&&this.j(t)}j(t){t===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class be extends at{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===w?void 0:t}}const Ue=Q?Q.emptyScript:"";class fe extends at{constructor(){super(...arguments),this.type=4}j(t){t&&t!==w?this.element.setAttribute(this.name,Ue):this.element.removeAttribute(this.name)}}class $e extends at{constructor(t,e,s,i,a){super(t,e,s,i,a),this.type=5}_$AI(t,e=this){var s;if((t=(s=H(this,t,e,0))!==null&&s!==void 0?s:w)===z)return;const i=this._$AH,a=t===w&&i!==w||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,r=t!==w&&(i===w||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;typeof this._$AH=="function"?this._$AH.call((s=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}}class ye{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}}const De={O:dt,P:M,A:It,C:1,M:ge,L:ve,D:ue,R:H,I:V,V:at,H:fe,N:$e,U:be,F:ye},Vt=ct.litHtmlPolyfillSupport;Vt==null||Vt(et,V),((wt=ct.litHtmlVersions)!==null&&wt!==void 0?wt:ct.litHtmlVersions=[]).push("2.7.3");const Ne=(n,t,e)=>{var s,i;const a=(s=e==null?void 0:e.renderBefore)!==null&&s!==void 0?s:t;let r=a._$litPart$;if(r===void 0){const l=(i=e==null?void 0:e.renderBefore)!==null&&i!==void 0?i:null;a._$litPart$=r=new V(t.insertBefore(X(),l),l,void 0,e??{})}return r._$AI(n),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var St,jt;let v=class extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ne(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return z}};v.finalized=!0,v._$litElement$=!0,(St=globalThis.litElementHydrateSupport)===null||St===void 0||St.call(globalThis,{LitElement:v});const Jt=globalThis.litElementPolyfillSupport;Jt==null||Jt({LitElement:v});((jt=globalThis.litElementVersions)!==null&&jt!==void 0?jt:globalThis.litElementVersions=[]).push("3.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const U={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},_e=n=>(...t)=>({_$litDirective$:n,values:t});let we=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:He}=De,Fe=n=>n.strings===void 0,Gt=()=>document.createComment(""),G=(n,t,e)=>{var s;const i=n._$AA.parentNode,a=t===void 0?n._$AB:t._$AA;if(e===void 0){const r=i.insertBefore(Gt(),a),l=i.insertBefore(Gt(),a);e=new He(r,l,n,n.options)}else{const r=e._$AB.nextSibling,l=e._$AM,c=l!==n;if(c){let d;(s=e._$AQ)===null||s===void 0||s.call(e,n),e._$AM=n,e._$AP!==void 0&&(d=n._$AU)!==l._$AU&&e._$AP(d)}if(r!==a||c){let d=e._$AA;for(;d!==r;){const m=d.nextSibling;i.insertBefore(d,a),d=m}}}return e},q=(n,t,e=n)=>(n._$AI(t,e),n),Be={},ke=(n,t=Be)=>n._$AH=t,We=n=>n._$AH,Ct=n=>{var t;(t=n._$AP)===null||t===void 0||t.call(n,!1,!0);let e=n._$AA;const s=n._$AB.nextSibling;for(;e!==s;){const i=e.nextSibling;e.remove(),e=i}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ke=_e(class extends we{constructor(n){if(super(n),n.type!==U.PROPERTY&&n.type!==U.ATTRIBUTE&&n.type!==U.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Fe(n))throw Error("`live` bindings can only contain a single expression")}render(n){return n}update(n,[t]){if(t===z||t===w)return t;const e=n.element,s=n.name;if(n.type===U.PROPERTY){if(t===e[s])return z}else if(n.type===U.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(s))return z}else if(n.type===U.ATTRIBUTE&&e.getAttribute(s)===t+"")return z;return ke(n),t}});class Qe extends v{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1},isInfoOpen:{type:Boolean,attribute:!1},infoText:{type:String,attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this.isInfoOpen=!1,this.infoText="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,jsObject.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}updated(t){t.has("variant")&&(this.renderRoot.querySelector(".inputs input").focus(),this.isInfoOpen=!1)}willUpdate(t){t.has("value")&&this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var t;return o`
                ...
                <div class="form-group stack--4">
                    <div class="d-flex align-items-center">
                        ...
                        <input
                            ...
                            .value="${this.city?Ke(this.city):(t=this.localValue)==null?void 0:t.label}"
        ...
        `}createRenderRoot(){return this}}window.customElements.define("invite-friends",Ve);class Je extends v{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},code:{attribute:!1},message:{attribute:!1},errorMessage:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.code="",this.errorMessage="",this.showTrainings=!1,this.loading=!1}firstUpdated(){const t=new URL(location.href);if(!t.searchParams.has("code")){this.message="",this.loading=!1,this.showTrainings=!0;return}const e=t.searchParams.get("code");this.connectToPlan(e)}connectToPlan(t){this.loading=!0,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}})),this.message=this.t.please_wait,this.code=t,makeRequest("POST","connect/public-plan",{code:t},"zume_system/v1").then(e=>{console.log(e),this.message=this.t.success.replace("%s",e.name),this._sendDoneStepEvent()}).fail(({responseJSON:e})=>{console.log(e),this.message="",e.code==="bad_plan_code"?this.setErrorMessage(this.t.broken_link):this.setErrorMessage(this.t.error),this._sendDoneStepEvent()}).always(()=>{this.loading=!1,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}}))})}_sendDoneStepEvent(){setTimeout(()=>{const t=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(t)},2e3)}setErrorMessage(t){this.errorMessage=t,setTimeout(()=>{this.errorMessage=""},3e3)}_handleChosenTraining(t){console.log(t);const{code:e}=t.detail;this.showTrainings=!1,this.connectToPlan(e)}render(){return o`
            ...
            <span class="loading-spinner ${this.loading?"active":""}"></span>
            <div class="warning banner" data-state=${this.errorMessage.length?"":"empty"}>${this.errorMessage}</div>
        `}createRenderRoot(){return this}}customElements.define("join-training",Je);class Ge extends v{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object}}}render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("review-steps",es);class ss extends v{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},code:{attribute:!1},message:{attribute:!1},errorMessage:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.code="",this.errorMessage="",this.loading=!1}firstUpdated(){this.loading=!0,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}})),this.message=this.t.please_wait;const t=new URL(location.href);if(!t.searchParams.has("code")){this.message="",this.setErrorMessage(this.t.broken_link),this._sendDoneStepEvent(),this.loading=!1,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}}));return}const e=t.searchParams.get("code");this.code=e,makeRequest("POST","checkin",{code:e},"zume_system/v1").then(s=>{this.message=this.t.success.replace("%s",s.name),this._sendDoneStepEvent()}).fail(({responseJSON:s})=>{console.log(s),this.message="",s.code==="bad_checkin_code"?this.setErrorMessage(this.t.broken_link):this.setErrorMessage(this.t.error),this._sendDoneStepEvent()}).always(()=>{this.loading=!1,this.dispatchEvent(new CustomEvent("loadingChange",{bubbles:!0,detail:{loading:this.loading}}))})}_sendDoneStepEvent(){setTimeout(()=>{const t=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(t)},2e3)}setErrorMessage(t){console.log(t),this.errorMessage=t,setTimeout(()=>{this.errorMessage=""},3e3)}render(){return o`
            <h1>${this.t.title}</h1>
            <p>${this.message}</p>
            <span class="loading-spinner ${this.loading?"active":""}"></span>
            <div class="warning banner" data-state=${this.errorMessage.length?"":"empty"}>${this.errorMessage}</div>
        `}createRenderRoot(){return this}}customElements.define("session-checkin",ss);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Se=Symbol.for(""),is=n=>{if((n==null?void 0:n.r)===Se)return n==null?void 0:n._$litStatic$},T=(n,...t)=>({_$litStatic$:t.reduce((e,s,i)=>e+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+n[i+1],n[0]),r:Se}),Yt=new Map,ns=n=>(t,...e)=>{const s=e.length;let i,a;const r=[],l=[];let c,d=0,m=!1;for(;d<s;){for(c=t[d];d<s&&(a=e[d],(i=is(a))!==void 0);)c+=i+t[++d],m=!0;d!==s&&l.push(a),r.push(c),d++}if(d===s&&r.push(t[s]),m){const u=r.join("$$lit$$");(t=Yt.get(u))===void 0&&(r.raw=r,Yt.set(u,t=r)),e=l}return n(t,...e)},as=ns(o);class rs extends v{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},translations:{type:Object},noUrlChange:{type:Boolean},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),this._handlePlanDecision=this._handlePlanDecision.bind(this),this._handleGotoStep=this._handleGotoStep.bind(this),this.stateManager=new Pt}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._handleHistoryPopState),window.addEventListener("plan-decision",this._handlePlanDecision),window.addEventListener("wizard:goto-step",this._handleGotoStep)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState),window.removeEventListener("plan-decision",this._handlePlanDecision),window.removeEventListener("wizard:goto-step",this._handleGotoStep)}firstUpdated(){this.loadWizard(),this._handleHistoryPopState(!0),this.translations&&(this.t=window.SHAREDFUNCTIONS.escapeObject(this.translations))}willUpdate(t){t.has("type")&&this.type===""&&this.wizard&&this.wizard.reset(),t.has("type")&&this.type!==""&&this.loadWizard()}loadWizard(){this.wizard=new Te(this.user),this.steps=this.wizard.getSteps(this.type),this._gotoStep(0)}render(){if(!this.wizard.isTypeValid(this.type))return o`
            ...
            `;if(!(!this.wizard||!this.wizard.isLoaded()))return this.steps.length===0?o`
                <div class="cover-page">
                    <div class="stack center | text-center">
        ...
        `}containerSize(){return{...this.steps[this.stepIndex]},h.joinTraining?"container-md":"container-xsm"}currentStep(){const t={...this.steps[this.stepIndex]};let e="",s="";switch(t.slug){case h.updateName:case h.updateLocation:case h.updatePhone:e=T`complete-profile`,s=this.t.complete_profile;break;case h.contactPreferences:case h.languagePreferences:case h.howCanWeServe:case h.connectingToCoach:e=T`request-coach`,s=this.t.get_a_coach;break;case h.inviteFriends:e=T`invite-friends`,s=this.t.share;break;case h.joinTraining:e=T`join-training`,s=this.t.join_training;break;case h.joinFriendsPlan:e=T`join-friend-training`,s=this.t.join_training;break;case h.connectToFriend:e=T`connect-friend`,s=this.t.connect_friend;break;case h.checkinSubmit:e=T`session-checkin`,s=this.t.checkin;break;case h.planDecision:case h.howManySessions:case h.howOften:case h.startDate:case h.location:case h.review:e=T`make-training`,s=this.t.make_training;break}return as`
            <${e}
                class="w-100"
                name=${t.slug}
                module=${t.module}
 ...
 */const te=(n,t,e)=>{const s=new Map;for(let i=t;i<=e;i++)s.set(n[i],i);return s},F=_e(class extends we{constructor(n){if(super(n),n.type!==U.CHILD)throw Error("repeat() can only be used in text expressions")}dt(n,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);const i=[],a=[];let r=0;for(const l of n)i[r]=s?s(l,r):r,a[r]=e(l,r),r++;return{values:a,keys:i}}render(n,t,e){return this.dt(n,t,e).values}update(n,[t,e,s]){var i;const a=We(n),{values:r,keys:l}=this.dt(t,e,s);if(!Array.isArray(a))return this.ht=l,r;const c=(i=this.ht)!==null&&i!==void 0?i:this.ht=[],d=[];let m,u,p=0,g=a.length-1,f=0,$=r.length-1;for(;p<=g&&f<=$;)if(a[p]===null)p++;else if(a[g]===null)g--;else if(c[p]===l[f])d[f]=q(a[p],r[f]),p++,f++;else if(c[g]===l[$])d[$]=q(a[g],r[$]),g--,$--;else if(c[p]===l[$])d[$]=q(a[p],r[$]),G(n,d[$+1],a[p]),p++,$--;else if(c[g]===l[f])d[f]=q(a[g],r[f]),G(n,a[p],a[g]),g--,f++;else if(m===void 0&&(m=te(l,f,$),u=te(c,p,g)),m.has(c[p]))if(m.has(c[g])){const A=u.get(l[f]),ft=A!==void 0?a[A]:null;if(ft===null){const qt=G(n,a[p]);q(qt,r[f]),d[f]=qt}else d[f]=q(ft,r[f]),G(n,a[p],ft),a[A]=null;f++}else Ct(a[g]),g--;else Ct(a[p]),p++;for(;f<=$;){const A=G(n,d[$+1]);q(A,r[f]),d[f++]=A}for(;p<=g;){const A=a[p++];A!==null&&Ct(A)}return this.ht=l,ke(n,d),z}});class I extends v{constructor(){super();const e=document.querySelector("html").dataset.dir;this.isRtl=e==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle(),window.scrollTo({top:0,behavior:"instant"})}attachResizeObeserver(){const t=document.querySelector("dash-header-right"),e=new ResizeObserver(s=>{for(let i of s){if(!i.contentRect)return;const a=Math.round(i.contentRect.height),r=Math.round(i.contentRect.width);this.updateHeaderStyle(!1,a,r)}});this.resizeObserver=e,e.observe(t)}updateHeaderStyle(t=!0,e=0,s=window.innerWidth){const i=document.querySelector(".dashboard__header.left");t&&(this.initialOffset=i.offsetTop);let a;s<window.innerWidth/2?a=this.initialOffset:a=this.initialOffset+e,i.style.top=a+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class us extends I{static get properties(){return{showTeaser:{type:Boolean},churches:{type:Array,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.route=b.getRoute("my-churches"),this.churches=[],this.renderChurch=this.renderChurch.bind(this),this.addChurch=this.addChurch.bind(this),this.handleSubmit=this.handleSubmit.bind(this)}firstUpdated(){super.firstUpdated(),document.querySelector("#add-church-form").addEventListener("submit",this.handleSubmit)}updated(){jQuery(document).foundation()}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(t=>{const e=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(e)})}handleSubmit(t){t.preventDefault(),this.addChurch()}addChurch(){const t=this.churches.length+1,e=[{id:t,name:"This is a new church",location:"Birmingham, UK",depth:0},{id:`${t}-1`,name:"Tea Shop 1",location:"Birmingham, UK",parent:t,depth:1},{id:`${t}-2`,name:"Tea Shop 2",location:"Birmingham, UK",parent:t,depth:1},{id:`${t}-2-1`,name:"Tea Shop 2 child",location:"Birmingham, UK",parent:`${t}-2`,depth:2},{id:`${t}-3`,name:"Breakfast Shop",location:"Birmingham, UK",parent:t,depth:1}];this.churches=[...this.churches,...e],this.closeChurchModal()}editChurch(t){console.log("edit church",t)}deleteChurch(t){console.log("delete church",t)}openChurchModal(){if(this.showTeaser)return;const t=document.querySelector("#new-church-form");jQuery(t).foundation("open")}closeChurchModal(){const t=document.querySelector("#new-church-form");jQuery(t).foundation("close"),this.clearChurchModal()}clearChurchModal(){jQuery("#add-church-form input").each(function(t){this.value=""})}renderChurch({id:t,name:e,location:s,depth:i}){return o`
                        ...
                        `:o`
                            <ul class="list">
                                ${this.churches.length===0?o`
                                    ...
                                    `:F(this.churches,t=>`${t.id}`,this.renderChurch)}
                            </ul>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",us);class ps extends I{render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",ps);const D=class extends v{static get properties(){return{ctas:{type:Array,attribute:!1}}}constructor(){super(),this.allCtas=[],this.ctas=[],this.celebrations=[],this.hiddenCtaKeys=[],this.initialCtaKeys=[],this.removedCtaKeys=[],this.manageCtas=this.manageCtas.bind(this),this.transitionIn=this.transitionIn.bind(this),this.transitionCtas=this.transitionCtas.bind(this),this.renderCta=this.renderCta.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("ctas:changed",this.manageCtas),this.addEventListener("begin-cta-transitions",this.transitionIn),this.addEventListener("cta-transition-in-ended",this.logCelebrationsSeen)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ctas:changed",this.manageCtas),this.removeEventListener("begin-cta-transitions",this.transitionIn),this.removeEventListener("cta-transition-in-ended",this.logCelebrationsSeen)}firstUpdated(){this.manageCtas()}updated(){this.dispatchEventAfterUpdated&&(this.dispatchEventAfterUpdated=!1,setTimeout(()=>{this.dispatchEvent(new CustomEvent("begin-cta-transitions"))},10))}manageCtas(){const t=this.getCtas(),[e,s,i]=this.diffCtas(t,this.ctas),a=[...e,...s].filter(({content_template:m})=>m==="celebration"),r=[...e,...s].filter(({content_template:m})=>m!=="celebration"),l=[...a,...r],c=this.getCtaKeys(l),d=this.getCtaKeys(i);this.ctas=l,this.celebrations=a,this.hiddenCtaKeys=this.getCtaKeys(e),this.removedCtaKeys=[...d,...c.slice(D.MAX_CTAS)],this.initialCtaKeys=c.slice(0,D.MAX_CTAS),this.ctas.length>1&&(this.dispatchEventAfterUpdated=!0)}getCtas(){return jsObject.allCtas??[]}diffCtas(t,e){const s=t.filter(({key:r})=>e.findIndex(({key:l})=>l===r)===-1),i=e.filter(({key:r})=>t.findIndex(({key:l})=>l===r)===-1),a=e.filter(({key:r})=>t.findIndex(({key:l})=>l===r)>-1);return[s,a,i]}transitionIn(){this.transitionCtas(this.removedCtaKeys,this.initialCtaKeys),setTimeout(()=>{this.dispatchEvent(new CustomEvent("cta-transition-in-ended"))},D.TRANSITION_TIMEOUT)}logCelebrationsSeen(){this.celebrations.forEach(({type:e,subtype:s})=>{makeRequest("POST","log",{type:e,subtype:s},"zume_system/v1")});const t=this.getCtaKeys(this.celebrations);jsObject.allCtas=jsObject.allCtas.filter(({key:e})=>!t.includes(e))}transitionCtas(t,e){(t.length>0?this.getCtaElements(t):[]).forEach(a=>{a&&(a.style.height=a.clientHeight+"px",setTimeout(()=>{a.classList.add("transition-out"),a.style.height=""},10))}),(e.length>0?this.getCtaElements(e):[]).forEach(a=>{a&&(a.classList.remove("hiding"),a.classList.add("showing"))})}getCtaElements(t){return this.renderRoot.querySelectorAll(t.map(e=>`[data-key="${e}"]`).join(","))}getCtaKeys(t){return t.map(({key:e})=>e)}isWizardLink(t){return t.includes("/wizard/")}openWizard(t){const e=t.split("/"),s=e[e.length-1];dispatchEvent(new CustomEvent("open-wizard",{bubbles:!0,detail:{type:s}}))}renderCta({content:t,content_template:e,key:s}){const i=this.hiddenCtaKeys.includes(s)?"hiding":"showing";if(e==="card")return o`
            ...
            `;if(e==="celebration")return o`
                <div class="stack | card celebration ${i}" data-key=${s} style="--duration: ${D.TRANSITION_TIMEOUT}ms">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-top-level",bt);class ms extends bt{constructor(){super("getting-started")}createRenderRoot(){return this}}customElements.define("dash-getting-started",ms);class gs extends I{static get properties(){return{showTeaser:{type:Boolean}}}constructor(){super(),this.showTeaser=!1}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(t=>{const e=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(e)})}render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",gs);class vs extends I{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}render(){var t,e,s,i,a,r,l,c;return o`
            <div class="dashboard__content">
                ...
                <div class="dashboard__main">
                    ${o`
                            <ul class="list">
                                ${F(this.filteredItems,d=>d.key,this.renderListItem)}
                            </ul>
                        `}
                </div>
                <div class="dashboard__secondary">
            ...
            <div class="dashboard__content">
                ...
                <div class="dashboard__main p-2">
                    ${this.showTeaser?o`
                        ...
                        `:o`
                            <ul class="list">
                                ${!this.loading&&this.sessions&&this.sessions.length>0?F(this.sessions,t=>t.id,this.renderListItem):""}
                            </ul>
                        `}
                </div>
                    ...
                    <div class="card | group-members | grow-0">
                        ...
                        <div class="collapse" data-state="open">
                            ...
                            ${!this.loading&&this.groupMembers&&this.groupMembers.length>0?o`
                                    <ol class="ps-1">
                                        ${F(this.groupMembers,t=>t.id,this.renderMemberItem)}
                                    </ol>
                                `:""}
                        </div>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",_s);class ws extends v{firstUpdated(){const t=this.offsetTop;this.style.top=t+"px"}render(){return o`
            <div class="dashboard__header right">
                <dash-sidebar-toggle displayOn="medium"></dash-sidebar-toggle>
                <launch-course></launch-course>
            </div>
        `}createRenderRoot(){return this}}customElements.define("dash-header-right",ws);class ks extends v{static get properties(){return{displayOn:{type:String}}}constructor(){super(),this.displayOn="large"}toggleSidebar(){const t=new CustomEvent("toggle-dashboard-sidebar",{bubbles:!0});this.dispatchEvent(t)}render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",ks);class Lt extends je(v){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1}handleClick(t){this.disableNavigate||(t.preventDefault(),this.navigate(this.href))}printBool(t){return t?"true":"false"}render(){return o`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",Lt);class Ss extends Lt{constructor(){super()}renderText(){return this.text.split(" ").map(t=>o`
            <span>${t}</span>
        ...
        `}}customElements.define("grid-link",Ss);class js extends Lt{constructor(){super()}renderText(){return this.text.split(" ").map(t=>o`
            <span>${t}</span>
        `)}getIcon(){return this.locked?this.icon+"-locked":this.icon}render(){return o`
            <div class="container-inline">
                <div
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slide",k);class Es extends k{static get properties(){return{slide:{type:Object},id:{type:String},offCanvasId:{type:String,attribute:!1}}}firstUpdated(){jQuery(document).foundation(),this.offCanvasId="activityOffCanvas"+this.id,this.offCanvasSelector="#"+this.offCanvasId,super.firstUpdated()}openMenu(){const t=document.querySelector(this.offCanvasSelector);console.log(t,this.offCanvasSelector),jQuery(t).foundation("open")}closeMenu(){const t=document.querySelector(this.offCanvasSelector);jQuery(t).foundation("close")}render(){return o`
        ...
        `}}customElements.define("activity-slide",Es);class Os extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("break-slide",Os);class zs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("center-slide",zs);class As extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("checkin-slide",As);class Ms extends k{render(){return o`
            <div class="slides-card">
        ...
        `}}customElements.define("congratulations-slide",Ms);class Ps extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("discuss-slide",Ps);class Ts extends k{render(){return o`
            <div class="slides-card">
                <div class="cover-page">
        ...
        `}}customElements.define("final-slide",Ts);class Rs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column right">
                    <div>
        ...
        `}}customElements.define("left-image-slide",Rs);class Is extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("next-steps-slide",Is);class Ls extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("obey-slide",Ls);class qs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("overview-slide",qs);class Us extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("pray-slide",Us);class Ds extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("review-slide",Ds);class Ns extends k{render(){return o`
            <div>
                <div class="slides-card">
                    ${this.renderProgressBar()}
        ...
        `}}customElements.define("video-slide",Hs);class Fs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("watch-slide",Fs);class Bs extends k{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}createRenderRoot(){return this}}customElements.define("course-presenter",Ws);class Ks extends v{static get properties(){return{sections:{type:Array}}}render(){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("activity-3-month-plan",Vs);class Ce extends v{constructor(){super()}render(){return o`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",Ce);class Js extends v{constructor(){super();y(this,"webShareSupported",!!window.navigator.share);y(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(e=>console.error("Error sharing",e))}copyLink(e){e.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return o`
        ...
        `}render(){return o`
            <div class="container-xsm">
                ...
                <div class="share-list__wrapper">
                    <ul class="stack  | mt-0">
                        ${F(this.items,e=>e.key,this.renderListItem)}
                    </ul>
                </div>
            </div>
        `}createRenderRoot(){return this}}customElements.define("share-list",Gs);class Ys extends v{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){makeRequest("POST","public_plans",{},"zume_system/v1").then(t=>{this.plans=t}).catch(t=>{console.log(t)}).always(()=>{this.loading=!1})}render(){return this.loading?o`<span class="loading-spinner active"></span>`:o`
            <table>
                <thead>
                    <tr>
                        <td>${this.t.name}</td>
        ...
        `}renderRow({join_key:t,language_note:e,post_title:s,time_of_day_note:i,timezone_note:a,...r}){const l=r.set_a_01?"a":"b",c=l==="a"?10:20,d=`set_${l}_`,m=Date.now()/1e3;let u="";for(let g=1;g<c+1;g++){const f=g<10?`0${g}`:`${g}`,$=r[d+f];if(u=$.timestamp,m<$.timestamp)break}const p=moment(u*1e3).format("MMM Do 'YY");return o`
            <tr>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",xe);class Xs extends xe{static get properties(){return{percent:{type:Number},type:{type:String}}}constructor(){super(),this.radius=50,this.lineWidth=15,this.percent=0,this.borderWidth=3,this.type="heard"}width(){return(this.radius+this.lineWidth)*2}getIconSvg(){switch(this.type){case"heard":return rt`
        ...
        `}createRenderRoot(){return this}}customElements.define("host-progress-circle",Xs);class Mt extends v{constructor(){super(),this.month_to_show=null,this.start_timestamp=window.campaign_data.start_timestamp,this.end_timestamp=window.campaign_data.end_timestamp,this.days=window.campaign_scripts.days,this.selected_times=[]}connectedCallback(){super.connectedCallback(),window.addEventListener("campaign_days_ready",t=>{this.days=t.detail,this.requestUpdate()})}next_view(t){this.month_to_show=t,this.requestUpdate(),this.shadowRoot.querySelectorAll(".selected-time").forEach(e=>e.classList.remove("selected-time"))}day_selected(t,e){this.dispatchEvent(new CustomEvent("day-selected",{detail:e})),this.shadowRoot.querySelectorAll(".selected-time").forEach(s=>s.classList.remove("selected-time")),t.target.classList.add("selected-time")}render(){if(this.days.length===0)return o`<div></div>`;this.end_timestamp||(this.end_timestamp=this.days[this.days.length-1].key);let t=this.selected_times.map(u=>u.day_key),e=window.campaign_scripts.get_days_of_the_week_initials(navigator.language,"narrow"),i=window.luxon.DateTime.now({zone:window.campaign_user_data.timezone}).toSeconds(),a=window.luxon.DateTime.fromSeconds(this.month_to_show||Math.max(this.days[0].key,i,window.campaign_data.start_timestamp),{zone:window.campaign_user_data.timezone}),r=a.startOf("month"),l=window.campaign_scripts.build_calendar_days(a),c=r.weekday,d=a.minus({months:1}).toSeconds(),m=r.plus({months:1}).toSeconds();return o`

            <div class="calendar-wrapper">
                <h3 class="month-title center">
                    <button class="month-next" ?disabled="${r.toSeconds()<i}"
                            @click="${u=>this.next_view(d)}">
                        <
                    </button>
                    ${a.toFormat("MMMM y")}
                    <button class="month-next" ?disabled="${m>this.end_timestamp}" @click="${u=>this.next_view(m)}">
                        >
                    </button>
                </h3>
                <div class="calendar">
                    ${e.map(u=>o`<div class="day-cell week-day">${u}</div>`)}
                    ${map(range(c%7),u=>o`<div class="day-cell disabled-calendar-day"></div>`)}
                    ${l.map(u=>o`
                            <div class="day-cell ${u.disabled?"disabled":""} ${t.includes(u.key)?"selected-day":""}"
                               data-day="${window.campaign_scripts.escapeHTML(u.key)}"
                               @click="${p=>!u.disabled&&this.day_selected(p,u.key)}"
                            >
                                ${window.campaign_scripts.escapeHTML(u.day)}
                            </div>`)}
                </div>
            </div>
            `}}y(Mt,"styles",[ce`
        ...
        `,window.campaignStyles]),y(Mt,"properties",{start_timestamp:{type:String},end_timestamp:{type:String},days:{type:Array},selected_times:{type:Array}});customElements.define("calendar-select",Mt);

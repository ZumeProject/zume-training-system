 ...
 */const ge=Symbol.for(""),Le=n=>{if((n==null?void 0:n.r)===ge)return n==null?void 0:n._$litStatic$},M=(n,...t)=>({_$litStatic$:t.reduce((e,s,i)=>e+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+n[i+1],n[0]),r:ge}),Wt=new Map,qe=n=>(t,...e)=>{const s=e.length;let i,a;const r=[],l=[];let c,d=0,v=!1;for(;d<s;){for(c=t[d];d<s&&(a=e[d],(i=Le(a))!==void 0);)c+=i+t[++d],v=!0;d!==s&&l.push(a),r.push(c),d++}if(d===s&&r.push(t[s]),v){const u=r.join("$$lit$$");(t=Wt.get(u))===void 0&&(r.raw=r,Wt.set(u,t=r)),e=l}return n(t,...e)},Ue=qe(o);class Ne extends g{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},translations:{type:Object},noUrlChange:{type:Boolean},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),this._handlePlanDecision=this._handlePlanDecision.bind(this),this.stateManager=new Jt}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._handleHistoryPopState),window.addEventListener("plan-decision",this._handlePlanDecision)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState),window.removeEventListener("plan-decision",this._handlePlanDecision)}firstUpdated(){this.loadWizard(),this._handleHistoryPopState(!0),this.translations&&(this.t=window.SHAREDFUNCTIONS.escapeObject(this.translations))}willUpdate(t){t.has("type")&&this.type===""&&this.wizard&&this.wizard.reset(),t.has("type")&&this.type!==""&&this.loadWizard(this.type)}loadWizard(t){this.wizard=new xe(this.user),this.steps=this.wizard.getSteps(this.type),this._gotoStep(0)}render(){if(!(!this.wizard||!this.wizard.isLoaded()))return this.wizard.isTypeValid(this.type)?this.steps.length===0?o`

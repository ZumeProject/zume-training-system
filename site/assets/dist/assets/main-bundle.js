var Ce=Object.defineProperty;var Ee=(n,t,e)=>t in n?Ce(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var y=(n,t,e)=>(Ee(n,typeof t!="symbol"?t+"":t,e),e),$t=(n,t,e)=>{if(!t.has(n))throw TypeError("Cannot "+e)};var j=(n,t,e)=>($t(n,t,"read from private field"),e?e.call(n):t.get(n)),x=(n,t,e)=>{if(t.has(n))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(n):t.set(n,e)},P=(n,t,e,s)=>($t(n,t,"write to private field"),s?s.call(n,e):t.set(n,e),e);var O=(n,t,e)=>($t(n,t,"access private method"),e);var Et;let xe=(Et=class{static save(t,e){localStorage.setItem(this.createKey(t),JSON.stringify(e))}static load(t){const e=localStorage.getItem(this.createKey(t));try{return JSON.parse(e)}catch{return e}}static createKey(t){return this.prefix+t}},y(Et,"prefix","Z5_"),Et);window.ZumeStorage=xe;var E,ht,ee,et,xt,ut,se,st,Ot,pt,ie,it,zt;class Mt{constructor(t){x(this,ht);x(this,et);x(this,ut);x(this,st);x(this,pt);x(this,it);y(this,"WIZARD_STATE_NAME","zume_wizard_state");y(this,"STALE_LIFESPAN",10*60*1e3);y(this,"MAX_LIFESPAN",60*60*1e3);x(this,E,void 0);y(this,"moduleName");this.moduleName=t,P(this,E,O(this,ht,ee).call(this))}isEmpty(){return Object.keys(j(this,E).data).length===0}isDataStale(){return O(this,it,zt).call(this,j(this,E),this.STALE_LIFESPAN)}has(t){return Object.prototype.hasOwnProperty.call(j(this,E).data,t)}get(t){return j(this,E).data[t]}getAll(){return j(this,E).data}add(t,e){j(this,E).data[t]=e,O(this,st,Ot).call(this)}remove(t){delete j(this,E).data[t],O(this,st,Ot).call(this)}clear(){P(this,E,O(this,et,xt).call(this)),localStorage.removeItem(this.WIZARD_STATE_NAME)}}E=new WeakMap,ht=new WeakSet,ee=function(){const t=O(this,ut,se).call(this);return t&&!O(this,it,zt).call(this,t,this.MAX_LIFESPAN)&&t.module===this.moduleName?t:O(this,et,xt).call(this)},et=new WeakSet,xt=function(){return{module:this.moduleName,data:{},timestamp:Date.now()}},ut=new WeakSet,se=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},st=new WeakSet,Ot=function(){O(this,pt,ie).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(j(this,E)))},pt=new WeakSet,ie=function(){j(this,E).timestamp=Date.now()},it=new WeakSet,zt=function(t,e){return Date.now()-t.timestamp>e};const S={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinATraining:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin",setProfile:"set-profile",joinCommunity:"join-the-community"},k={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision",joinCommunity:"joinCommunity"},Oe={planDecision:"plan-decision",howManySessions:"how-many-sessions",howOften:"how-often",startDate:"what-start-date",location:"what-location",review:"review-steps"},h={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",joinCommunity:"join-community",...Oe},ze={[h.updateName]:{field:"name",testExistance:(n,t)=>t.has_set_name},[h.updateLocation]:{field:"location",testExistance:n=>!(n.source&&n.source==="ip")},[h.updatePhone]:{field:"phone",testExistance:n=>!!n}},Ae={[S.gettingStarted]:{[k.completeProfile]:C([h.updateName,h.updateLocation],!0),[k.planDecision]:C([h.planDecision],!1)},[S.setProfile]:{[k.completeProfile]:C([h.updateName,h.updateLocation],!0)},[S.makeAGroup]:{[k.makePlan]:C([h.howManySessions,h.howOften,h.startDate,h.location,h.review,h.inviteFriends],!0)},[S.getACoach]:{[k.completeProfile]:C([h.updateName,h.updateLocation,h.updatePhone]),[k.getACoach]:C([h.contactPreferences,h.languagePreferences,h.howCanWeServe,h.connectingToCoach])},[S.joinATraining]:{[k.completeProfile]:C([h.updateName,h.updateLocation,h.updatePhone]),[k.joinTraining]:C([h.joinTraining],!0)},[S.connectWithFriend]:{[k.completeProfile]:C([h.updateName,h.updateLocation],!0),[k.connectFriend]:C([h.connectToFriend])},[S.joinFriendsPlan]:{[k.completeProfile]:C([h.updateName,h.updateLocation],!0),[k.joinFriendsTraining]:C([h.joinFriendsPlan])},[S.joinCommunity]:{[k.joinCommunity]:C([h.joinCommunity],!0)},[S.checkin]:{[k.checkin]:C([h.checkinSubmit])}};function C(n=[],t=!1){const e={steps:[],skippable:t};return n.forEach(s=>{Object.values(h).includes(s)&&e.steps.push(s)}),e}var R,N,mt,ne,gt,ae,vt,re;class Me{constructor(t){x(this,mt);x(this,gt);x(this,vt);x(this,R,void 0);x(this,N,void 0);y(this,"profile");P(this,R,{}),P(this,N,[]),this.profile=t}reset(){P(this,R,{})}isTypeValid(t){return!!Object.values(S).includes(t)}isLoaded(){return Object.keys(j(this,R)).length!==0}getSteps(t){return O(this,gt,ae).call(this,t),j(this,N)}}R=new WeakMap,N=new WeakMap,mt=new WeakSet,ne=function(t){return this.isTypeValid(t)?Ae[t]:{}},gt=new WeakSet,ae=function(t){const e=O(this,mt,ne).call(this,t);Object.keys(e).length!==0&&O(this,vt,re).call(this,e)},vt=new WeakSet,re=function(t){P(this,R,t),P(this,N,[]),Object.entries(j(this,R)).forEach(([e,{steps:s,skippable:i}])=>{s.forEach(a=>{const r=ze[a];let l=null;if(r&&this.profile){if(r.testExistance(this.profile[r.field],this.profile))return;l=this.profile[r.field]}const c={slug:a,module:e,skippable:i};l!==null&&(c.value=l),j(this,N).push(c)})})};/**
 * @license
 ...
 */const Xt=(n,t,e)=>{const s=new Map;for(let i=t;i<=e;i++)s.set(n[i],i);return s},B=$e(class extends ye{constructor(n){if(super(n),n.type!==U.CHILD)throw Error("repeat() can only be used in text expressions")}dt(n,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);const i=[],a=[];let r=0;for(const l of n)i[r]=s?s(l,r):r,a[r]=e(l,r),r++;return{values:a,keys:i}}render(n,t,e){return this.dt(n,t,e).values}update(n,[t,e,s]){var i;const a=Fe(n),{values:r,keys:l}=this.dt(t,e,s);if(!Array.isArray(a))return this.ht=l,r;const c=(i=this.ht)!==null&&i!==void 0?i:this.ht=[],d=[];let m,p,u=0,g=a.length-1,f=0,$=r.length-1;for(;u<=g&&f<=$;)if(a[u]===null)u++;else if(a[g]===null)g--;else if(c[u]===l[f])d[f]=q(a[u],r[f]),u++,f++;else if(c[g]===l[$])d[$]=q(a[g],r[$]),g--,$--;else if(c[u]===l[$])d[$]=q(a[u],r[$]),G(n,d[$+1],a[u]),u++,$--;else if(c[g]===l[f])d[f]=q(a[g],r[f]),G(n,a[u],a[g]),g--,f++;else if(m===void 0&&(m=Xt(l,f,$),p=Xt(c,u,g)),m.has(c[u]))if(m.has(c[g])){const A=p.get(l[f]),ft=A!==void 0?a[A]:null;if(ft===null){const Lt=G(n,a[u]);q(Lt,r[f]),d[f]=Lt}else d[f]=q(ft,r[f]),G(n,a[u],ft),a[A]=null;f++}else Ct(a[g]),g--;else Ct(a[u]),u++;for(;f<=$;){const A=G(n,d[$+1]);q(A,r[f]),d[f++]=A}for(;u<=g;){const A=a[u++];A!==null&&Ct(A)}return this.ht=l,_e(n,d),z}});class I extends v{constructor(){super();const e=document.querySelector("html").dataset.dir;this.isRtl=e==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle(),window.scrollTo({top:0,behavior:"instant"})}attachResizeObeserver(){const t=document.querySelector("dash-header-right"),e=new ResizeObserver(s=>{for(let i of s){if(!i.contentRect)return;const a=Math.round(i.contentRect.height),r=Math.round(i.contentRect.width);this.updateHeaderStyle(!1,a,r)}});this.resizeObserver=e,e.observe(t)}updateHeaderStyle(t=!0,e=0,s=window.innerWidth){const i=document.querySelector(".dashboard__header.left");t&&(this.initialOffset=i.offsetTop);let a;s<window.innerWidth/2?a=this.initialOffset:a=this.initialOffset+e,i.style.top=a+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class hs extends I{static get properties(){return{showTeaser:{type:Boolean},churches:{type:Array,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.route=b.getRoute("my-churches"),this.churches=[],this.renderChurch=this.renderChurch.bind(this),this.addChurch=this.addChurch.bind(this),this.handleSubmit=this.handleSubmit.bind(this)}firstUpdated(){super.firstUpdated(),document.querySelector("#add-church-form").addEventListener("submit",this.handleSubmit)}updated(){jQuery(document).foundation()}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(t=>{const e=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(e)})}handleSubmit(t){t.preventDefault(),this.addChurch()}addChurch(){const t=this.churches.length+1,e=[{id:t,name:"This is a new church",location:"Birmingham, UK",depth:0},{id:`${t}-1`,name:"Tea Shop 1",location:"Birmingham, UK",parent:t,depth:1},{id:`${t}-2`,name:"Tea Shop 2",location:"Birmingham, UK",parent:t,depth:1},{id:`${t}-2-1`,name:"Tea Shop 2 child",location:"Birmingham, UK",parent:`${t}-2`,depth:2},{id:`${t}-3`,name:"Breakfast Shop",location:"Birmingham, UK",parent:t,depth:1}];this.churches=[...this.churches,...e],this.closeChurchModal()}editChurch(t){console.log("edit church",t)}deleteChurch(t){console.log("delete church",t)}openChurchModal(){if(this.showTeaser)return;const t=document.querySelector("#new-church-form");jQuery(t).foundation("open")}closeChurchModal(){const t=document.querySelector("#new-church-form");jQuery(t).foundation("close"),this.clearChurchModal()}clearChurchModal(){jQuery("#add-church-form input").each(function(t){this.value=""})}renderChurch({id:t,name:e,location:s,depth:i}){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slide",w);class Es extends w{static get properties(){return{slide:{type:Object},id:{type:String},offCanvasId:{type:String,attribute:!1}}}firstUpdated(){jQuery(document).foundation(),this.offCanvasId="activityOffCanvas"+this.id,this.offCanvasSelector="#"+this.offCanvasId,super.firstUpdated()}openMenu(){const t=document.querySelector(this.offCanvasSelector);console.log(t,this.offCanvasSelector),jQuery(t).foundation("open")}closeMenu(){const t=document.querySelector(this.offCanvasSelector);jQuery(t).foundation("close")}render(){return o`
        ...
        `}}customElements.define("activity-slide",Es);class xs extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("break-slide",xs);class Os extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("center-slide",Os);class zs extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("checkin-slide",zs);class As extends w{render(){return o`
            <div class="slides-card">
        ...
        `}}customElements.define("congratulations-slide",As);class Ms extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("discuss-slide",Ms);class Ps extends w{render(){return o`
            <div class="slides-card">
                <div class="cover-page">
        ...
        `}}customElements.define("final-slide",Ps);class Ts extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column right">
                    <div>
        ...
        `}}customElements.define("left-image-slide",Ts);class Rs extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("next-steps-slide",Rs);class Is extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("obey-slide",Is);class Ls extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("overview-slide",Ls);class qs extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("pray-slide",qs);class Us extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("review-slide",Us);class Ds extends w{render(){return o`
            <div>
                <div class="slides-card">
                    ${this.renderProgressBar()}
        ...
        `}}customElements.define("video-slide",Ns);class Hs extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("watch-slide",Hs);class Bs extends w{render(){return o`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}createRenderRoot(){return this}}customElements.define("course-presenter",Fs);class Ws extends v{static get properties(){return{sections:{type:Array}}}render(){return o`

...
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/var ts;const Te=window,Lt=Te.trustedTypes,Vs=Lt?Lt.createPolicy("lit-html",{createHTML:i=>i}):void 0,Me="$lit$",at=`lit$${(Math.random()+"").slice(9)}$`,Es="?"+at,_a=`<${Es}>`,Pt=document,ie=()=>Pt.createComment(""),ne=i=>i===null||typeof i!="object"&&typeof i!="function",Wi=Array.isArray,Vi=i=>Wi(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",es=`[ 	
\f\r]`,Gt=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Hs=/-->/g,Bs=/>/g,gt=RegExp(`>|${es}(?:([^\\s"'>=/]+)(${es}*=${es}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Gs=/'/g,Zs=/"/g,Hi=/^(?:script|style|textarea|title)$/i,Bi=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),c=Bi(1),ge=Bi(2),tt=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),Ks=new WeakMap,It=Pt.createTreeWalker(Pt,129,null,!1),Gi=(i,t)=>{const e=i.length-1,s=[];let n,a=t===2?"<svg>":"",r=Gt;for(let l=0;l<e;l++){const d=i[l];let u,p,m=-1,f=0;for(;f<d.length&&(r.lastIndex=f,p=r.exec(d),p!==null);)f=r.lastIndex,r===Gt?p[1]==="!--"?r=Hs:p[1]!==void 0?r=Bs:p[2]!==void 0?(Hi.test(p[2])&&(n=RegExp("</"+p[2],"g")),r=gt):p[3]!==void 0&&(r=gt):r===gt?p[0]===">"?(r=n??Gt,m=-1):p[1]===void 0?m=-2:(m=r.lastIndex-p[2].length,u=p[1],r=p[3]===void 0?gt:p[3]==='"'?Zs:Gs):r===Zs||r===Gs?r=gt:r===Hs||r===Bs?r=Gt:(r=gt,n=void 0);const y=r===gt&&i[l+1].startsWith("/>")?" ":"";a+=r===Gt?d+_a:m>=0?(s.push(u),d.slice(0,m)+Me+d.slice(m)+at+y):d+at+(m===-2?(s.push(void 0),l):y)}const o=a+(i[e]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Vs!==void 0?Vs.createHTML(o):o,s]};class ae{constructor({strings:t,_$litType$:e},s){let n;this.parts=[];let a=0,r=0;const o=t.length-1,l=this.parts,[d,u]=Gi(t,e);if(this.el=ae.createElement(d,s),It.currentNode=this.el.content,e===2){const p=this.el.content,m=p.firstChild;m.remove(),p.append(...m.childNodes)}for(;(n=It.nextNode())!==null&&l.length<o;){if(n.nodeType===1){if(n.hasAttributes()){const p=[];for(const m of n.getAttributeNames())if(m.endsWith(Me)||m.startsWith(at)){const f=u[r++];if(p.push(m),f!==void 0){const y=n.getAttribute(f.toLowerCase()+Me).split(at),j=/([.?@])?(.*)/.exec(f);l.push({type:1,index:a,name:j[2],strings:y,ctor:j[1]==="."?Ki:j[1]==="?"?Qi:j[1]==="@"?Yi:ce})}else l.push({type:6,index:a})}for(const m of p)n.removeAttribute(m)}if(Hi.test(n.tagName)){const p=n.textContent.split(at),m=p.length-1;if(m>0){n.textContent=Lt?Lt.emptyScript:"";for(let f=0;f<m;f++)n.append(p[f],ie()),It.nextNode(),l.push({type:2,index:++a});n.append(p[m],ie())}}}else if(n.nodeType===8)if(n.data===Es)l.push({type:2,index:a});else{let p=-1;for(;(p=n.data.indexOf(at,p+1))!==-1;)l.push({type:7,index:a}),p+=at.length-1}a++}}static createElement(t,e){const s=Pt.createElement("template");return s.innerHTML=t,s}}function jt(i,t,e=i,s){var n,a,r,o;if(t===tt)return t;let l=s!==void 0?(n=e._$Co)===null||n===void 0?void 0:n[s]:e._$Cl;const d=ne(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==d&&((a=l==null?void 0:l._$AO)===null||a===void 0||a.call(l,!1),d===void 0?l=void 0:(l=new d(i),l._$AT(i,e,s)),s!==void 0?((r=(o=e)._$Co)!==null&&r!==void 0?r:o._$Co=[])[s]=l:e._$Cl=l),l!==void 0&&(t=jt(i,l._$AS(i,t.values),l,s)),t}class Zi{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:s},parts:n}=this._$AD,a=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:Pt).importNode(s,!0);It.currentNode=a;let r=It.nextNode(),o=0,l=0,d=n[0];for(;d!==void 0;){if(o===d.index){let u;d.type===2?u=new Ft(r,r.nextSibling,this,t):d.type===1?u=new d.ctor(r,d.name,d.strings,this,t):d.type===6&&(u=new Ji(r,this,t)),this._$AV.push(u),d=n[++l]}o!==(d==null?void 0:d.index)&&(r=It.nextNode(),o++)}return a}v(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class Ft{constructor(t,e,s,n){var a;this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=n,this._$Cp=(a=n==null?void 0:n.isConnected)===null||a===void 0||a}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=jt(this,t,e),ne(t)?t===z||t==null||t===""?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==tt&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):Vi(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==z&&ne(this._$AH)?this._$AA.nextSibling.data=t:this.$(Pt.createTextNode(t)),this._$AH=t}g(t){var e;const{values:s,_$litType$:n}=t,a=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=ae.createElement(n.h,this.options)),n);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===a)this._$AH.v(s);else{const r=new Zi(a,this),o=r.u(this.options);r.v(s),this.$(o),this._$AH=r}}_$AC(t){let e=Ks.get(t.strings);return e===void 0&&Ks.set(t.strings,e=new ae(t)),e}T(t){Wi(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,n=0;for(const a of t)n===e.length?e.push(s=new Ft(this.k(ie()),this.k(ie()),this,this.options)):s=e[n],s._$AI(a),n++;n<e.length&&(this._$AR(s&&s._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,e);t&&t!==this._$AB;){const n=t.nextSibling;t.remove(),t=n}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class ce{constructor(t,e,s,n,a){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=z}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,n){const a=this.strings;let r=!1;if(a===void 0)t=jt(this,t,e,0),r=!ne(t)||t!==this._$AH&&t!==tt,r&&(this._$AH=t);else{const o=t;let l,d;for(t=a[0],l=0;l<a.length-1;l++)d=jt(this,o[s+l],e,l),d===tt&&(d=this._$AH[l]),r||(r=!ne(d)||d!==this._$AH[l]),d===z?t=z:t!==z&&(t+=(d??"")+a[l+1]),this._$AH[l]=d}r&&!n&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ki extends ce{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}}const ka=Lt?Lt.emptyScript:"";class Qi extends ce{constructor(){super(...arguments),this.type=4}j(t){t&&t!==z?this.element.setAttribute(this.name,ka):this.element.removeAttribute(this.name)}}class Yi extends ce{constructor(t,e,s,n,a){super(t,e,s,n,a),this.type=5}_$AI(t,e=this){var s;if((t=(s=jt(this,t,e,0))!==null&&s!==void 0?s:z)===tt)return;const n=this._$AH,a=t===z&&n!==z||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,r=t!==z&&(n===z||a);a&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;typeof this._$AH=="function"?this._$AH.call((s=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}}class Ji{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){jt(this,t)}}const Sa={O:Me,P:at,A:Es,C:1,M:Gi,L:Zi,D:Vi,R:jt,I:Ft,V:ce,H:Qi,N:Yi,U:Ki,F:Ji},Qs=Te.litHtmlPolyfillSupport;Qs==null||Qs(ae,Ft),((ts=Te.litHtmlVersions)!==null&&ts!==void 0?ts:Te.litHtmlVersions=[]).push("2.7.3");const ja=(i,t,e)=>{var s,n;const a=(s=e==null?void 0:e.renderBefore)!==null&&s!==void 0?s:t;let r=a._$litPart$;if(r===void 0){const o=(n=e==null?void 0:e.renderBefore)!==null&&n!==void 0?n:null;a._$litPart$=r=new Ft(t.insertBefore(ie(),o),o,void 0,e??{})}return r._$AI(i),r};/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause

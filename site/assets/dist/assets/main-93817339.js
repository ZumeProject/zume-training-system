 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ee=i=>(...t)=>({_$litDirective$:i,values:t});class se{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:we}=_e,Se=i=>i.strings===void 0,Ot=()=>document.createComment(""),q=(i,t,e)=>{var s;const a=i._$AA.parentNode,o=t===void 0?i._$AB:t._$AA;if(e===void 0){const n=a.insertBefore(Ot(),o),h=a.insertBefore(Ot(),o);e=new we(n,h,i,i.options)}else{const n=e._$AB.nextSibling,h=e._$AM,c=h!==i;if(c){let d;(s=e._$AQ)===null||s===void 0||s.call(e,i),e._$AM=i,e._$AP!==void 0&&(d=i._$AU)!==h._$AU&&e._$AP(d)}if(n!==o||c){let d=e._$AA;for(;d!==n;){const f=d.nextSibling;a.insertBefore(d,o),d=f}}}return e},A=(i,t,e=i)=>(i._$AI(t,e),i),xe={},ie=(i,t=xe)=>i._$AH=t,Ee=i=>i._$AH,pt=i=>{var t;(t=i._$AP)===null||t===void 0||t.call(i,!1,!0);let e=i._$AA;const s=i._$AB.nextSibling;for(;e!==s;){const a=e.nextSibling;e.remove(),e=a}};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const De=ee(class extends se{constructor(i){if(super(i),i.type!==P.PROPERTY&&i.type!==P.ATTRIBUTE&&i.type!==P.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Se(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===S||t===_)return t;const e=i.element,s=i.name;if(i.type===P.PROPERTY){if(t===e[s])return S}else if(i.type===P.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(s))return S}else if(i.type===P.ATTRIBUTE&&e.getAttribute(s)===t+"")return S;return ie(i),t}});class ze extends u{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var t;return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-board",w);class qe extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",qe);class Ue extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",Ue);class Be extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-content",Be);class We extends u{render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-top-level",it);class Ze extends it{constructor(){super("getting-started")}createRenderRoot(){return this}}customElements.define("dash-getting-started",Ze);class Ve extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
                    <h1 class="h3">Maps</h1>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",Ve);class Qe extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
 ...
 */const jt=(i,t,e)=>{const s=new Map;for(let a=t;a<=e;a++)s.set(i[a],a);return s},_t=ee(class extends se{constructor(i){if(super(i),i.type!==P.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);const a=[],o=[];let n=0;for(const h of i)a[n]=s?s(h,n):n,o[n]=e(h,n),n++;return{values:o,keys:a}}render(i,t,e){return this.dt(i,t,e).values}update(i,[t,e,s]){var a;const o=Ee(i),{values:n,keys:h}=this.dt(t,e,s);if(!Array.isArray(o))return this.ht=h,n;const c=(a=this.ht)!==null&&a!==void 0?a:this.ht=[],d=[];let f,m,p=0,g=o.length-1,b=0,v=n.length-1;for(;p<=g&&b<=v;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(c[p]===h[b])d[b]=A(o[p],n[b]),p++,b++;else if(c[g]===h[v])d[v]=A(o[g],n[v]),g--,v--;else if(c[p]===h[v])d[v]=A(o[p],n[v]),q(i,d[v+1],o[p]),p++,v--;else if(c[g]===h[b])d[b]=A(o[g],n[b]),q(i,o[p],o[g]),g--,b++;else if(f===void 0&&(f=jt(h,b,v),m=jt(c,p,g)),f.has(c[p]))if(f.has(c[g])){const x=m.get(h[b]),at=x!==void 0?o[x]:null;if(at===null){const kt=q(i,o[p]);A(kt,n[b]),d[b]=kt}else d[b]=A(at,n[b]),q(i,o[p],at),o[x]=null;b++}else pt(o[g]),g--;else pt(o[p]),p++;for(;b<=v;){const x=q(i,d[v+1]);A(x,n[b]),d[b++]=x}for(;p<=g;){const x=o[p++];x!==null&&pt(x)}return this.ht=h,ie(i,d),S}});class Ge extends st{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.loading=!0,this.route=w.getRoute("my-plans"),this.filterName="my-plans-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){super.firstUpdated();const t=this.filterStatus||"";this.fetchCommitments(t)}updated(){jQuery(document).foundation()}fetchCommitments(){const t=this.filterStatus;makeRequest("GET","commitments",{status:t},"zume_system/v1").done(e=>{this.commitments=e}).always(()=>{this.loading=!1})}openCommitmentsModal(){const t=document.querySelector("#new-commitments-form");jQuery(t).foundation("open")}closeCommitmentsModal(){const t=document.querySelector("#new-commitments-form");jQuery(t).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(t){this.value=""})}addCommitments(){const t=[];return jQuery(".post-training-plan").each(function(e){const s=jQuery(this).val();if(s){const o=jQuery(this).prev().text();console.log("Question: "+o+" Answer: "+s);var a=new Date;a.setDate(a.getDate()+30),this.value="";const n=makeRequest("POST","commitment",{user_id:zumeDashboard.user_profile.user_id,post_id:zumeDashboard.user_profile.contact_id,meta_key:"tasks",note:"Question: "+o+" Answer: "+s,question:o,answer:s,date:a,category:"post_training_plan"},"zume_system/v1");t.push(n.promise())}}),console.log(t),Promise.all(t).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(t){let e={id:t,user_id:zumeDashboard.user_profile.user_id};makeRequest("PUT","commitment",e,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(t){let e={id:t,user_id:zumeDashboard.user_profile.user_id};makeRequest("DELETE","commitment",e,"zume_system/v1").done(s=>{this.closeMenu(t),this.fetchCommitments()})}editCommitment(t){console.log(t)}filterCommitments(t){this.filterStatus=t,this.fetchCommitments(t),ZumeStorage.save(this.filterName,t),this.closeFilter()}closeFilter(){const t=this.querySelector("#filter-menu");jQuery(t).foundation("close")}closeMenu(t){const e=this.querySelector(`#kebab-menu-${t}`);jQuery(e).foundation("close")}renderListItem(t){const{question:e,answer:s,id:a,status:o}=t;return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-progress",Ke);class Ye extends u{render(){return r`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-tools",Ye);class Xe extends it{constructor(){super("training")}createRenderRoot(){return this}}customElements.define("dash-training",Xe);class ts extends st{static get properties(){return{loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.loading=!0,this.route=w.getRoute("my-plans"),this.filterName="my-plans-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){super.firstUpdated();const t=this.filterStatus||"";this.fetchCommitments(t)}updated(){jQuery(document).foundation()}fetchCommitments(){const t=this.filterStatus;makeRequest("GET","commitments",{status:t},"zume_system/v1").done(e=>{this.commitments=e}).always(()=>{this.loading=!1})}openCommitmentsModal(){const t=document.querySelector("#new-commitments-form");jQuery(t).foundation("open")}closeCommitmentsModal(){const t=document.querySelector("#new-commitments-form");jQuery(t).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(t){this.value=""})}addCommitments(){const t=[];return jQuery(".post-training-plan").each(function(e){const s=jQuery(this).val();if(s){const o=jQuery(this).prev().text();console.log("Question: "+o+" Answer: "+s);var a=new Date;a.setDate(a.getDate()+30),this.value="";const n=makeRequest("POST","commitment",{user_id:zumeDashboard.user_profile.user_id,post_id:zumeDashboard.user_profile.contact_id,meta_key:"tasks",note:"Question: "+o+" Answer: "+s,question:o,answer:s,date:a,category:"post_training_plan"},"zume_system/v1");t.push(n.promise())}}),console.log(t),Promise.all(t).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(t){let e={id:t,user_id:zumeDashboard.user_profile.user_id};makeRequest("PUT","commitment",e,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(t){let e={id:t,user_id:zumeDashboard.user_profile.user_id};makeRequest("DELETE","commitment",e,"zume_system/v1").done(s=>{this.closeMenu(t),this.fetchCommitments()})}editCommitment(t){console.log(t)}filterCommitments(t){this.filterStatus=t,this.fetchCommitments(t),ZumeStorage.save(this.filterName,t),this.closeFilter()}closeFilter(){const t=this.querySelector("#filter-menu");jQuery(t).foundation("close")}closeMenu(t){const e=this.querySelector(`#kebab-menu-${t}`);jQuery(e).foundation("close")}renderListItem(t){const{question:e,answer:s,id:a,status:o}=t;return r`
            <li class="list__item">
                <span>${e} <b>${s}</b></span>
                <div class="list__secondary">
                    <div class="d-flex w-6rem justify-content-center">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-trainings",ts);class es extends u{firstUpdated(){const t=this.offsetTop;this.style.top=t+"px"}render(){return r`
            <div class="dashboard__header right">
                <dash-sidebar-toggle displayOn="medium"></dash-sidebar-toggle>
                <launch-course></launch-course>
            </div>
        `}createRenderRoot(){return this}}customElements.define("dash-header-right",es);class ss extends u{static get properties(){return{displayOn:{type:String}}}constructor(){super(),this.displayOn="large"}toggleSidebar(){const t=new CustomEvent("toggle-dashboard-sidebar",{bubbles:!0});this.dispatchEvent(t)}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",ss);class yt extends Fe(u){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},directLink:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.directLink=!1}handleClick(t){this.directLink||(t.preventDefault(),this.navigate(this.href))}printBool(t){return t?"true":"false"}render(){return r`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",yt);class is extends yt{constructor(){super()}renderText(){return this.text.split(" ").map(t=>r`
            <span>${t}</span>
        ...
        `}}customElements.define("grid-link",is);class as extends yt{constructor(){super()}renderText(){return this.text.split(" ").map(t=>r`
            <span>${t}</span>
        `)}getIcon(){return this.locked?this.icon+"-locked":this.icon}render(){return r`
            <div
        ...
        `}}customElements.define("list-link",as);class ns extends u{updated(){jQuery(document).foundation()}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("launch-course",ns);class rs extends u{static get properties(){return{title:{type:String},sections:{type:Array}}}render(){return r`
            <div class="container">
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slideshow",cs);class ds extends u{static get properties(){return{partData:{type:Object}}}render(){switch(this.partData.type){case"section":return r`<section-part .partData=${this.partData}></section-part>`;case"watch":return r`<watch-part .partData=${this.partData}></watch-part>`;case"discuss":return r`<discuss-part .partData=${this.partData}></discuss-part>`;case"read":return r`<read-part .partData=${this.partData}></read-part>`;case"see":return r`<see-part .partData=${this.partData}></see-part>`;case"share":return r`<share-part .partData=${this.partData}></share-part>`;case"listen":return r`<listen-part .partData=${this.partData}></listen-part>`;case"form":return r`<form-part .partData=${this.partData}></form-part>`;case"checkin":return r`<checkin-part .partData=${this.partData}></checkin-part>`;case"cta":default:return r`<basic-part .partData=${this.partData}></basic-part>`}}createRenderRoot(){return this}}customElements.define("part-switcher",ds);class hs extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("basic-part",hs);class us extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        ...
        `}createRenderRoot(){return this}}customElements.define("checkin-part",us);class ps extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("discuss-part",ps);class ms extends u{static get properties(){return{partData:{type:Object}}}render(){return this.partData.t,this.partData.d,this.partData.info,r`
            ${this.title!==null?r`<h2>${this.title}</h2>`:""}
            ${this.description!==null?r`<p>${this.description}</p>`:""}
            ${this.info!==null?r`<p>${this.info}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("form-part",ms);class gs extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            <h2 class="brand">LISTEN</h2>
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("listen-part",gs);class bs extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            <h2 class="brand">READ</h2>
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("read-part",bs);class fs extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            ${t!==null?r`<h2>${t}</h2>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("section-part",fs);class vs extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            <h2 class="brand">SEE</h2>
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("see-part",vs);class $s extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("share-part",$s);class _s extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return r`
            ${t!==null?r`<h3>${t}</h3>`:""}
            ${e!==null?r`<p>${e}</p>`:""}
            ${s!==null?r`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("watch-part",_s);class ae extends u{constructor(){super()}render(){return r`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",ae);class ys extends u{constructor(){super();D(this,"webShareSupported",!!window.navigator.share);D(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(e=>console.error("Error sharing",e))}copyLink(e){e.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return r`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-links",ys);class ks extends u{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){makeRequest("POST","public_plans",{},"zume_system/v1").then(t=>{this.plans=t}).catch(t=>{console.log(t)}).always(()=>{this.loading=!1})}render(){return this.loading?r`<span class="loading-spinner active"></span>`:r`
            <table>
                <thead>
                    <tr>
                        <td>${this.t.name}</td>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",ne);class ws extends ne{static get properties(){return{percent:{type:Number},type:{type:String}}}constructor(){super(),this.radius=50,this.lineWidth=15,this.percent=0,this.borderWidth=3,this.type="heard"}width(){return(this.radius+this.lineWidth)*2}getIconSvg(){switch(this.type){case"heard":return Q`
